...
// Test fixture for: avoid_map_keys_contains
...
// BAD: Should trigger avoid_map_keys_contains
// expect_lint: avoid_map_keys_contains
void _bad241() {
  if (map.keys.contains(key)) {}
}

// GOOD: Should NOT trigger avoid_map_keys_contains
void _good241() {
