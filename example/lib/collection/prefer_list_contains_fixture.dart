...
// Test fixture for: prefer_list_contains
...
// BAD: Should trigger prefer_list_contains
// expect_lint: prefer_list_contains
void _bad244() {
  if (list.indexOf(item) != -1) {}
}

// GOOD: Should NOT trigger prefer_list_contains
void _good244() {
