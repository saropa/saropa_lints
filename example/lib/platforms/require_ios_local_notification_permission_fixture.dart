...
// Test fixture for: require_ios_local_notification_permission
...
// BAD: Should trigger require_ios_local_notification_permission
// expect_lint: require_ios_local_notification_permission
void _bad861() async {
  // Schedules without permission check
  await FlutterLocalNotificationsPlugin().zonedSchedule();
}

// GOOD: Should NOT trigger require_ios_local_notification_permission
void _good861() async {
