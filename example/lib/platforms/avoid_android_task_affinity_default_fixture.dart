...
// Test fixture for: avoid_android_task_affinity_default
// Source: lib\src\rules\platforms\android_rules.dart

import '../flutter_mocks.dart';

final context = BuildContext();

// BAD: Should trigger avoid_android_task_affinity_default
// expect_lint: avoid_android_task_affinity_default
void _bad830() async {
  // Launching activity without considering back stack
  await platform.invokeMethod('startActivity', {'class': 'SecondActivity'});
}

// GOOD: Should NOT trigger avoid_android_task_affinity_default
void _good830() {
