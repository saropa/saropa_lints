...
// Test fixture for: avoid_notification_spam
...
// BAD: Should trigger avoid_notification_spam
// expect_lint: avoid_notification_spam
void _bad903() async {
...
// GOOD: Should NOT trigger avoid_notification_spam
void _good903() async {
  // Batch notifications
  if (items.length > 1) {
