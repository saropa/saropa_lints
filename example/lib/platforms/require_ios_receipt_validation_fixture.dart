...
// Test fixture for: require_ios_receipt_validation
...
// BAD: Should trigger require_ios_receipt_validation
// expect_lint: require_ios_receipt_validation
void _bad867() async {
...
// GOOD: Should NOT trigger require_ios_receipt_validation
void _good867() async {
  final result = await InAppPurchase.instance.buyNonConsumable();
  if (result) {
