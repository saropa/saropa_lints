...
// Test fixture for: avoid_ios_wifi_only_assumption
...
// BAD: Should trigger avoid_ios_wifi_only_assumption
// expect_lint: avoid_ios_wifi_only_assumption
void _bad908() async {
  // Assumes stable WiFi
  await downloadLargeFile(url);
}

// GOOD: Should NOT trigger avoid_ios_wifi_only_assumption
void _good908() async {
