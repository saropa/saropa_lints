...
// Test fixture for: require_cors_handling
...
// BAD: Should trigger require_cors_handling
// expect_lint: require_cors_handling
void _bad940() async {
  final response = await http.get(Uri.parse('https://api.example.com/data'));
}

// GOOD: Should NOT trigger require_cors_handling
void _good940() async {
