...
// Test fixture for: require_ios_keychain_sync_awareness
...
// BAD: Should trigger require_ios_keychain_sync_awareness
// expect_lint: require_ios_keychain_sync_awareness
void _bad873() async {
  // May sync to other devices
  await secureStorage.write(key: 'private_key', value: key);
}

// GOOD: Should NOT trigger require_ios_keychain_sync_awareness
void _good873() async {
  // Device-only storage
