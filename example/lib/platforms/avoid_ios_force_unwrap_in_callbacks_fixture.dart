...
// Test fixture for: avoid_ios_force_unwrap_in_callbacks
...
// BAD: Should trigger avoid_ios_force_unwrap_in_callbacks
// expect_lint: avoid_ios_force_unwrap_in_callbacks
void _bad889() async {
  final result = await channel.invokeMethod('getData');
  final value = result!['key']; // Crash if null
}

// GOOD: Should NOT trigger avoid_ios_force_unwrap_in_callbacks
void _good889() async {
