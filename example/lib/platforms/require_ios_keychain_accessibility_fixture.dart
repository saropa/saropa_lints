...
// Test fixture for: require_ios_keychain_accessibility
...
// BAD: Should trigger require_ios_keychain_accessibility
// expect_lint: require_ios_keychain_accessibility
void _bad857() async {
  // No accessibility specified
  await secureStorage.write(key: 'token', value: token);
}

// GOOD: Should NOT trigger require_ios_keychain_accessibility
void _good857() async {
