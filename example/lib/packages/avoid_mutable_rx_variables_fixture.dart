...
// Test fixture for: avoid_mutable_rx_variables
...
// BAD: Should trigger avoid_mutable_rx_variables
// expect_lint: avoid_mutable_rx_variables
void _bad647() {
  count = 5.obs; // Breaks reactivity!
}

// GOOD: Should NOT trigger avoid_mutable_rx_variables
void _good647() {
