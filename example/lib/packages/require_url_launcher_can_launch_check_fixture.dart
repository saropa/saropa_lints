...
// Test fixture for: require_url_launcher_can_launch_check
...
// BAD: Should trigger require_url_launcher_can_launch_check
// expect_lint: require_url_launcher_can_launch_check
void _bad773() async {
  await launchUrl(Uri.parse('https://example.com'));
  await launchUrl(Uri.parse('tel:+1234567890'));
}

// GOOD: Should NOT trigger require_url_launcher_can_launch_check
void _good773() async {
  final uri = Uri.parse('https://example.com');
