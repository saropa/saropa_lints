...
// Test fixture for: avoid_global_riverpod_providers
...
// BAD: Should trigger avoid_global_riverpod_providers
// expect_lint: avoid_global_riverpod_providers
void _bad743() {
  final myProvider = StateProvider((ref) => 0);
  // Global scope
}

// GOOD: Should NOT trigger avoid_global_riverpod_providers
void _good743() {
