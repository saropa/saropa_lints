...
// Test fixture for: require_hive_encryption_key_secure
...
// BAD: Should trigger require_hive_encryption_key_secure
// expect_lint: require_hive_encryption_key_secure
void _bad659() {
  final cipher = HiveAesCipher(base64.decode('hardcodedKeyHere=='));
  final cipher = HiveAesCipher([1, 2, 3, 4, 5]);
}

// GOOD: Should NOT trigger require_hive_encryption_key_secure
void _good659() async {
