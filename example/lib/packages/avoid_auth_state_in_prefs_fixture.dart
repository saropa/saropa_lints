...
// Test fixture for: avoid_auth_state_in_prefs
...
// BAD: Should trigger avoid_auth_state_in_prefs
// expect_lint: avoid_auth_state_in_prefs
void _bad765() async {
...
// GOOD: Should NOT trigger avoid_auth_state_in_prefs
void _good765() async {
  final secureStorage = FlutterSecureStorage();
