...
// Test fixture for: require_image_picker_result_handling
...
// BAD: Should trigger require_image_picker_result_handling
// expect_lint: require_image_picker_result_handling
void _bad69() async {
  final image = await picker.pickImage(source: ImageSource.camera);
  final bytes = await image.readAsBytes(); // Crashes if null!
}

// GOOD: Should NOT trigger require_image_picker_result_handling
void _good69() async {
  final image = await picker.pickImage(source: ImageSource.camera);
