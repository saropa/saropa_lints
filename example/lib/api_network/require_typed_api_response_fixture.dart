...
// Test fixture for: require_typed_api_response
...
// BAD: Should trigger require_typed_api_response
// expect_lint: require_typed_api_response
void _bad47() {
  final data = jsonDecode(response.body);
  final name = data['user']['name']; // Dynamic access
}

// GOOD: Should NOT trigger require_typed_api_response
void _good47() {
