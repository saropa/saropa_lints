...
// Test fixture for: require_input_sanitization
...
// BAD: Should trigger require_input_sanitization
// expect_lint: require_input_sanitization
void _bad991() {
  final query = 'SELECT * FROM users WHERE name = "$userInput"';
  webView.loadUrl(userProvidedUrl);
}

// GOOD: Should NOT trigger require_input_sanitization
void _good991() {
