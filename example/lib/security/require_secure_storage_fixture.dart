...
// Test fixture for: require_secure_storage
...
// BAD: Should trigger require_secure_storage
// expect_lint: require_secure_storage
void _bad990() {
  prefs.setString('auth_token', token);
  prefs.setString('password', password);
}

// GOOD: Should NOT trigger require_secure_storage
void _good990() {
