...
// Test fixture for: avoid_storing_sensitive_unencrypted
...
// BAD: Should trigger avoid_storing_sensitive_unencrypted
// expect_lint: avoid_storing_sensitive_unencrypted
void _bad1024() async {
  await prefs.setString('auth_token', token);
  await box.put('password', password);
}

// GOOD: Should NOT trigger avoid_storing_sensitive_unencrypted
void _good1024() async {
