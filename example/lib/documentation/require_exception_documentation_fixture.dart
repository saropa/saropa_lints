...
// Test fixture for: require_exception_documentation
...
// BAD: Should trigger require_exception_documentation
// expect_lint: require_exception_documentation
void _bad343() {
  /// Gets the user.
...
// GOOD: Should NOT trigger require_exception_documentation
void _good343() {
  /// Gets the user.
  ///
