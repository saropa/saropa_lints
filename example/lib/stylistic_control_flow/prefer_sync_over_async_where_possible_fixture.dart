...
// Test fixture for: prefer_sync_over_async_where_possible
// Source: lib\src\rules\stylistic_control_flow_rules.dart

import '../flutter_mocks.dart';

// BAD: Should trigger prefer_sync_over_async_where_possible
// expect_lint: prefer_sync_over_async_where_possible
class _BadClass1094 {
  // TODO: Add method declaration that triggers prefer_sync_over_async_where_possible
  void badMethod() {}
}

// GOOD: Should NOT trigger prefer_sync_over_async_where_possible
class _GoodClass1094 {
  // TODO: Add compliant method for prefer_sync_over_async_where_possible
  void goodMethod() {}
}
