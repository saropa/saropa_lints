...
// Test fixture for: require_graphql_error_handling
...
// BAD: Should trigger require_graphql_error_handling
// expect_lint: require_graphql_error_handling
void _bad371() async {
  final result = await client.query(options);
  final data = result.data!['users']; // May be null if there's an error!
}

// GOOD: Should NOT trigger require_graphql_error_handling
void _good371() async {
  final result = await client.query(options);
