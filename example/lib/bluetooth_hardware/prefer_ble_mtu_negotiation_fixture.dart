...
// Test fixture for: prefer_ble_mtu_negotiation
...
// BAD: Should trigger prefer_ble_mtu_negotiation
// expect_lint: prefer_ble_mtu_negotiation
void _bad128() async {
...
// GOOD: Should NOT trigger prefer_ble_mtu_negotiation
void _good128() async {
  await device.connect();
