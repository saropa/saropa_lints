...
// Test fixture for: require_geolocator_permission_check
// Source: lib\src\rules\bluetooth_hardware_rules.dart

import '../flutter_mocks.dart';

// BAD: Should trigger require_geolocator_permission_check
// expect_lint: require_geolocator_permission_check
void _bad124() async {
  final position = await Geolocator.getCurrentPosition();
}

// GOOD: Should NOT trigger require_geolocator_permission_check
void _good124() async {
