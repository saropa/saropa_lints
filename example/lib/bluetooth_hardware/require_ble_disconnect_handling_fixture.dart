...
// Test fixture for: require_ble_disconnect_handling
...
// BAD: Should trigger require_ble_disconnect_handling
// expect_lint: require_ble_disconnect_handling
void _bad121() async {
  await device.connect();
  // No disconnect handling - app breaks when device goes out of range
}

// GOOD: Should NOT trigger require_ble_disconnect_handling
void _good121() async {
  await device.connect();
