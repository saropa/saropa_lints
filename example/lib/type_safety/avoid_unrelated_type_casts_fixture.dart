...
// Test fixture for: avoid_unrelated_type_casts
...
// BAD: Should trigger avoid_unrelated_type_casts
// expect_lint: avoid_unrelated_type_casts
void _bad1245() {
  final str = 'hello';
...
// GOOD: Should NOT trigger avoid_unrelated_type_casts
void _good1245() {
  final obj = getValue();
  if (obj is int) {
