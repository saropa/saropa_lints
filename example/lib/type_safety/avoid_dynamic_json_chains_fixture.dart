...
// Test fixture for: avoid_dynamic_json_chains
...
// BAD: Should trigger avoid_dynamic_json_chains
// expect_lint: avoid_dynamic_json_chains
void _bad1248() {
  final value = json['data']['user']['address']['city'];
  final item = response['results']['items']['first']['name'];
}

// GOOD: Should NOT trigger avoid_dynamic_json_chains
void _good1248() {
