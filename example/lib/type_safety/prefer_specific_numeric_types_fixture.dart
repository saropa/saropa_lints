...
// Test fixture for: prefer_specific_numeric_types
...
// BAD: Should trigger prefer_specific_numeric_types
// expect_lint: prefer_specific_numeric_types
void _bad1240() {
  num calculate(num a, num b) => a + b;
}

// GOOD: Should NOT trigger prefer_specific_numeric_types
double _good1240_calculate(double a, double b) => a + b;
