...
// Test fixture for: avoid_dynamic_json_access
...
// BAD: Should trigger avoid_dynamic_json_access
// expect_lint: avoid_dynamic_json_access
void _bad1246() {
  final name = json['user']['profile']['name']; // Throws if any key missing
  final data = response['data']['items'][0]; // Unsafe chain
}

// GOOD: Should NOT trigger avoid_dynamic_json_access
void _good1246() {
