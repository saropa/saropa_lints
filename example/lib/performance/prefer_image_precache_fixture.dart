...
// Test fixture for: prefer_image_precache
...
// BAD: Should trigger prefer_image_precache
// expect_lint: prefer_image_precache
void _bad785() {
  // In build method
  Image.asset('assets/hero_image.png');
}

// GOOD: Should NOT trigger prefer_image_precache
void _good785() {
