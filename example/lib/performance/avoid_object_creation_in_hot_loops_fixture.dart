...
// Test fixture for: avoid_object_creation_in_hot_loops
...
// BAD: Should trigger avoid_object_creation_in_hot_loops
...
// GOOD: Should NOT trigger avoid_object_creation_in_hot_loops
void _good781() {
  final formatter = DateFormat('yyyy-MM-dd');
  for (final item in items) {
    print(formatter.format(item.date));
