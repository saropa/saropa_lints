...
// Test fixture for: avoid_ios_simulator_only_code
...
// BAD: Should trigger avoid_ios_simulator_only_code
// expect_lint: avoid_ios_simulator_only_code
void _bad849() {
  // Only works on Simulator running on Mac
  final file = File('/Users/developer/test.json');
}

// GOOD: Should NOT trigger avoid_ios_simulator_only_code
void _good849() async {
