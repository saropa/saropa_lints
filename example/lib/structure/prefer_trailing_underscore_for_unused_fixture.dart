...
// Test fixture for: prefer_trailing_underscore_for_unused
...
// BAD: Should trigger prefer_trailing_underscore_for_unused
// expect_lint: prefer_trailing_underscore_for_unused
void _bad1064() {
  list.map((item) => 'fixed');
}

// GOOD: Should NOT trigger prefer_trailing_underscore_for_unused
void _good1064() {
  list.map((_) => 'fixed');
}
