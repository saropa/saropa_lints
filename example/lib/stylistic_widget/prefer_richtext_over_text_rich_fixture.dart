...
// Test fixture for: prefer_richtext_over_text_rich
// Source: lib\src\rules\stylistic_widget_rules.dart

import '../flutter_mocks.dart';

// BAD: Should trigger prefer_richtext_over_text_rich
// expect_lint: prefer_richtext_over_text_rich
class _Bad1156 extends StatelessWidget {
  const _Bad1156({super.key});
  @override
  Widget build(BuildContext context) {
    // TODO: Add widget creation that triggers prefer_richtext_over_text_rich
    return Container();
  }
}

// GOOD: Should NOT trigger prefer_richtext_over_text_rich
class _Good1156 extends StatelessWidget {
  const _Good1156({super.key});
  @override
  Widget build(BuildContext context) {
    // TODO: Add compliant widget pattern for prefer_richtext_over_text_rich
    return Container();
  }
}
