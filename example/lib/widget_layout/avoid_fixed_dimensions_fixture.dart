...
// Test fixture for: avoid_fixed_dimensions
...
// BAD: Should trigger avoid_fixed_dimensions
// expect_lint: avoid_fixed_dimensions
void _bad1327() {
  SizedBox(width: 300, height: 400);
  Container(width: 500, height: 600);
}

// GOOD: Should NOT trigger avoid_fixed_dimensions
void _good1327() {
