...
// Test fixture for: prefer_logger_over_print
...
// BAD: Should trigger prefer_logger_over_print
// expect_lint: prefer_logger_over_print
void _bad1258() {
  print('User logged in: $userId'); // Shows in production logs!
}

// GOOD: Should NOT trigger prefer_logger_over_print
void _good1258() {
