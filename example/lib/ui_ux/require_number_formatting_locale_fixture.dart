...
// Test fixture for: require_number_formatting_locale
// Source: lib\src\rules\ui_ux_rules.dart

import '../flutter_mocks.dart';

dynamic locale;

// BAD: Should trigger require_number_formatting_locale
// expect_lint: require_number_formatting_locale
void _bad1255() {
  NumberFormat().format(number);
  NumberFormat.decimal().format(number);
}

// GOOD: Should NOT trigger require_number_formatting_locale
void _good1255() {
