...
// Test fixture for: prefer_descriptive_bool_names_strict
// Source: lib\src\rules\stylistic_rules.dart

import '../flutter_mocks.dart';

// BAD: Should trigger prefer_descriptive_bool_names_strict
// expect_lint: prefer_descriptive_bool_names_strict
void _bad1137() {
  // TODO: Add variable declaration that triggers prefer_descriptive_bool_names_strict
  var x = 0;
}

// GOOD: Should NOT trigger prefer_descriptive_bool_names_strict
void _good1137() {
  // TODO: Add compliant variable for prefer_descriptive_bool_names_strict
  final x = 0;
}
