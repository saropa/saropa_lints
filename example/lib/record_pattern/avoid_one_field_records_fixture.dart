...
// Test fixture for: avoid_one_field_records
...
// BAD: Should trigger avoid_one_field_records
// expect_lint: avoid_one_field_records
void _bad955() {
  (int,) singleField = (42,);
}

// GOOD: Should NOT trigger avoid_one_field_records
int _good955_value = 42;
