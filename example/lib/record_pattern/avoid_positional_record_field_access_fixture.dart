...
// Test fixture for: avoid_positional_record_field_access
...
// BAD: Should trigger avoid_positional_record_field_access
// expect_lint: avoid_positional_record_field_access
void _bad956() {
  final record = (1, 'hello');
  print(record.$1);
}

// GOOD: Should NOT trigger avoid_positional_record_field_access
void _good956() {
