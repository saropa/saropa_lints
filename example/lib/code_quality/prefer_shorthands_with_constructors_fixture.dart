...
// Test fixture for: prefer_shorthands_with_constructors
...
// BAD: Should trigger prefer_shorthands_with_constructors
// expect_lint: prefer_shorthands_with_constructors
void _bad209() {
  final items = list.map((e) => Item(e));
}

// GOOD: Should NOT trigger prefer_shorthands_with_constructors
void _good209() {
