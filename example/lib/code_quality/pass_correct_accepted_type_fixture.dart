...
// Test fixture for: pass_correct_accepted_type
...
// BAD: Should trigger pass_correct_accepted_type
// expect_lint: pass_correct_accepted_type
void _bad212_process(@Accept(String) int value) {} // Type mismatch

// GOOD: Should NOT trigger pass_correct_accepted_type
void _good212(
    @Accept(String) String value) {} // Parameter type matches annotation
