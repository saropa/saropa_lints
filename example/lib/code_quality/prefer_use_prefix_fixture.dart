...
// Test fixture for: prefer_use_prefix
// Source: lib\src\rules\code_quality_rules.dart

import '../flutter_mocks.dart';

// BAD: Should trigger prefer_use_prefix
// expect_lint: prefer_use_prefix
T _bad235_myHook<T>() => useHook(); // Missing use prefix

// GOOD: Should NOT trigger prefer_use_prefix
T _good235_useMyHook<T>() => useHook();
