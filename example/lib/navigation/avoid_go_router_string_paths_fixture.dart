...
// Test fixture for: avoid_go_router_string_paths
...
// BAD: Should trigger avoid_go_router_string_paths
// expect_lint: avoid_go_router_string_paths
void _bad517() {
  context.go('/users/123/profile');
  context.push('/settings');
}

// GOOD: Should NOT trigger avoid_go_router_string_paths
void _good517() {
