...
// Test fixture for: avoid_nested_routes_without_parent
...
// BAD: Should trigger avoid_nested_routes_without_parent
// expect_lint: avoid_nested_routes_without_parent
void _bad523() {
  // From unrelated screen:
  context.go('/products/details/123'); // Parent '/products' may not be in stack
}

// GOOD: Should NOT trigger avoid_nested_routes_without_parent
void _good523() {
