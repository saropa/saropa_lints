...
// Fixture for prefer_named_routes_for_deep_links

import 'package:saropa_lints_example/flutter_mocks.dart';

final context = BuildContext();

// BAD: Anonymous route — no settings/name. Should trigger prefer_named_routes_for_deep_links.
// expect_lint: prefer_named_routes_for_deep_links
void _badAnonymousRoute() {
  Navigator.push(
    context,
...
// GOOD: Named route via RouteSettings(name: ...). Should NOT trigger.
void _goodNamedRouteLiteral() {
  Navigator.push(
    context,
    MaterialPageRoute(
...
// GOOD: Variable route name (e.g. from onGenerateRoute). Should NOT trigger.
void _goodNamedRouteVariable(String routeName) {
  Navigator.push(
    context,
    MaterialPageRoute(
...
// BAD: Empty string name cannot be used for deep linking. Should trigger.
// expect_lint: prefer_named_routes_for_deep_links
void _badEmptyRouteName() {
  Navigator.push(
    context,
    MaterialPageRoute(
