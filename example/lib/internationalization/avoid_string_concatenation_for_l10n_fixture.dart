...
// Test fixture for: avoid_string_concatenation_for_l10n
...
// BAD: Should trigger avoid_string_concatenation_for_l10n
// expect_lint: avoid_string_concatenation_for_l10n
void _bad451() {
  Text('Hello, ' + userName + '!'); // Word order varies by language
}

// GOOD: Should NOT trigger avoid_string_concatenation_for_l10n
void _good451() {
