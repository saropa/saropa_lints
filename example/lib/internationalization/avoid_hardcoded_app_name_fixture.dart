...
// Test fixture for: avoid_hardcoded_app_name
...
// BAD: Should trigger avoid_hardcoded_app_name
// expect_lint: avoid_hardcoded_app_name
void _bad443() {
  AppBar(title: Text('MyApp'));
  Text('Welcome to MyApp!');
}

// GOOD: Should NOT trigger avoid_hardcoded_app_name
void _good443() {
