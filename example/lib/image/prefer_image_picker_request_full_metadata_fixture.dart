...
// Test fixture for: prefer_image_picker_request_full_metadata
...
// BAD: Should trigger prefer_image_picker_request_full_metadata
// expect_lint: prefer_image_picker_request_full_metadata
void _bad434() async {
  final image = await ImagePicker().pickImage(source: ImageSource.gallery);
  // Includes GPS, camera info, timestamps - may not be needed
}

// GOOD: Should NOT trigger prefer_image_picker_request_full_metadata
void _good434() async {
