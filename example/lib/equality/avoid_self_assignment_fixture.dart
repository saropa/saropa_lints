...
// Test fixture for: avoid_self_assignment
...
// BAD: Should trigger avoid_self_assignment
// expect_lint: avoid_self_assignment
void _bad347() {
  x = x;
  this.value = this.value;
}

// GOOD: Should NOT trigger avoid_self_assignment
void _good347() {
  x = newValue;
