# Task: `pubspec_ordering`

## Summary
- **Rule Name**: `pubspec_ordering`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
...
Pubspec fields should follow recommended ordering.
...
// TODO: Replace with concrete example for `pubspec_ordering`.
```
...
- Add package/docs links relevant to `pubspec_ordering` (e.g. bloc, riverpod, hive).
