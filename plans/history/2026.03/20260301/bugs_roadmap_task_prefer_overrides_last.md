# Task: `prefer_overrides_last`

## Summary
- **Rule Name**: `prefer_overrides_last`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
`@override` methods at bottom of class
...
// TODO: Replace with concrete example for `prefer_overrides_last`.
```
...
- Add package/docs links relevant to `prefer_overrides_last` (e.g. bloc, riverpod, hive).
