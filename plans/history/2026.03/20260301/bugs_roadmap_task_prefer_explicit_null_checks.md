# Task: `prefer_explicit_null_checks`

## Summary
- **Rule Name**: `prefer_explicit_null_checks`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
...
Prefer explicit null checks for clarity.
...
// TODO: Replace with concrete example for `prefer_explicit_null_checks`.
```
...
- Add package/docs links relevant to `prefer_explicit_null_checks` (e.g. bloc, riverpod, hive).
