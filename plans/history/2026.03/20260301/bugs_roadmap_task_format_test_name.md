# Task: `format_test_name`

## Summary
- **Rule Name**: `format_test_name`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
...
Test names should follow a consistent format.
...
// TODO: Replace with concrete example for `format_test_name`.
```
...
- Add package/docs links relevant to `format_test_name` (e.g. bloc, riverpod, hive).
