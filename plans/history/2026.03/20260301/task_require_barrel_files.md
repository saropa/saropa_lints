# Task: `require_barrel_files`

## Summary
- **Rule Name**: `require_barrel_files`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use barrel files for exports. Detect multiple individual imports.
...
// TODO: Replace with concrete example for `require_barrel_files`.
```
...
- Add package/docs links relevant to `require_barrel_files` (e.g. bloc, riverpod, hive).
