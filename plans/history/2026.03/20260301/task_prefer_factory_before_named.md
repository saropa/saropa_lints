# Task: `prefer_factory_before_named`

## Summary
- **Rule Name**: `prefer_factory_before_named`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
Factory constructors before named constructors
...
// TODO: Replace with concrete example for `prefer_factory_before_named`.
```
...
- Add package/docs links relevant to `prefer_factory_before_named` (e.g. bloc, riverpod, hive).
