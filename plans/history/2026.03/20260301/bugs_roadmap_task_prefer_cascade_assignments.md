# Task: `prefer_cascade_assignments`

## Summary
- **Rule Name**: `prefer_cascade_assignments`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
...
Prefer using cascade (..) for assignments to the same object.
...
// TODO: Replace with concrete example for `prefer_cascade_assignments`.
```
...
- Add package/docs links relevant to `prefer_cascade_assignments` (e.g. bloc, riverpod, hive).
