# Prefer Custom Finder Over Find (Widget Tests)

**GitHub:** [https://github.com/saropa/saropa_lints/issues/45](https://github.com/saropa/saropa_lints/issues/45)

**Resolved in:** N/A — Deferred (find vs find.byType pattern; test API). Issue closed.
...
### Problem  
Using custom finders in widget tests improves readability and maintainability over generic find calls.

### Why This Is Complex  
- **Pattern detection:** Requires analyzing test code for finder usage.
...
### Desired Outcome  
- Detect widget tests using generic find instead of custom finders.
- Warn about potential maintainability issues.
- Suggest using custom finders for clarity.
