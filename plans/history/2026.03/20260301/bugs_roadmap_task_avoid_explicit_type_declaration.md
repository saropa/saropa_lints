# Task: `avoid_explicit_type_declaration`

## Summary
- **Rule Name**: `avoid_explicit_type_declaration`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
- **Source**: ROADMAP.md — 1.56 Type Safety & Error Handling

## Problem Statement

Prefer type inference over explicit type declarations where the type is obvious.
...
// TODO: Replace with concrete example for `avoid_explicit_type_declaration`.
```
...
- Add package/docs links relevant to `avoid_explicit_type_declaration` (e.g. bloc, riverpod, hive).
