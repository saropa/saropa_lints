# Task: `prefer_factory_constructor`

## Summary
- **Rule Name**: `prefer_factory_constructor`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
...
Prefer factory constructors for object creation patterns.
...
// TODO: Replace with concrete example for `prefer_factory_constructor`.
```
...
- Add package/docs links relevant to `prefer_factory_constructor` (e.g. bloc, riverpod, hive).
