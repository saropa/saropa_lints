# Task: `prefer_if_else_over_guards`

## Summary
- **Rule Name**: `prefer_if_else_over_guards`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
...
Prefer if-else over guard clauses for certain logic.
...
// TODO: Replace with concrete example for `prefer_if_else_over_guards`.
```
...
- Add package/docs links relevant to `prefer_if_else_over_guards` (e.g. bloc, riverpod, hive).
