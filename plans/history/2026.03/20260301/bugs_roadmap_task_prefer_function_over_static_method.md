# Task: `prefer_function_over_static_method`

## Summary
- **Rule Name**: `prefer_function_over_static_method`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
Top-level functions over static methods
...
// TODO: Replace with concrete example for `prefer_function_over_static_method`.
```
...
- Add package/docs links relevant to `prefer_function_over_static_method` (e.g. bloc, riverpod, hive).
