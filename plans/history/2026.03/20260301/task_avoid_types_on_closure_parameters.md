# Task: `avoid_types_on_closure_parameters`

## Summary
- **Rule Name**: `avoid_types_on_closure_parameters`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
...
Avoid explicit types on closure parameters when unnecessary.
...
// TODO: Replace with concrete example for `avoid_types_on_closure_parameters`.
```
...
- Add package/docs links relevant to `avoid_types_on_closure_parameters` (e.g. bloc, riverpod, hive).
