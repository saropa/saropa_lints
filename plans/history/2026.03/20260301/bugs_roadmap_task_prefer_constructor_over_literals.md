# Task: `prefer_constructor_over_literals`

## Summary
- **Rule Name**: `prefer_constructor_over_literals`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
...
Prefer List()/Map() constructors over literals in certain contexts.
...
// TODO: Replace with concrete example for `prefer_constructor_over_literals`.
```
...
- Add package/docs links relevant to `prefer_constructor_over_literals` (e.g. bloc, riverpod, hive).
