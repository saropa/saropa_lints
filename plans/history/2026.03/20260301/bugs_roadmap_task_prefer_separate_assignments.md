# Task: `prefer_separate_assignments`

## Summary
- **Rule Name**: `prefer_separate_assignments`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
...
Prefer separate assignments over chained or compound assignments.
...
// TODO: Replace with concrete example for `prefer_separate_assignments`.
```
...
- Add package/docs links relevant to `prefer_separate_assignments` (e.g. bloc, riverpod, hive).
