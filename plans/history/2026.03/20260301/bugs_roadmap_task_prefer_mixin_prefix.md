# Task: `prefer_mixin_prefix`

## Summary
- **Rule Name**: `prefer_mixin_prefix`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
Mixins use `Mixin` suffix or no suffix
...
// TODO: Replace with concrete example for `prefer_mixin_prefix`.
```
...
- Add package/docs links relevant to `prefer_mixin_prefix` (e.g. bloc, riverpod, hive).
