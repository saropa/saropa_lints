# Task: `newline_before_pubspec_entry`

## Summary
- **Rule Name**: `newline_before_pubspec_entry`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
...
Add blank lines between major pubspec sections.
...
// TODO: Replace with concrete example for `newline_before_pubspec_entry`.
```
...
- Add package/docs links relevant to `newline_before_pubspec_entry` (e.g. bloc, riverpod, hive).
