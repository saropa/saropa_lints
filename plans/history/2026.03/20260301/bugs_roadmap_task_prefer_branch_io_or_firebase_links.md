# Task: `prefer_branch_io_or_firebase_links`

## Summary
- **Rule Name**: `prefer_branch_io_or_firebase_links`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Raw deep links break when app not installed. Branch.io or Firebase Dynamic Links provide install-then-open flow.
...
// TODO: Replace with concrete example for `prefer_branch_io_or_firebase_links`.
```
...
- Add package/docs links relevant to `prefer_branch_io_or_firebase_links` (e.g. bloc, riverpod, hive).
