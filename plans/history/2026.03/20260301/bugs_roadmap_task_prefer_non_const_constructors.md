# Task: `prefer_non_const_constructors`

## Summary
- **Rule Name**: `prefer_non_const_constructors`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
...
Prefer non-const constructors when mutation is required.
...
// TODO: Replace with concrete example for `prefer_non_const_constructors`.
```
...
- Add package/docs links relevant to `prefer_non_const_constructors` (e.g. bloc, riverpod, hive).
