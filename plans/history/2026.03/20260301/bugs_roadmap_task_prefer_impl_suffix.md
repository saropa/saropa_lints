# Task: `prefer_impl_suffix`

## Summary
- **Rule Name**: `prefer_impl_suffix`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
// TODO: Replace with concrete example for `prefer_impl_suffix`.
```
...
- Add package/docs links relevant to `prefer_impl_suffix` (e.g. bloc, riverpod, hive).
