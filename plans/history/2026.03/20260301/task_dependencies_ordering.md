# Task: `dependencies_ordering`

## Summary
- **Rule Name**: `dependencies_ordering`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
...
// TODO: Replace with concrete example for `dependencies_ordering`.
```
...
- Add package/docs links relevant to `dependencies_ordering` (e.g. bloc, riverpod, hive).
