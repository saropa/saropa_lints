# Task: `add_resolution_workspace`

## Summary
- **Rule Name**: `add_resolution_workspace`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Add resolution workspace for monorepo dependency management.
...
// TODO: Replace with concrete example for `add_resolution_workspace`.
```
...
- Add package/docs links relevant to `add_resolution_workspace` (e.g. bloc, riverpod, hive).
