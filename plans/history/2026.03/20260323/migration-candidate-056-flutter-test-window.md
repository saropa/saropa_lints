...
**Source plan:** `plans/implementable_only_in_plugin_extension/migration-candidate-056-deprecates_testwindow_in.md` (still the canonical checklist; quick fix and `expect_lint` fixture deferred: example packages are Dart-only).
