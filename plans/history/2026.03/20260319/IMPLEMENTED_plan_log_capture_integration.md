...
- **Comments:** api.ts and healthScore.ts reference plans/sync; violation_export _writeAtomicFile doc updated; setup runAnalysisForFiles JSDoc describes cap and progress.
