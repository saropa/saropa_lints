...
**For developers:** Canonical v4→v5 migration guide. Moved from `bugs/history/migration/` during history integration; init CLI and README reference this guide.
...
custom_lint:
  ...
  rules:
    - avoid_print_in_production: true
...
// AFTER (v5):
// ignore: saropa_lints/no_magic_number
```
...
# Severity overrides
severities:
  avoid_print_in_production: ERROR
  no_magic_number: false
