> **========================================================**
> **NOT VIABLE -- FALSE POSITIVE RATE TOO HIGH**
> **========================================================**
>
> Flags List.add() in State/ChangeNotifier without a size
> guard. But List.add() is used thousands of times in every
> Flutter app — filter chips, selected items, form entries,
> shopping carts. The linter cannot determine whether a list
> "should" have a bound (that's a domain-level decision).
> Even the spec's conservative Phase 1 would flag virtually
> every stateful list in a typical app.
>
> **========================================================**
