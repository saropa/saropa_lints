...
> **========================================================**
>
> Checks `claims['admin'] == true` used for UI gating. But
> the linter cannot distinguish security enforcement (bad)
> from UI personalization (fine). Every Firebase app with
> role-based UI (admin panels, moderator badges) would be
> falsely flagged. The code looks identical for both cases.
>
> **========================================================**
