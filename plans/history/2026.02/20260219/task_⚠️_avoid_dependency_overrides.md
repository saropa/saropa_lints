> **========================================================**
> **NOT VIABLE -- INFRASTRUCTURE BLOCKER**
> **========================================================**
>
> Requires reading `pubspec.yaml` to find `dependency_overrides:`
> sections. custom_lint rules only receive Dart AST nodes --
> they have no API to read YAML files.
>
> Same blocker affects all 11 deferred pubspec rules
> (avoid_any_version, require_version_constraint, etc.).
> Tracked in ROADMAP_DEFERRED.md under [PUBSPEC] tag.
>
> Would need either:
> - A pubspec-specific lint tool (separate from custom_lint)
> - A custom_lint extension exposing pubspec to rules
> - A pre-analysis step generating Dart from pubspec data
>
