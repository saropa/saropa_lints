...
> **========================================================**
>
> Flags instance methods accessing mutable global state.
> The allowlist would never converge: Theme.of(context),
> Navigator.of(context), MediaQuery.sizeOf(context),
> kDebugMode, Platform.isAndroid, GetIt.instance, every
> singleton pattern, every service locator, every static
> logger... A typical Flutter widget references 5-8 globals
> in build() alone. Estimated 90%+ false positive rate.
>
> **========================================================**
