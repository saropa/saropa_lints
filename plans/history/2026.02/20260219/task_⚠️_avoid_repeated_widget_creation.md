...
> **========================================================**
>
> Detecting "identical widgets in loops with all-constant
> arguments" requires deep expression analysis to determine
> if constructor args are truly constant and index-independent.
> The trivial case (all literal args) is rare in real code.
> Complex cases (is `_getColor()` pure? is `icons[0]` stable?)
> are unreliable. Narrow detection surface doesn't justify
