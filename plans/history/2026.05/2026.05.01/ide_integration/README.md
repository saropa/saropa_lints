...
Run each step in order, fill in the result column, and commit the updated table. Treat any **FAIL** as a blocker for the milestone in [`plans/TESTING_AND_RELEASE.md`](../../../TESTING_AND_RELEASE.md) §8 row "IDE integration sign-off".
