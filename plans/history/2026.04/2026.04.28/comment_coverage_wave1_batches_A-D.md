...
Archived from the former `plans/PLAN_comment_coverage_worst_offenders.md`. **Not** a live to-do list; see [COMMENT_COVERAGE_PLAN.md](../../COMMENT_COVERAGE_PLAN.md) for ongoing maintenance.
