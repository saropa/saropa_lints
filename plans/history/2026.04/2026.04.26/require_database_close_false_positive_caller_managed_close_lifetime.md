...
- `plans/history/2026.03/20260303/require_database_close_false_positive_string_literal_rule_files.md` — different scope (rule files self-trigger). Already fixed.
