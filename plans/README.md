...
| plan_additional_rules_31_through_40 | Generators, enums, docs ([history/20260323/plan_additional_rules_31_through_40.md](history/20260323/plan_additional_rules_31_through_40.md)) |
...
All additional-rule plans are ordered by **developer usefulness** (BLOCKER → MAJOR → MINOR; then Wow; then Effort). Batches **1–10**, **11–20**, **21–30**, and **31–40** are done (see `plans/history/` completion records). Remaining roadmap rows are listed in [ROADMAP.md § Additional rules](../../ROADMAP.md#additional-rules).
