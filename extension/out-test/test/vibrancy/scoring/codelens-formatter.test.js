...
const codelens_formatter_1 = require("../../../vibrancy/scoring/codelens-formatter");
...
describe('categoryEmoji', () => {
    it('should return green for vibrant', () => {
        assert.strictEqual((0, codelens_formatter_1.categoryEmoji)('vibrant'), '🟢');
    });
    it('should return yellow for quiet', () => {
        assert.strictEqual((0, codelens_formatter_1.categoryEmoji)('quiet'), '🟡');
    });
    it('should return orange for legacy-locked', () => {
        assert.strictEqual((0, codelens_formatter_1.categoryEmoji)('legacy-locked'), '🟠');
    });
    it('should return orange for stale', () => {
        assert.strictEqual((0, codelens_formatter_1.categoryEmoji)('stale'), '🟠');
    });
    it('should return red for end-of-life', () => {
        assert.strictEqual((0, codelens_formatter_1.categoryEmoji)('end-of-life'), '🔴');
    });
});
describe('formatCodeLensTitle', () => {
    describe('minimal detail', () => {
        it('should show only score and category', () => {
            ...
            const title = (0, codelens_formatter_1.formatCodeLensTitle)(result, 'minimal');
    ...
    describe('standard detail', () => {
        it('should include up-to-date when no update', () => {
            const title = (0, codelens_formatter_1.formatCodeLensTitle)(makeResult(), 'standard');
        ...
        it('should include update info when available', () => {
            ...
            const title = (0, codelens_formatter_1.formatCodeLensTitle)(result, 'standard');
    ...
    describe('full detail', () => {
        it('should include archive size when available', () => {
            const result = makeResult({ archiveSizeBytes: 1_048_576 });
            const title = (0, codelens_formatter_1.formatCodeLensTitle)(result, 'full');
...
//# sourceMappingURL=codelens-formatter.test.js.map