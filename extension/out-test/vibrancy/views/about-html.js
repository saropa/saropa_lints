...
exports.buildAboutHtml = buildAboutHtml;
const MARKETPLACE_URL = 'https://marketplace.visualstudio.com/items?itemName=saropa.saropa-package-vibrancy';
const GITHUB_URL = 'https://github.com/saropa/saropa-package-vibrancy';
/** Build the full HTML for the About panel. */
function buildAboutHtml(version) {
    const sections = [
...
function getPackageInfoHtml(version) {
    return `
...
function getExtensionsListHtml() {
...
`;
//# sourceMappingURL=about-html.js.map