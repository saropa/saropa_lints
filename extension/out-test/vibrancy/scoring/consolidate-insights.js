...
exports.consolidateInsights = consolidateInsights;
exports.collectProblems = collectProblems;
exports.computeCombinedRisk = computeCombinedRisk;
exports.determineSuggestedAction = determineSuggestedAction;
exports.findUnlockedPackages = findUnlockedPackages;
 ...
 */
function consolidateInsights(results, overrides, splits) {
    const insights = [];
    ...
    for (const result of results) {
        ...
        const unlocksIfFixed = findUnlockedPackages(result.package.name, results, overrides);
        insights.push({
 ...
 */
function collectProblems(result, overrideMap, splitMap) {
    const problems = [];
 ...
 */
function computeCombinedRisk(problems, result) {
    let score = 0;
 ...
 */
function determineSuggestedAction(problems, result) {
 ...
 */
function findUnlockedPackages(packageName, results, overrides) {
    const unlocked = [];
    for (const result of results) {
...
//# sourceMappingURL=consolidate-insights.js.map