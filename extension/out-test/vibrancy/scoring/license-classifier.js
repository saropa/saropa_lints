...
exports.licenseEmoji = licenseEmoji;
...
function classifyLicense(spdx) {
    ...
    if (isOr) {
        return leastRestrictive(tiers);
    }
    return mostRestrictive(tiers);
}
function leastRestrictive(tiers) {
    if (tiers.includes('permissive')) {
        return 'permissive';
    }
    if (tiers.includes('copyleft')) {
        return 'copyleft';
    }
    return 'unknown';
}
...
//# sourceMappingURL=license-classifier.js.map