...
exports.findOverridesSection = findOverridesSection;
exports.findOverrideRange = findOverrideRange;
/**
 ...
 */
function parseOverrides(yamlContent) {
 ...
 */
function findOverridesSection(yamlContent) {
    const lines = yamlContent.split('\n');
    let startLine = -1;
    let endLine = -1;
    for (let i = 0; i < lines.length; i++) {
 ...
 */
function findOverrideRange(yamlContent, packageName) {
    const lines = yamlContent.split('\n');
    let inOverrides = false;
    let startLine = -1;
    for (let i = 0; i < lines.length; i++) {
