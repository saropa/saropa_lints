...
function generateGitHubActions(thresholds) {
...
function generateGitLabCi(thresholds) {
    return `# Generated by Saropa Package Vibrancy
...
function generateShellScript(thresholds) {
    const failOnVuln = thresholds.failOnVulnerability ? 'true' : 'false';
    return `#!/bin/bash
