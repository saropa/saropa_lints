/**
 * Slices of the package-vibrancy report's client-side script, split out of
 * report-script.ts so the ~1850-line script string is not one function. Each
 * returns a fragment of the SAME IIFE body; the composer there concatenates
 * them in order, so the assembled script is byte-identical and runs in one
 * scope exactly as before. No interpolation.
 */

export function reportScriptPart1(): string {
    return `
...
export function reportScriptPart2(): string {
    return `
...
export function reportScriptPart3(): string {
    return `
...
export function reportScriptPart4(): string {
    return `
...
export function reportScriptPart5(): string {
    return `
...
export function reportScriptPart6(): string {
    return `
...
export function reportScriptPart7(): string {
    return `
...
export function reportScriptPart8(): string {
    return `
...
export function reportScriptPart9(): string {
    return `
