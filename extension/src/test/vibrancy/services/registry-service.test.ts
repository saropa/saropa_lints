...
/**
 * Tests [RegistryService]: scoped registry URLs per package, [MockSecretStorage] persistence,
 * dispose clears listeners, and error paths when credentials are missing.
 */
