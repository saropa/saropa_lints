...
export const RULE_PACK_DEFINITIONS: readonly RulePackDefinition[] = [
  ...
  {
    id: 'device_calendar_plus',
    label: 'device_calendar_plus',
    matchPubNames: ['device_calendar_plus'],
    ruleCodes: [
  ...
  {
    id: 'migrate_accessibility_lint',
    label: 'Migrate from accessibility_lint',
    matchPubNames: ['accessibility_lint'],
    ruleCodes: [
      'avoid_icon_buttons_without_tooltip',
      'avoid_small_touch_targets',
      'require_image_semantics',
  ...
  {
    id: 'migrate_awesome_lints',
    label: 'Migrate from awesome_lints',
    matchPubNames: ['awesome_lints'],
    ruleCodes: [
      'avoid_accessing_other_classes_private_members',
      'avoid_always_null_parameters',
      'avoid_assigning_to_static_field',
  ...
  {
    id: 'migrate_bloc_lint',
    label: 'Migrate from bloc_lint',
    matchPubNames: ['bloc_lint'],
    ruleCodes: [
      'avoid_cubit_usage',
      'avoid_returning_value_from_cubit_methods',
      'avoid_ui_in_domain_layer',
  ...
  {
    id: 'migrate_dart_code_linter',
    label: 'Migrate from dart_code_linter',
    matchPubNames: ['dart_code_linter'],
    ruleCodes: [
  ...
  {
    id: 'migrate_dart_code_metrics_presets',
    label: 'Migrate from dart_code_metrics_presets',
    matchPubNames: ['dart_code_metrics_presets'],
    ruleCodes: [
      'always_remove_getx_listener',
  ...
  {
    id: 'migrate_dcm',
    label: 'Migrate from DCM',
    matchPubNames: ['dart_code_metrics', 'dcm'],
    ruleCodes: [
      'NewlineBeforeReturnRule',
      'always_remove_listener',
      'avoid_accessing_collections_by_constant_index',
  ...
  {
    id: 'migrate_equatable_lint',
    label: 'Migrate from equatable_lint',
    matchPubNames: ['equatable_lint'],
    ruleCodes: [
      'list_all_equatable_fields',
    ],
  },
  {
    id: 'migrate_essential_lints',
    label: 'Migrate from essential_lints',
    matchPubNames: ['essential_lints'],
    ruleCodes: [
      'avoid_assignments_as_conditions',
      'avoid_missing_completer_stack_trace',
      'avoid_positional_boolean_parameters_with_fix',
  ...
  {
    id: 'migrate_flutter_best_practices_lints',
    label: 'Migrate from flutter_best_practices_lints',
    matchPubNames: ['flutter_best_practices_lints'],
    ruleCodes: [
      'prefer_dedicated_media_query_method',
      'prefer_match_file_name',
    ],
  ...
  {
    id: 'migrate_flutter_custom_lints',
    label: 'Migrate from flutter_custom_lints',
    matchPubNames: ['flutter_custom_lints'],
    ruleCodes: [
      'avoid_non_null_assertion',
      'dispose_class_fields',
      'dispose_widget_fields',
  ...
  {
    id: 'migrate_flutter_doctor_ai',
    label: 'Migrate from flutter_doctor_ai',
    matchPubNames: ['flutter_doctor_ai'],
    ruleCodes: [
      'avoid_empty_setstate',
      'avoid_long_functions',
  ...
  {
    id: 'migrate_flutter_hooks_lint',
    label: 'Migrate from flutter_hooks_lint',
    matchPubNames: ['flutter_hooks_lint'],
    ruleCodes: [
      'avoid_hooks_outside_build',
      'avoid_unnecessary_hook_widgets',
      'prefer_use_prefix',
  ...
  {
    id: 'migrate_flutter_quality_lints',
    label: 'Migrate from flutter_quality_lints',
    matchPubNames: ['flutter_quality_lints'],
    ruleCodes: [
      'avoid_cross_feature_dependencies',
  ...
  {
    id: 'migrate_flutter_sane_lints',
    label: 'Migrate from flutter_sane_lints',
    matchPubNames: ['flutter_sane_lints'],
    ruleCodes: [
      'avoid_hardcoded_strings_in_ui',
      'prefer_switch_with_enums',
    ],
  ...
  {
    id: 'migrate_flutter_skill_lints',
    label: 'Migrate from flutter_skill_lints',
    matchPubNames: ['flutter_skill_lints'],
    ruleCodes: [
      'always_remove_listener',
      'avoid_accessing_collections_by_constant_index',
      'avoid_accessing_other_classes_private_members',
  ...
  {
    id: 'migrate_hardcoded_strings_lint',
    label: 'Migrate from hardcoded_strings_lint',
    matchPubNames: ['hardcoded_strings_lint'],
    ruleCodes: [
      'avoid_hardcoded_strings_in_ui',
    ],
  },
  {
    id: 'migrate_klin_dart',
    label: 'Migrate from klin_dart',
    matchPubNames: ['klin_dart'],
    ruleCodes: [
      'avoid_hardcoded_strings_in_ui',
      'no_magic_string',
    ],
  ...
  {
    id: 'migrate_leancode_lint',
    label: 'Migrate from leancode_lint',
    matchPubNames: ['leancode_lint'],
    ruleCodes: [
      'avoid_collection_equality_checks',
      'avoid_conditional_hooks',
      'avoid_deprecated_use_inherited_media_query',
  ...
  {
    id: 'migrate_mad_lint',
    label: 'Migrate from mad_lint',
    matchPubNames: ['mad_lint'],
    ruleCodes: [
      'NewlineBeforeReturnRule',
      'avoid_incomplete_copy_with',
      'avoid_non_null_assertion',
  ...
  {
    id: 'migrate_many_lints',
    label: 'Migrate from many_lints',
    matchPubNames: ['many_lints'],
    ruleCodes: [
      'always_remove_listener',
      'avoid_accessing_collections_by_constant_index',
      'avoid_accessing_other_classes_private_members',
  ...
  {
    id: 'migrate_pyramid_lint',
    label: 'Migrate from pyramid_lint',
    matchPubNames: ['pyramid_lint'],
    ruleCodes: [
      'NewlineBeforeReturnRule',
      'avoid_border_all',
      'avoid_dynamic_type',
  ...
  {
    id: 'migrate_ripplearc_linter',
    label: 'Migrate from ripplearc_linter',
    matchPubNames: ['ripplearc_linter'],
    ruleCodes: [
      'avoid_catch_all',
  ...
  {
    id: 'migrate_solid_lints',
    label: 'Migrate from solid_lints',
    matchPubNames: ['solid_lints'],
    ruleCodes: [
      'avoid_global_state',
      'avoid_high_cyclomatic_complexity',
      'avoid_late_keyword',
  ...
  {
    id: 'migrate_very_good_analysis',
    label: 'Migrate from very_good_analysis',
    matchPubNames: ['very_good_analysis'],
    ruleCodes: [
      'avoid_positional_boolean_parameters_with_fix',
      'avoid_print_in_production',
