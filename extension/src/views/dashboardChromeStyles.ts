...
function chromeBaseLayout(): string {
...
function chromeHeroAndGauge(): string {
  return `
.dash-hero {
  position: relative;
  display: grid;
...
function chromeKpiCards(): string {
  return `
.kpi-row {
  display: grid;
...
function chromeToolbarAndButtons(): string {
  return `
.toolbar-band {
  position: sticky;
  top: 0;
...
function chromeChipStrip(): string {
  return `
.chip-strip {
  display: flex; flex-wrap: wrap; align-items: center;
  gap: 6px;
...
function chromeChartAndDonut(): string {
...
function chromeTableBase(): string {
  return `
.dash-table-wrap {
  border: 1px solid var(--border);
  border-radius: 10px;
...
function chromeMicroAndMotion(): string {
  return `
 ...
 */
function chromeEmptyAndError(): string {
  return `
.empty-cta {
  display: flex;
  flex-direction: column;
 ...
 */
function chromeAccessibility(): string {
  return `
.sr-only {
  position: absolute;
  width: 1px;
 ...
 */
function chromePrintStyles(): string {
  return `
@media print {
 ...
 */
function chromeReducedMotion(): string {
  return `
@media (prefers-reduced-motion: reduce) {
  .dash-hero,
  .kpi-card,
