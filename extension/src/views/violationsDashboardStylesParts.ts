/**
 * Per-section slices of the Findings (violations) dashboard stylesheet,
 * split out of violationsDashboardStyles.ts so the ~1300-line CSS string is
 * not one function. Each returns a static CSS fragment; the composer there
 * concatenates them in order. No interpolation — output is byte-identical.
 */

export function vdsPart1(): string {
    return `
    :root {
...
export function vdsPart2(): string {
    return `
    /* ============================================================
...
export function vdsPart3(): string {
    return `
    /* ============================================================
...
export function vdsPart4(): string {
    return `
    /* ============================================================
...
export function vdsPart5(): string {
    return `
    /* ============================================================
...
export function vdsPart6(): string {
    return `
    /* ============================================================
...
export function vdsPart7(): string {
    return `
    /* ============================================================
...
export function vdsPart8(): string {
    return `
    /* ============================================================
...
export function vdsPart9(): string {
    return `
    /* ============================================================
