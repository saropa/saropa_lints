...
export const projectCatalogEntries: readonly CatalogEntry[] = [
  ...
  },
  {
    ...
    title: 'Disable Saropa Lints',
    description: 'Turn off both live analysis and scan on save for the current project.',
    category: 'Setup & Configuration',
    icon: 'circle-slash',
  },
  {
    command: 'saropaLints.reenablePlugin',
    title: 'Re-enable Live Analysis',
    description: 'Restore the plugins: block after Disable Saropa Lints and restart the analysis server.',
    category: 'Setup & Configuration',
    icon: 'debug-restart',
  },
  {
