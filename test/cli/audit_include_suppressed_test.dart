...
void main() {
  ...
  group('suppressedDiagnosticMaps', () {
    test(
      'flag absent (captureDetails off): suppressions are captured with no '
      ...
      () {
        ...
        final maps = suppressedDiagnosticMaps(
          minSeverity: null,
          minImpact: null,
        );
    ...
    test(
      'flag present (captureDetails on): a suppressed finding is re-emitted '
      ...
      () {
        ...
        expect(
          ...
          'Add a body or remove the block.',
        );
    ...
    test(
      'defaults column/endLine/endColumn when the reporter could not '
