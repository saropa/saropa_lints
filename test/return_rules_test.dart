...
void main() {
  group('Return Rules - Rule Instantiation', () {
    test('AvoidReturningCascadesRule', () {
      ...
      expect(rule.code.name.toLowerCase(), 'avoid_returning_cascades');
    ...
    test('AvoidReturningThisRule', () {
      ...
      expect(rule.code.name.toLowerCase(), 'avoid_returning_this');
    ...
    test('AvoidReturningVoidRule', () {
      ...
      expect(rule.code.name.toLowerCase(), 'avoid_returning_void');
    ...
    test('AvoidUnnecessaryReturnRule', () {
      ...
      expect(rule.code.name.toLowerCase(), 'avoid_unnecessary_return');
    ...
    test('PreferImmediateReturnRule', () {
      ...
      expect(rule.code.name.toLowerCase(), 'prefer_immediate_return');
    ...
    test('PreferReturningShorthandsRule', () {
      ...
      expect(rule.code.name.toLowerCase(), 'prefer_returning_shorthands');
      expect(
    ...
    test('AvoidReturningNullForVoidRule', () {
      ...
      expect(rule.code.name.toLowerCase(), 'avoid_returning_null_for_void');
      expect(
        rule.code.problemMessage,
    ...
    test('AvoidReturningNullForFutureRule', () {
      ...
      expect(rule.code.name.toLowerCase(), 'avoid_returning_null_for_future');
      expect(
        rule.code.problemMessage,
