...
'''), isEmpty);
    ...
    test('does NOT fire when normalized against a matching-case literal',
        () async {
      expect(await _codes('''
bool isAdminRole(String role) => role.toLowerCase() == 'admin';
'''), isEmpty);
    ...
    test('does NOT fire when upper-normalized against an uppercase literal',
        () async {
      expect(await _codes('''
bool isAdminRole(String role) => role.toUpperCase() != 'ADMIN';
'''), isEmpty);
...
'''), isEmpty);
    ...
    test('does NOT fire on compareTo used for ordering rather than equality',
        () async {
      expect(await _codes('''
