...
void main() {
  ...
  group('require_rtl_layout_support physical-corner enum mapper', () {
    ...
    test(
      'plain Alignment.topLeft (non-switch) still triggers — no AST hit',
      () {
        ...
        // identity mapper arm.
        final unit = parseString(content: 'final a = Alignment.topLeft;').unit;
    ...
    test(
      'identity-named switch arm has SwitchExpressionCase parent + matching ConstantPattern',
      () {
