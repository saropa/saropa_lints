...
void main() {
  group('Getx Rules - Rule Instantiation', () {
    ...
    testRule('RequireGetxWorkerDisposeRule', 'require_getx_worker_dispose', () => RequireGetxWorkerDisposeRule());
    testRule('RequireGetxPermanentCleanupRule', 'require_getx_permanent_cleanup', () => RequireGetxPermanentCleanupRule());
    testRule('AvoidGetxContextOutsideWidgetRule', 'avoid_getx_context_outside_widget', () => AvoidGetxContextOutsideWidgetRule());
    testRule('AvoidGetxGlobalNavigationRule', 'avoid_getx_global_navigation', () => AvoidGetxGlobalNavigationRule());
    testRule('RequireGetxBindingRoutesRule', 'require_getx_binding_routes', () => RequireGetxBindingRoutesRule());
    testRule('AvoidGetxDialogSnackbarInControllerRule', 'avoid_getx_dialog_snackbar_in_controller', () => AvoidGetxDialogSnackbarInControllerRule());
    testRule('RequireGetxLazyPutRule', 'require_getx_lazy_put', () => RequireGetxLazyPutRule());
    testRule('AvoidGetFindInBuildRule', 'avoid_get_find_in_build', () => AvoidGetFindInBuildRule());
    testRule('RequireGetxControllerDisposeRule', 'require_getx_controller_dispose', () => RequireGetxControllerDisposeRule());
    testRule('AvoidObsOutsideControllerRule', 'avoid_obs_outside_controller', () => AvoidObsOutsideControllerRule());
    testRule('ProperGetxSuperCallsRule', 'proper_getx_super_calls', () => ProperGetxSuperCallsRule());
    testRule('AlwaysRemoveGetxListenerRule', 'always_remove_getx_listener', () => AlwaysRemoveGetxListenerRule());
    testRule('AvoidGetxRxInsideBuildRule', 'avoid_getx_rx_inside_build', () => AvoidGetxRxInsideBuildRule());
    testRule('AvoidMutableRxVariablesRule', 'avoid_mutable_rx_variables', () => AvoidMutableRxVariablesRule());
    testRule('DisposeGetxFieldsRule', 'dispose_getx_fields', () => DisposeGetxFieldsRule());
    testRule('PreferGetxBuilderRule', 'prefer_getx_builder', () => PreferGetxBuilderRule());
    testRule('RequireGetxBindingRule', 'require_getx_binding', () => RequireGetxBindingRule());
    testRule('AvoidGetxGlobalStateRule', 'avoid_getx_global_state', () => AvoidGetxGlobalStateRule());
    testRule('AvoidGetxStaticContextRule', 'avoid_getx_static_context', () => AvoidGetxStaticContextRule());
    testRule('AvoidTightCouplingWithGetxRule', 'avoid_tight_coupling_with_getx', () => AvoidTightCouplingWithGetxRule());
    testRule('AvoidGetxStaticGetRule', 'avoid_getx_static_get', () => AvoidGetxStaticGetRule());
    testRule('AvoidGetxBuildContextBypassRule', 'avoid_getx_build_context_bypass', () => AvoidGetxBuildContextBypassRule());
    testRule('AvoidGetxRxNestedObsRule', 'avoid_getx_rx_nested_obs', () => AvoidGetxRxNestedObsRule());
  });
