...
void main() {
  group('Debug Rules - Rule Instantiation', () {
    test('AlwaysFailRule (prefer_fail_test_case)', () {
      ...
      expect(rule.code.name, 'prefer_fail_test_case');
    ...
    test('AvoidDebugPrintRule (avoid_debug_print)', () {
      ...
      expect(rule.code.name, 'avoid_debug_print');
    ...
    test('AvoidUnguardedDebugRule (avoid_unguarded_debug)', () {
      ...
      expect(rule.code.name, 'avoid_unguarded_debug');
    ...
    test('PreferCommentingAnalyzerIgnoresRule', () {
      ...
      expect(rule.code.name, 'prefer_commenting_analyzer_ignores');
      expect(
    ...
    test('AvoidPrintInReleaseRule (avoid_print_in_release)', () {
      ...
      expect(rule.code.name, 'avoid_print_in_release');
    ...
    test('RequireStructuredLoggingRule', () {
      ...
      expect(rule.code.name, 'require_structured_logging');
      expect(
        rule.code.problemMessage,
    ...
    test('AvoidSensitiveInLogsRule (avoid_sensitive_in_logs)', () {
      ...
      expect(rule.code.name, 'avoid_sensitive_in_logs');
    ...
    test('RequireLogLevelForProductionRule', () {
      ...
      expect(rule.code.name, 'require_log_level_for_production');
      expect(
        rule.code.problemMessage,
