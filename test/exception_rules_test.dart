...
void main() {
  group('Exception Rules - Rule Instantiation', () {
    test('AvoidNonFinalExceptionClassFieldsRule', () {
      ...
      expect(rule.code.name.toLowerCase(), 'avoid_non_final_exception_class_fields');
      expect(
    ...
    test('AvoidOnlyRethrowRule', () {
      ...
      expect(rule.code.name.toLowerCase(), 'avoid_only_rethrow');
    ...
    test('AvoidThrowInCatchBlockRule', () {
      ...
      expect(rule.code.name.toLowerCase(), 'avoid_throw_in_catch_block');
      expect(
        rule.code.problemMessage,
    ...
    test('AvoidThrowObjectsWithoutToStringRule', () {
      ...
      expect(rule.code.name.toLowerCase(), 'avoid_throw_objects_without_tostring');
      expect(
        rule.code.problemMessage,
    ...
    test('PreferPublicExceptionClassesRule', () {
      ...
      expect(rule.code.name.toLowerCase(), 'prefer_public_exception_classes');
      expect(
        rule.code.problemMessage,
