...
| Package                                                                            | Description                                                                                                                                                                                                                                           |
| :--------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **[saropa_lints](https://pub.dev/packages/saropa_lints)**                          | **2100+ Custom Rules.** Catch memory leaks, security vulnerabilities (mapped to OWASP Top 10), and runtime crashes that standard linters miss. Includes AI-ready diagnostics for faster repairs.                                                      |
