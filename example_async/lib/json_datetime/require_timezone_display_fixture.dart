...
// BAD: Named constructor with time-only format
// expect_lint: require_timezone_display
void _bad459b() {
  final fmt = DateFormat.Hm(); // No timezone!
}

// GOOD: Should NOT trigger require_timezone_display
void _good459() {
  final fmt = DateFormat('yyyy-MM-dd HH:mm z');
}

// GOOD: Date-only format (no time = no timezone needed)
void _good459b() {
  final fmt = DateFormat('yyyy-MM-dd');
}

// GOOD: Named constructor with timezone
void _good459c() {
