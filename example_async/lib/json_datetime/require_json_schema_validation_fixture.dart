...
// Test fixture for: require_json_schema_validation
...
// BAD: Should trigger require_json_schema_validation
// expect_lint: require_json_schema_validation
void _bad457() async {
...
// GOOD: Should NOT trigger require_json_schema_validation
void _good457() async {
  final response = await http.get(Uri.parse('https://api.example.com/user'));
  final json = jsonDecode(response.body);
