...
// Test fixture for: prefer_duration_constants
// Source: lib\src\rules\json_datetime_rules.dart

import '../flutter_mocks.dart';

// BAD: Should trigger prefer_duration_constants
// expect_lint: prefer_duration_constants
void _bad455() {
  Duration(seconds: 60);
...
// GOOD: Should NOT trigger prefer_duration_constants
void _good455() {
  Duration(minutes: 1);
  Duration(seconds: 1);
  Duration(hours: 1);
