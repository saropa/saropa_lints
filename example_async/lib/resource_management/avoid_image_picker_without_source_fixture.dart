...
// Test fixture for: avoid_image_picker_without_source
...
// BAD: Should trigger avoid_image_picker_without_source
// expect_lint: avoid_image_picker_without_source
void _bad975() async {
  final image = await ImagePicker().pickImage(); // Missing source!
}

// GOOD: Should NOT trigger avoid_image_picker_without_source
void _good975() async {
