...
// Test fixture for: require_url_validation
...
// BAD: Should trigger require_url_validation
// expect_lint: require_url_validation
void _bad1016() {
  final url = Uri.parse(userInput);
  http.get(url);
}

// GOOD: Should NOT trigger require_url_validation
void _good1016() {
  final url = Uri.parse(userInput);
  if (url.scheme != 'https') {
