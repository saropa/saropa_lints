...
// Test fixture for: avoid_clipboard_sensitive
...
// BAD: Should trigger avoid_clipboard_sensitive
// expect_lint: avoid_clipboard_sensitive
void _bad997() {
  Clipboard.setData(ClipboardData(text: password));
  Clipboard.setData(ClipboardData(text: user.secretToken));
}

// GOOD: Should NOT trigger avoid_clipboard_sensitive
void _good997() {
