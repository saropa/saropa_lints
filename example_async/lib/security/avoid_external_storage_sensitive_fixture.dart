...
// Test fixture for: avoid_external_storage_sensitive
...
// BAD: Should trigger avoid_external_storage_sensitive
// expect_lint: avoid_external_storage_sensitive
void _bad1017() async {
  final dir = await getExternalStorageDirectory();
  File('${dir.path}/user_credentials.json').writeAsString(creds);
}

// GOOD: Should NOT trigger avoid_external_storage_sensitive
void _good1017() async {
