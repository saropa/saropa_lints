...
// Test fixture for: prefer_typed_data
...
// BAD: Should trigger prefer_typed_data
// expect_lint: prefer_typed_data
void _bad1002() async {
  final List<int> bytes = utf8.encode(text);
  final List<int> fileContents = await file.readAsBytes();
}

// GOOD: Should NOT trigger prefer_typed_data
void _good1002() async {
