...
// Test fixture for: avoid_storing_passwords
...
// BAD: Should trigger avoid_storing_passwords
// expect_lint: avoid_storing_passwords
void _bad998() {
  prefs.setString('password', userPassword);
  prefs.setString('user_password', value);
}

// GOOD: Should NOT trigger avoid_storing_passwords
void _good998() async {
