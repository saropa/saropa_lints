...
// GOOD: Should NOT trigger require_feature_flag_type_safety
void _good270() {
  final enabled = featureFlags.isEnabled(FeatureFlag.newCheckoutFlow);
}

// FALSE POSITIVE: isEnabled on a non-flag object
void _fp270_notificationEnabled() {
  final ok = notification.isEnabled('push');
}

// FALSE POSITIVE: getBool on SharedPreferences (not a flag target)
void _fp270_sharedPrefs() {
  final dark = sharedPrefs.getBool('dark_mode');
}
