...
// Test fixture for: avoid_hardcoded_config_test
...
// BAD: Should trigger avoid_hardcoded_config_test
// expect_lint: avoid_hardcoded_config_test
void _bad269() {
  // test/utils_test.dart
  final url = 'https://api.example.com/v1/users'; // INFO
}

// GOOD: Should NOT trigger avoid_hardcoded_config_test
void _good269() {
  // test/utils_test.dart
