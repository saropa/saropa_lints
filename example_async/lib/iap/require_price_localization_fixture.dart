...
// Test fixture for: require_price_localization
// Source: lib\src\rules\iap_rules.dart

import 'package:saropa_lints_example/flutter_mocks.dart';

// BAD: Should trigger require_price_localization
// expect_lint: require_price_localization
void _bad420() {
  Text('Only \$4.99/month!');
  Text('Price: \$9.99');
}

// GOOD: Should NOT trigger require_price_localization
void _good420() {
