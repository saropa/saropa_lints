...
// Test fixture for: avoid_synchronous_file_io
...
// BAD: Should trigger avoid_synchronous_file_io
// expect_lint: avoid_synchronous_file_io
void _bad779() {
  final content = File('data.txt').readAsStringSync();
}

// GOOD: Should NOT trigger avoid_synchronous_file_io
void _good779() async {
