...
// Test fixture for: avoid_global_key_misuse
...
// BAD: Should trigger avoid_global_key_misuse
// expect_lint: avoid_global_key_misuse
void _bad791() {
...
// GOOD: Should NOT trigger avoid_global_key_misuse
void _good791() {
