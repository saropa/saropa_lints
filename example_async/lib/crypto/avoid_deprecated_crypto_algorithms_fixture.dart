...
// BAD: Should trigger avoid_deprecated_crypto_algorithms
// expect_lint: avoid_deprecated_crypto_algorithms
void _bad300() {
  final hash = md5.convert(utf8.encode(data));
  final hash = sha1.convert(utf8.encode(data));
}

// GOOD: Should NOT trigger avoid_deprecated_crypto_algorithms
void _good300() {
