...
// Test fixture for: require_sqflite_close
...
// BAD: Should trigger require_sqflite_close
// expect_lint: require_sqflite_close
void _bad376() async {
...
// GOOD: Should NOT trigger require_sqflite_close
void _good376() async {
  final db = await openDatabase('my_db.db');
  try {
    //use db
