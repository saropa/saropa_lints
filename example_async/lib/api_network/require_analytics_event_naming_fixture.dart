...
// BAD: Should trigger require_analytics_event_naming
// expect_lint: require_analytics_event_naming
void _bad75() {
  analytics.logEvent(name: 'UserSignedUp');
}

// GOOD: Should NOT trigger require_analytics_event_naming
void _good75() {
  analytics.logEvent(name: 'user_signed_up');
}

// FALSE POSITIVE: track() on a non-analytics object
void _fp75_shipmentTrack() {
  shipment.track('FedEx-123');
}

// FALSE POSITIVE: sendEvent() on a state machine
void _fp75_stateMachine() {
  stateMachine.sendEvent('UpdateUI');
}
