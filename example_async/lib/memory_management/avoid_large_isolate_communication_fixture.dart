...
// BAD: Should trigger avoid_large_isolate_communication
// expect_lint: avoid_large_isolate_communication
void _bad473() async {
  await compute(processData, largeList); // Copies entire list
  isolatePort.send(hugeByteArray); // Expensive copy
}

// GOOD: Should NOT trigger avoid_large_isolate_communication
void _good473() async {
