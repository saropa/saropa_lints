...
// Test fixture for: prefer_camera_resolution_selection
...
// BAD: Should trigger prefer_camera_resolution_selection
// expect_lint: prefer_camera_resolution_selection
void _bad465() {
  final controller = CameraController(camera, ResolutionPreset.max);
}

// GOOD: Should NOT trigger prefer_camera_resolution_selection
void _good465() {
