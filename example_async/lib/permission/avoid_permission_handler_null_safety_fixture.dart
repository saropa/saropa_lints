...
// Test fixture for: avoid_permission_handler_null_safety
...
// BAD: Should trigger avoid_permission_handler_null_safety
// expect_lint: avoid_permission_handler_null_safety
void _bad825() async {
  final handler = PermissionHandler();
  var status = await handler.checkPermissionStatus(PermissionGroup.camera);
}

// GOOD: Should NOT trigger avoid_permission_handler_null_safety
void _good825() async {
