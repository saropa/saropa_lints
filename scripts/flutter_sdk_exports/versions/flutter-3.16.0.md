...
This page has release notes for 3.16.0. For information about subsequent bug-fix releases, see our [CHANGELOG](https://github.com/flutter/flutter/blob/main/CHANGELOG.md). 
...
#
  ...
  * Bump gradle heap size limit in _everywhere_ by @zanderso in [134665](https://github.com/flutter/flutter/pull/134665)
...
Unless stated otherwise, the documentation on this site reflects Flutter 3.41.2. Page last updated on 2025-11-08.  [View source](https://github.com/flutter/website/blob/main/src/content/release/release-notes/release-notes-3.16.0.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/release/release-notes/release-notes-3.16.0&page-source=https://github.com/flutter/website/blob/main/src/content/release/release-notes/release-notes-3.16.0.md "Report an issue with this page").
