...
This page has release notes for 3.29.0. For information about subsequent bug-fix releases, check out the Flutter [CHANGELOG](https://github.com/flutter/flutter/blob/main/CHANGELOG.md). 
...
#
  ...
  * [Web] Allow specifying the strategy on when to use  element to display images by @dkwingsmt in 159917 
  ...
  * Add platform-android label for all flutter_tools _android_ files by @jmagman in 159166
  ...
  * [web] On the web platform, use an  tag to show an image if it can't be accessed with CORS by @harryterkelsen in 157755 
...
Unless stated otherwise, the documentation on this site reflects Flutter 3.41.2. Page last updated on 2025-11-08.  [View source](https://github.com/flutter/website/blob/main/src/content/release/release-notes/release-notes-3.29.0.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/release/release-notes/release-notes-3.29.0&page-source=https://github.com/flutter/website/blob/main/src/content/release/release-notes/release-notes-3.29.0.md "Report an issue with this page").
