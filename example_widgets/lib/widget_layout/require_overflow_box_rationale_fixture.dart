...
// Test fixture for: require_overflow_box_rationale
...
// BAD: Should trigger require_overflow_box_rationale
// expect_lint: require_overflow_box_rationale
void _bad1329() {
  final isDark = Theme.of(context).brightness == Brightness.dark;
  final textColor = isDark ? Colors.white : Colors.black;
}

// GOOD: Should NOT trigger require_overflow_box_rationale
void _good1329() {
