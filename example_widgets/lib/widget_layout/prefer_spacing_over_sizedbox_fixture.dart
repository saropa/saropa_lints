...
// Test fixture for: prefer_spacing_over_sizedbox
...
// BAD: Should trigger prefer_spacing_over_sizedbox
// expect_lint: prefer_spacing_over_sizedbox
void _bad1306() {
  Text('Very long paragraph that users might want to copy');
}

// GOOD: Should NOT trigger prefer_spacing_over_sizedbox
void _good1306() {
