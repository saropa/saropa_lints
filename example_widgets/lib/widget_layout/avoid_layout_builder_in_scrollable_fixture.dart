...
// Test fixture for: avoid_layout_builder_in_scrollable
...
// BAD: Should trigger avoid_layout_builder_in_scrollable
// expect_lint: avoid_layout_builder_in_scrollable
void _bad1315() {
  Image(image: FileImage(File('assets/logo.png')));
}

// GOOD: Should NOT trigger avoid_layout_builder_in_scrollable
void _good1315() {
