...
// Test fixture for: require_https_over_http
...
// BAD: Should trigger require_https_over_http
// expect_lint: require_https_over_http
void _bad1452() async {
  final response = await http.get(Uri.parse('http://api.example.com/data'));
}

// GOOD: Should NOT trigger require_https_over_http
void _good1452() async {
