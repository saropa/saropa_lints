...
// Test fixture for: avoid_fitted_box_for_text
...
// BAD: Should trigger avoid_fitted_box_for_text
// expect_lint: avoid_fitted_box_for_text
void _bad1402() {
  FittedBox(child: Text('Long text'));
}

// GOOD: Should NOT trigger avoid_fitted_box_for_text
void _good1402() {
