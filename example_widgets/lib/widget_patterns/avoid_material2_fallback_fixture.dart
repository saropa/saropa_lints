...
// Test fixture for: avoid_material2_fallback
...
// BAD: Should trigger avoid_material2_fallback
// expect_lint: avoid_material2_fallback
void _bad1405() {
  Column(children: [Text('A'), SizedBox(height: 8), Text('B')]);
}

// GOOD: Should NOT trigger avoid_material2_fallback
void _good1405() {
