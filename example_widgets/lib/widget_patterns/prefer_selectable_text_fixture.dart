...
// Test fixture for: prefer_selectable_text
...
// BAD: Should trigger prefer_selectable_text
// expect_lint: prefer_selectable_text
void _bad1404() {
  SizedBox.expand(child: MyWidget());
}

// GOOD: Should NOT trigger prefer_selectable_text
void _good1404() {
