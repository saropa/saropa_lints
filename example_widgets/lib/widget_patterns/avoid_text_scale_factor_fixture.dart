...
// Test fixture for: avoid_text_scale_factor
...
// BAD: Should trigger avoid_text_scale_factor
// expect_lint: avoid_text_scale_factor
void _bad1383() {
  MediaQuery.textScaleFactorOf(context);
  MediaQuery.of(context).textScaleFactor;
}

// GOOD: Should NOT trigger avoid_text_scale_factor
void _good1383() {
