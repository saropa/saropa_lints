...
// Test fixture for: avoid_implicit_animation_dispose_cast
// Source: lib/src/rules/ui/animation_rules.dart
// Migration: Flutter PR #111849 (ImplicitlyAnimatedWidgetState internal CurvedAnimation)

import 'package:saropa_lints_example/flutter_mocks.dart';

// ============================================================================
// BAD: Should trigger avoid_implicit_animation_dispose_cast
// ============================================================================

class _BadImplicitAnimWidget extends ImplicitlyAnimatedWidget {
  const _BadImplicitAnimWidget({super.key, required super.duration});
  @override
  State<_BadImplicitAnimWidget> createState() => _BadImplicitAnimState();
}

// expect_lint: avoid_implicit_animation_dispose_cast
class _BadImplicitAnimState
    extends ImplicitlyAnimatedWidgetState<_BadImplicitAnimWidget> {
  @override
...
// ============================================================================
// GOOD: Should NOT trigger avoid_implicit_animation_dispose_cast
// ============================================================================

class _GoodImplicitAnimWidget extends ImplicitlyAnimatedWidget {
  const _GoodImplicitAnimWidget({super.key, required super.duration});
  @override
  State<_GoodImplicitAnimWidget> createState() => _GoodImplicitAnimState();
}

class _GoodImplicitAnimState
    extends ImplicitlyAnimatedWidgetState<_GoodImplicitAnimWidget> {
  @override
  Widget build(BuildContext context) => const SizedBox();
...
// OK: Cast for CurvedAnimation members other than dispose (narrow rule)
class _GoodCurveReadWidget extends ImplicitlyAnimatedWidget {
  const _GoodCurveReadWidget({super.key, required super.duration});
  @override
  State<_GoodCurveReadWidget> createState() => _GoodCurveReadState();
}

class _GoodCurveReadState
    extends ImplicitlyAnimatedWidgetState<_GoodCurveReadWidget> {
  dynamic curveRead;

  @override
  Widget build(BuildContext context) {
    curveRead = (animation as CurvedAnimation).curve;
