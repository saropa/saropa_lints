...
// Test fixture for: require_scroll_controller_dispose
...
// BAD: Should trigger require_scroll_controller_dispose
// expect_lint: require_scroll_controller_dispose
void _bad1359() {
  Text('');
  Text("");
...
// GOOD: Should NOT trigger require_scroll_controller_dispose
void _good1359() {
  SizedBox.shrink();
