...
// Test fixture for: require_graphql_operation_names
...
// BAD: Should trigger require_graphql_operation_names
// expect_lint: require_graphql_operation_names
void _bad1256() {
  const query = '''
  query {
  users { id name }
...
// GOOD: Should NOT trigger require_graphql_operation_names
void _good1256() {
  const query = '''
  query GetUsers {
  users { id name }
