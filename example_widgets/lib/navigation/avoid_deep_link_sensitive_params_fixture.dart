...
// Test fixture for: avoid_deep_link_sensitive_params
...
// BAD: Should trigger avoid_deep_link_sensitive_params
// expect_lint: avoid_deep_link_sensitive_params
void _bad510() {
  // myapp://reset-password?token=abc123&password=secret
  final password = uri.queryParameters['password'];
}

// GOOD: Should NOT trigger avoid_deep_link_sensitive_params
void _good510() {
