...
// Test fixture for: avoid_pop_without_result
...
// BAD: Should trigger avoid_pop_without_result
// expect_lint: avoid_pop_without_result
void _bad507() async {
  final result = await Navigator.push(context);
  saveData(result); // May be null if user pressed back!
}

// GOOD: Should NOT trigger avoid_pop_without_result
void _good507() async {
