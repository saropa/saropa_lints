...
<!-- Custom Badges -->
[![rules](https://img.shields.io/badge/rules-1698%2B-4B0082)](https://github.com/saropa/saropa_lints/blob/main/doc/rules/README.md)
...
The tier system lets you adopt gradually — start with ~100 critical rules, work up to 1698+ when you're ready.
...
See [example/analysis_options_template.yaml](https://github.com/saropa/saropa_lints/blob/main/example/analysis_options_template.yaml) for a complete reference with all 1698+ rules organized by category, tier membership, and examples.
...
Running all 1698+ rules uses significant memory. The tier system helps:
...
- `comprehensive`/`insanity`: 1518+ rules → **slowest** (everything)
