...
Coverage: 1 HAVE (33%), 0 PARTIAL (0%), 2 TODO (67%).
...
| `avoid_src_import_from_other_subpackage` | TODO | TODO — no proposal filed yet |
| `avoid_src_import_from_same_package` | TODO | TODO — no proposal filed yet |
