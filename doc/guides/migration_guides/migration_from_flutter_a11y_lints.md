...
| `A02` — label contains redundant role words ("button"/"icon") | TODO | TODO — see [proposal](../../../plans/tier_3_infrastructure/proposal_a02_redundant_role_words.md). |
...
| `A05` — remove redundant `Semantics(button: true)` wrapper on a primitive button | TODO | TODO — see [proposal](../../../plans/tier_3_infrastructure/proposal_a05_redundant_semantics_button_wrapper.md). |
| `A06` — interactive control with multiple semantic parts should use `MergeSemantics` | HAVE | `prefer_merge_semantics` |
| `A07` — `Semantics()` label replacement must exclude children (prevents double announcement) | TODO | TODO — see [proposal](../../../plans/tier_3_infrastructure/proposal_a07_semantics_label_excludes_children.md). |
| `A09` — numeric-only label missing units | TODO | TODO — see [proposal](../../../plans/tier_3_infrastructure/proposal_a09_numeric_label_missing_units.md). |
| `A13` — composite control should present a single semantic role (2+ focusable descendants) | TODO | TODO — see [proposal](../../../plans/tier_3_infrastructure/proposal_a13_composite_control_single_role.md). |
...
| `A21` — use `IconButton.tooltip` instead of wrapping with `Tooltip` | TODO | TODO — see [proposal](../../../plans/tier_3_infrastructure/proposal_a21_prefer_iconbutton_tooltip.md). |
| `A22` — avoid `MergeSemantics` on the `ListTile` family (double-announcement) | TODO | TODO — see [proposal](../../../plans/tier_3_infrastructure/proposal_avoid_merge_semantics_list_tile.md) |
