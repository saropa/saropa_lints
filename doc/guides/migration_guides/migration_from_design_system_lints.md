...
| `edge_insets` | TODO | TODO — see [proposal](../../../plans/tier_3_infrastructure/proposal_use_design_system.md) |
| `box_shadow` | TODO | TODO — see [proposal](../../../plans/tier_3_infrastructure/proposal_edge_insets.md) |
| `radius` | TODO | TODO — see [proposal](../../../plans/tier_3_infrastructure/proposal_use_design_system.md) |
| `text_style` | TODO | TODO — see [proposal](../../../plans/tier_3_infrastructure/proposal_text_style.md) (saropa's similarly-named `avoid_hardcoded_text_styles` is a false cognate about `onHover`, not a match) |
| `theme_data` | TODO | TODO — see [proposal](../../../plans/tier_3_infrastructure/proposal_theme_data.md) |
| `box_constraints` | TODO | TODO — see [proposal](../../../plans/tier_3_infrastructure/proposal_use_design_system.md) |
