...
|---|---|---|
| `team_guard.forbidden_widget` — generic project-configurable "ban this widget/class, suggest this replacement" mechanism with an import-fixing quick fix | TODO | Planned (Gap Theme 2 — generic, user-configurable architecture/import-boundary engines) |
