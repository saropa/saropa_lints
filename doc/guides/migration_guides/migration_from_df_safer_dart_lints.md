...
| `no_future_outcome_type` | TODO | TODO — see [proposal](../../../bugs/tier_4_needs_decision/proposal_no_future_outcome_type.md) |
| `must_be_anonymous` | TODO | TODO — see [proposal](../../../bugs/tier_2_high_value/proposal_must_be_anonymous.md) |
| `must_be_strong_ref` | TODO | TODO — see [proposal](../../../bugs/tier_2_high_value/proposal_must_be_strong_ref.md) |
| `no_futures` | TODO | TODO — see [proposal](../../../bugs/tier_4_needs_decision/proposal_no_futures.md) |
| `must_use_unsafe_wrapper` | TODO | TODO — see [proposal](../../../bugs/tier_2_high_value/proposal_must_use_unsafe_wrapper.md) |
| `sendable` | TODO | TODO — see [proposal](../../../bugs/tier_2_high_value/proposal_sendable.md) |
