...
| `no_direct_iterable_access` | TODO | Flags any direct `[]` index access on `Iterable`/`List`, suggesting a project-defined `safeAt()` extension. TODO — see [proposal](../../../bugs/tier_2_high_value/proposal_no_direct_iterable_access.md) |
