...
| `always_call_super_props_when_overriding_equatable_props` | TODO | TODO — closest existing proposal (not an exact scope match): [proposal](../../../plans/tier_2_high_value/proposal_avoid_equatable_call_on_equality_base_class.md) |
