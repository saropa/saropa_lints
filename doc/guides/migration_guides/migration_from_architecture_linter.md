...
| `architecture_linter_config_file_error` | TODO | TODO — see [proposal](../../../bugs/proposal_architecture_linter_config_file_error.md) (tool self-diagnostic, not a code-quality rule) |
| `architecture_linter_layers_not_found` | TODO | TODO — see [proposal](../../../bugs/proposal_architecture_linter_layers_not_found.md) (tool self-diagnostic, not a code-quality rule) |
| `architecture_linter_banned_imports_not_found` | TODO | TODO — see [proposal](../../../bugs/proposal_architecture_linter_banned_imports_not_found.md) (tool self-diagnostic, not a code-quality rule) |
