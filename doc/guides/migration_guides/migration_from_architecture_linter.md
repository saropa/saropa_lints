...
Coverage: 0 HAVE (0%), 1 PARTIAL (25%), 3 TODO (75%) — audited 2026-09-02 against github.com/Iteo/architecture_linter.
...
| `architecture_linter_config_file_error` | TODO | TODO — no proposal filed yet (tool self-diagnostic, not a code-quality rule) |
| `architecture_linter_layers_not_found` | TODO | TODO — no proposal filed yet (tool self-diagnostic, not a code-quality rule) |
| `architecture_linter_banned_imports_not_found` | TODO | TODO — no proposal filed yet (tool self-diagnostic, not a code-quality rule) |
