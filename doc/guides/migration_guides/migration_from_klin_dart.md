...
Coverage: 2 HAVE (33%), 3 PARTIAL (50%), 1 TODO (17%).
...
| `class_length` | TODO | TODO — no proposal filed yet. `avoid_god_class` exists but measures member count, not LOC — a different metric, not a substitute |
