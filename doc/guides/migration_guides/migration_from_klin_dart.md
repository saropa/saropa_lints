...
| `class_length` | TODO | TODO — see [proposal](../../../bugs/proposal_function_lines_of_code.md). `avoid_god_class` exists but measures member count, not LOC — a different metric, not a substitute |
