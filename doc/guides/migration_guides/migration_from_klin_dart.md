...
| `class_length` | TODO | TODO — see [proposal](../../../plans/history/2026.09/2026.09.06/proposal_function_lines_of_code.md). `avoid_god_class` exists but measures member count, not LOC — a different metric, not a substitute |
