...
|---|---|---|
| `missing_field_in_equatable_props` (flags an instance field missing from `hashParameters`) | TODO | TODO — see [proposal](../../../bugs/proposal_missing_field_in_equatable_props.md) |
| `always_call_super_props_when_overriding_equatable_props` (flags a `hashParameters` override that drops the parent's fields) | TODO | TODO — see [proposal](../../../bugs/proposal_always_call_super_props_when_overriding_equatable_props.md) |
