...
final List<SaropaLintRule Function()> _allRuleFactories =
  ...
  RequireLateAccessCheckRule.new,
  ...
  AvoidReferencingSubclassesRule.new,
  ...
  PreferForeachRule.new,
  PreferForeachOverMapEntriesRule.new,
  PreferConstructorOverLiteralsRule.new,
  ...
  PreferBasePrefixRule.new,
  PreferExtensionSuffixRule.new,
  PreferMixinPrefixRule.new,
  PreferIPrefixInterfacesRule.new,
  PreferNoIPrefixInterfacesRule.new,
  PreferImplSuffixRule.new,
  ...
  PreferConstructorsOverStaticMethodsRule.new,
  PreferFunctionOverStaticMethodRule.new,
  PreferStaticMethodOverFunctionRule.new,
  PreferImportOverPartRule.new,
  PreferExtensionMethodsRule.new,
  ...
  PreferInlineFunctionTypesRule.new,
  PreferResultTypeRule.new,
  ...
  PreferAdjectiveBoolGettersRule.new,
  ...
  PreferNonConstConstructorsRule.new,
  ...
  AvoidTypesOnClosureParametersRule.new,
  AvoidExplicitTypeDeclarationRule.new,
  PreferExplicitNullChecksRule.new,
  PreferOptionalNamedParamsRule.new,
  PreferOptionalPositionalParamsRule.new,
  PreferPositionalBoolParamsRule.new,
  ...
  PreferThenCatchErrorRule.new,
  PreferFireAndForgetRule.new,
  ...
  RequirePaginationForLargeListsRule.new,
  ...
  PreferDriftBatchOperationsRule.new,
  RequireDriftStreamCancelRule.new,
  AvoidDriftDatabaseOnMainIsolateRule.new,
  AvoidDriftLogStatementsProductionRule.new,
  AvoidDriftGetSingleWithoutUniqueRule.new,
  PreferDriftUseColumnsFalseRule.new,
  AvoidDriftLazyDatabaseRule.new,
  PreferDriftIsolateSharingRule.new,
  AvoidDriftQueryInMigrationRule.new,
  RequireDriftSchemaVersionBumpRule.new,
  AvoidDriftForeignKeyInMigrationRule.new,
  RequireDriftReadsFromRule.new,
  ...
  PreferFinalLocalsRule.new,
  PreferConstDeclarationsRule.new,
  PreferGettersBeforeSettersRule.new,
  PreferIfElementsToConditionalExpressionsRule.new,
  PreferInlinedAddsRule.new,
  PreferInterpolationToComposeRule.new,
  PreferLowercaseConstantsRule.new,
  PreferMixinOverAbstractRule.new,
  PreferNamedBoolParamsRule.new,
  PreferNounClassNamesRule.new,
  PreferNullAwareMethodCallsRule.new,
  PreferRawStringsRule.new,
  PreferRecordOverTupleClassRule.new,
