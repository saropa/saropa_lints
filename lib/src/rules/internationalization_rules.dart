...
class RequireIntlArgsMatchRule extends SaropaLintRule {
  ...
  static const LintCode _code = LintCode(
    ...
    problemMessage:
        '[require_intl_args_match] Intl.message placeholders and args do not match. Missing or extra args cause runtime errors and incorrect translations.',
    correctionMessage:
        'Update Intl.message so every placeholder in the string has a matching argument, and vice versa. Example: args: [name, count] for "Hello {name}, you have {count} messages".',
