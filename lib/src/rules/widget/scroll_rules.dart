...
class PreferSliverForMixedScrollRule extends SaropaLintRule {
  ...
  static const LintCode _code = LintCode(
    'prefer_sliver_for_mixed_scroll',
    '[prefer_sliver_for_mixed_scroll] ListView/GridView with shrinkWrap in '
        'Column. Prefer CustomScrollView with slivers for mixed scroll content.',
    correctionMessage:
        'Use CustomScrollView and slivers (SliverList, SliverToBoxAdapter) instead.',
    severity: DiagnosticSeverity.INFO,
  );
