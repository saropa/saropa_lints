...
class PreferTryParseForDynamicDataRule extends SaropaLintRule {
  ...
  static const LintCode _code = LintCode(
    ...
    problemMessage:
        '[prefer_try_parse_for_dynamic_data] Using parse() on dynamic or user-provided data throws exceptions on invalid input, causing crashes or unhandled errors. tryParse() returns null instead, allowing safe validation.',
    correctionMessage:
        'Use tryParse() for parsing dynamic or user input, and handle null results to avoid exceptions.',
...
class RequireDateFormatSpecificationRule extends SaropaLintRule {
  ...
  static const LintCode _code = LintCode(
    ...
    correctionMessage: 'Use DateTime.tryParse() for safety or DateFormat for specific formats.',
    errorSeverity: DiagnosticSeverity.WARNING,
  );
