...
class PreferSpecifyingFutureValueTypeRule extends SaropaLintRule {
  ...
  static const LintCode _code = LintCode(
    ...
    problemMessage:
        '[prefer_specifying_future_value_type] Future.value() without type loses compile-time safety, returning Future<dynamic>. Consequence: This can lead to type errors, runtime bugs, and harder-to-maintain code.',
...
class AvoidStreamInBuildRule extends SaropaLintRule {
  ...
  static const LintCode _code = LintCode(
    ...
    problemMessage:
        '[avoid_stream_in_build] Creating a StreamController inside build() will create a new instance every frame, leaking previous streams and listeners. This causes memory leaks and unpredictable app behavior.',
    correctionMessage:
        'Always create StreamController in initState() and store it as a field to avoid leaks and keep your app stable.',
    errorSeverity: DiagnosticSeverity.ERROR,
  );
