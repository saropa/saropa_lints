...
class AvoidHiveFieldIndexReuseRule extends SaropaLintRule {
  ...
  static const LintCode _code = LintCode(
    ...
    correctionMessage:
        'Assign a unique index to each @HiveField annotation within a class. Duplicate indices cause data corruption, serialization errors, and loss of user data. Carefully review all field indices to ensure uniqueness.',
    errorSeverity: DiagnosticSeverity.ERROR,
  );
