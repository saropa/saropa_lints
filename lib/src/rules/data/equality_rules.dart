...
class AvoidUnnecessaryCompareToRule extends SaropaLintRule {
  ...
  void runWithReporter(
    ...
    context.addBinaryExpression((BinaryExpression node) {
      ...
      if (leftOp is MethodInvocation && rightOp is IntegerLiteral) {
        compareToCall = leftOp;
        zeroLiteral = rightOp;
      } else if (rightOp is MethodInvocation && leftOp is IntegerLiteral) {
        compareToCall = rightOp;
        zeroLiteral = leftOp;
      }
