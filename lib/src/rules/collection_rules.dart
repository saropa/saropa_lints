...
class PreferContainsRule extends SaropaLintRule {
  ...
  static const LintCode _code = LintCode(
    ...
    problemMessage:
        '[prefer_list_contains] Use contains() instead of indexOf() for presence checks.',
...
class PreferFirstRule extends SaropaLintRule {
  ...
  static const LintCode _code = LintCode(
    ...
    problemMessage: '[prefer_list_first] Use .first instead of [0].',
...
class PreferLastRule extends SaropaLintRule {
  ...
  static const LintCode _code = LintCode(
    ...
    problemMessage: '[prefer_list_last] Use .last instead of [length - 1].',
...
class AvoidDuplicateNumberElementsRule extends SaropaLintRule {
  ...
  static const LintCode _code = LintCode(
    ...
    correctionMessage: 'Remove the duplicate element or suppress if intentional.',
    errorSeverity: DiagnosticSeverity.WARNING,
  );
...
void _checkForDuplicateObjects(
  ...
  for (final CollectionElement element in elements) {
    ...
    if (element is IntegerLiteral || element is DoubleLiteral || element is StringLiteral) {
      continue;
    }
...
class PreferCorrectForLoopIncrementRule extends SaropaLintRule {
  ...
  static const LintCode _code = LintCode(
    ...
    problemMessage:
        '[prefer_correct_for_loop_increment] For loop uses non-standard increment pattern.',
