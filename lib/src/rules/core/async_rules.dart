...
class PreferFutureVoidFunctionOverAsyncCallbackRule extends SaropaLintRule {
  ...
  @override
  String get exampleBad => 'final AsyncCallback onTap;';

  @override
  String get exampleGood => 'final Future<void> Function() onTap;';
...
class PreferStreamDistinctRule extends SaropaLintRule {
  ...
  bool _hasVoidOrNullTypeArg(InterfaceType type) {
    ...
    final arg = typeArgs.firstOrNull;
    return arg != null && (arg is VoidType || arg.isDartCoreNull);
  }
...
class AvoidVoidAsyncRule extends SaropaLintRule {
  ...
  void _check(
    ...
    if (actualBody == null || !actualBody.isAsynchronous) return;
...
bool _isAnimationControllerTickerAwait(Expression expression) {
  ...
  return targetTypeName == 'AnimationController';
}
