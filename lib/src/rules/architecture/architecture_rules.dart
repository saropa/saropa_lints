...
class AvoidCircularImportsRule extends SaropaLintRule {
  ...
  String _formatCycle(List<String> cycle) {
    ...
    // Truncate long cycles (names.length > 3, so last index is valid)
...
class PreferBuilderPatternRule extends SaropaLintRule {
  PreferBuilderPatternRule() : super(code: _code);
