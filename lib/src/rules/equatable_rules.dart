...
class ListAllEquatableFieldsRule extends SaropaLintRule {
  ...
  static const LintCode _code = LintCode(
    ...
    correctionMessage: 'Add all instance fields to the props getter for correct equality.',
...
class AvoidMutableFieldInEquatableRule extends SaropaLintRule {
  ...
  static const LintCode _code = LintCode(
    ...
    correctionMessage:
        'Declare all fields in Equatable classes as final. Mutable fields break value equality, cause subtle bugs, and make state management unreliable. Use the copyWith pattern for updates instead of mutating fields.',
...
class RequireDeepEqualityCollectionsRule extends SaropaLintRule {
  ...
  static const LintCode _code = LintCode(
    ...
    correctionMessage: 'Use DeepCollectionEquality().hash(collection) or wrap in unmodifiable.',
    errorSeverity: DiagnosticSeverity.WARNING,
  );
