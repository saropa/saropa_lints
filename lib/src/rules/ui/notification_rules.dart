...
///
/// Important notifications may need a custom sound for accessibility or branding.
///
/// **Bad:** AndroidNotificationDetails without sound configuration.
///
/// **Good:** Set sound or document default sound usage.
class PreferNotificationCustomSoundRule extends SaropaLintRule {
  ...
  static const LintCode _code = LintCode(
    'prefer_notification_custom_sound',
    '[prefer_notification_custom_sound] Consider custom sound for important '
        'notifications. Document or set sound in AndroidNotificationDetails.',
    correctionMessage:
        'Add sound to notification details or document default sound usage.',
    severity: DiagnosticSeverity.INFO,
  );
  ...
  void runWithReporter(
    ...
    context.addInstanceCreationExpression((InstanceCreationExpression node) {
      ...
      if (name != 'AndroidNotificationDetails') return;
      reporter.atNode(node);
    });
  }
}
