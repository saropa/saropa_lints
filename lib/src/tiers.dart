...
const Set<String> professionalOnlyRules = <String>{
  ...
  // REMAINING_ROADMAP_RULES (Medium – High importance)
...
const Set<String> comprehensiveOnlyRules = <String>{
  ...
  // Pack-gated migrations (dio_5 / bloc_8); stripped from tier enables unless
  // the owning rule pack is enabled. Tier slot satisfies the one-tier-per-rule
  // invariant.
  'avoid_dio_error',
