...
/// Quick fix: Add mounted check before this
class AddMountedCheckFix extends SaropaFixProducer {
  AddMountedCheckFix({required super.context});

  static const _fixKind = FixKind(
    'saropa.fix.addMountedCheckFix',
    50,
    'Add mounted check before this',
  );
  ...
  Future<void> compute(ChangeBuilder builder) async {
    ...
    await builder.addDartFileEdit(file, (builder) {
      builder.addSimpleInsertion(target.offset, 'if (!mounted) return;\n    ');
    });
  }
}
