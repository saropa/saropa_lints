...
class PreferLazySingletonRegistrationFix extends SaropaFixProducer {
  PreferLazySingletonRegistrationFix({required super.context});

  static const _fixKind = FixKind(
    'saropa.fix.preferLazySingletonRegistrationFix',
    4000,
