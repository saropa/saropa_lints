...
/// Quick fix: Remove digit separators from integer literal.
///
/// Matches [AvoidDigitSeparatorsRule].
class RemoveDigitSeparatorsFix extends ReplaceNodeFix {
  RemoveDigitSeparatorsFix({required super.context});

  static const _fixKind = FixKind(
    'saropa.fix.removeDigitSeparators',
    50,
