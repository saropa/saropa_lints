...
/// Quick fix: Replace with Center
class PreferCenterOverAlignFix extends SaropaFixProducer {
  PreferCenterOverAlignFix({required super.context});

  static const _fixKind = FixKind(
    'saropa.fix.preferCenterOverAlignFix',
    50,
    'Replace with Center',
  );
  ...
  Future<void> compute(ChangeBuilder builder) async {
    ...
    final replacement = source.replaceFirst('Align(', 'Center(');
