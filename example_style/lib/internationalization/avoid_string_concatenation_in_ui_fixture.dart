...
// Test fixture for: avoid_string_concatenation_in_ui
...
// BAD: Should trigger avoid_string_concatenation_in_ui
// expect_lint: avoid_string_concatenation_in_ui
void _bad441() {
  Text('Hello ' + userName + '!');
  Text('You have $count new ' + (count == 1 ? 'message' : 'messages'));
}

// GOOD: Should NOT trigger avoid_string_concatenation_in_ui
void _good441() {
