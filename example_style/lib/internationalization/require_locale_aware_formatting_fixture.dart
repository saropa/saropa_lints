...
// Test fixture for: require_locale_aware_formatting
...
// BAD: Should trigger require_locale_aware_formatting
// expect_lint: require_locale_aware_formatting
void _bad437() {
  Text('\$${price.toStringAsFixed(2)}');
  Text('${date.day}/${date.month}/${date.year}');
}

// GOOD: Should NOT trigger require_locale_aware_formatting
void _good437() {
