...
// Test fixture for: avoid_hardcoded_strings_in_ui
...
// BAD: Should trigger avoid_hardcoded_strings_in_ui
// expect_lint: avoid_hardcoded_strings_in_ui
void _bad436() {
  Text('Welcome to the app');
  ElevatedButton(child: Text('Submit'));
}

// GOOD: Should NOT trigger avoid_hardcoded_strings_in_ui
void _good436() {
