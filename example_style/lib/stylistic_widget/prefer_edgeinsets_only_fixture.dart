...
// Test fixture for: prefer_edgeinsets_only
// Source: lib\src\rules\stylistic_widget_rules.dart

import 'package:saropa_lints_example/flutter_mocks.dart';

// BAD: Should trigger prefer_edgeinsets_only
// expect_lint: prefer_edgeinsets_only
class _Bad1157 extends StatelessWidget {
  const _Bad1157({super.key});
  @override
  Widget build(BuildContext context) {
    // TODO: Add widget creation that triggers prefer_edgeinsets_only
    return Container();
  }
}

// GOOD: Should NOT trigger prefer_edgeinsets_only
class _Good1157 extends StatelessWidget {
  const _Good1157({super.key});
  @override
  Widget build(BuildContext context) {
    // TODO: Add compliant widget pattern for prefer_edgeinsets_only
    return Container();
  }
}
