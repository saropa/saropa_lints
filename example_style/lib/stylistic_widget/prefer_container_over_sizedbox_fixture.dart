...
// Test fixture for: prefer_container_over_sizedbox
// Source: lib\src\rules\stylistic_widget_rules.dart

import '../flutter_mocks.dart';

// BAD: Should trigger prefer_container_over_sizedbox
// expect_lint: prefer_container_over_sizedbox
class _Bad1155 extends StatelessWidget {
  const _Bad1155({super.key});
  @override
  Widget build(BuildContext context) {
    // TODO: Add widget creation that triggers prefer_container_over_sizedbox
    return Container();
  }
}

// GOOD: Should NOT trigger prefer_container_over_sizedbox
class _Good1155 extends StatelessWidget {
  const _Good1155({super.key});
  @override
  Widget build(BuildContext context) {
    // TODO: Add compliant widget pattern for prefer_container_over_sizedbox
    return Container();
  }
}
