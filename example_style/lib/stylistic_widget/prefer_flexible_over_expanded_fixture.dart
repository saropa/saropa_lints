...
// Test fixture for: prefer_flexible_over_expanded
// Source: lib\src\rules\stylistic_widget_rules.dart

import 'package:saropa_lints_example/flutter_mocks.dart';

// BAD: Should trigger prefer_flexible_over_expanded
// expect_lint: prefer_flexible_over_expanded
class _Bad1158 extends StatelessWidget {
  const _Bad1158({super.key});
  @override
  Widget build(BuildContext context) {
    // TODO: Add widget creation that triggers prefer_flexible_over_expanded
    return Container();
  }
}

// GOOD: Should NOT trigger prefer_flexible_over_expanded
class _Good1158 extends StatelessWidget {
  const _Good1158({super.key});
  @override
  Widget build(BuildContext context) {
    // TODO: Add compliant widget pattern for prefer_flexible_over_expanded
    return Container();
  }
}
