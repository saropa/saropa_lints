...
// Test fixture for: prefer_mutable_collections
// Source: lib\src\rules\stylistic_null_collection_rules.dart

import 'package:saropa_lints_example/flutter_mocks.dart';

// BAD: Should trigger prefer_mutable_collections
// expect_lint: prefer_mutable_collections
class _Bad1120 extends StatelessWidget {
  const _Bad1120({super.key});
  @override
  Widget build(BuildContext context) {
    // TODO: Add widget creation that triggers prefer_mutable_collections
    return Container();
  }
}

// GOOD: Should NOT trigger prefer_mutable_collections
class _Good1120 extends StatelessWidget {
  const _Good1120({super.key});
  @override
  Widget build(BuildContext context) {
    // TODO: Add compliant widget pattern for prefer_mutable_collections
    return Container();
  }
}
