...
// Test fixture for: require_parameter_documentation
...
// BAD: Should trigger require_parameter_documentation
// expect_lint: require_parameter_documentation
void _bad341() {
  /// Creates a new user.
  Future<User> createUser(String name, String email, int age) {}
}

// GOOD: Should NOT trigger require_parameter_documentation
void _good341() {
  /// Creates a new user.
  ///
