...
// Test fixture for: avoid_misleading_documentation
...
// BAD: Should trigger avoid_misleading_documentation
// expect_lint: avoid_misleading_documentation
void _bad338() {
  /// Returns the user's name.
  String getUserEmail() => user.email; // Doc says name but returns email
}

// GOOD: Should NOT trigger avoid_misleading_documentation
void _good338() {
