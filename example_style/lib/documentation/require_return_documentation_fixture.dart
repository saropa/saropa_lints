...
// Test fixture for: require_return_documentation
...
// BAD: Should trigger require_return_documentation
// expect_lint: require_return_documentation
void _bad342() {
  /// Processes the order.
  OrderResult processOrder(Order order) {}
}

// GOOD: Should NOT trigger require_return_documentation
void _good342() {
  /// Processes the order.
  ///
