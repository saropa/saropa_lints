...
// Test fixture for: prefer_await_over_then
// Source: lib\src\rules\stylistic_control_flow_rules.dart

import '../flutter_mocks.dart';

// BAD: Should trigger prefer_await_over_then
// expect_lint: prefer_await_over_then
void _bad1092() {
  // TODO: Add method call that triggers prefer_await_over_then
}

// GOOD: Should NOT trigger prefer_await_over_then
void _good1092() {
  // TODO: Add compliant method call for prefer_await_over_then
}
