# Implemented: Migration candidate #022 (ButtonBar deprecation)

**Source plan:** `plan/implementable_only_in_plugin_extension/migration-candidate-022-deprecate_buttonbar_buttonbarthemedata_and_themedata_buttonb.md` (moved here when complete).
