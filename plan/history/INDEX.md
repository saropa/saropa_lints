...
Searchable index of all files in `plan/history/`. Search this file instead of scanning 1,000+ history files.

## Maintenance

- When moving a file into `plan/history/YYYY.MM/YYYYMMDD/`, add a one-line entry to the appropriate month section below.
