# Migration Candidate #036

**Source:** Flutter SDK 3.22.0
**Category:** Deprecation
**Relevance Score:** 5
**Detected APIs:** CupertinoContextMenu.previewBuilder, Remove, LongCatIsLooong
...
>
> Context: * Clean up lint ignores by @eliasyishak in [144229](https://github.com/flutter/flutter/pull/144229)

**PR:** https://github.com/flutter/flutter/pull/143990

## PR Details

**Title:** Remove deprecated `CupertinoContextMenu.previewBuilder`
**Author:** @LongCatIsLooong
**Status:** merged
**Labels:** a: text input, framework, f: cupertino, autosubmit
