...
> **========================================================**
>
> Already implemented as `AvoidUncontrolledTextFieldRule` in
> `lib/src/rules/widget_patterns_rules.dart` (line 730).
> Detects TextField/TextFormField without controller argument.
>
> **========================================================**
