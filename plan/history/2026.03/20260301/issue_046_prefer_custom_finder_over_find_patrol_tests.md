# Prefer Custom Finder Over Find (Patrol Tests)

**GitHub:** [https://github.com/saropa/saropa_lints/issues/46](https://github.com/saropa/saropa_lints/issues/46)

**Resolved in:** N/A — Deferred (Patrol finder pattern). Issue closed.
...
### Problem  
Using Patrol's custom finders for integration tests provides clearer and more robust test code than generic find calls.

### Why This Is Complex  
- **Pattern detection:** Requires analyzing Patrol test code for finder usage.
- **Test diversity:** Different patterns for custom and generic finders.
- **False positives:** Some tests may intentionally use generic finders.

### Desired Outcome  
- Detect Patrol tests using generic find instead of custom finders.
- Warn about potential maintainability issues.
- Suggest using Patrol's custom finders for clarity.

### References  
- See ROADMAP.md section: "prefer_custom_finder_over_find"

---

## Roadmap task spec (merged from bugs/roadmap/task_prefer_custom_finder_over_find.md)

# Task: `prefer_custom_finder_over_find`

## Summary
- **Rule Name**: `prefer_custom_finder_over_find`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use Patrol's custom finders for clearer integration tests.
...
// TODO: Replace with concrete example for `prefer_custom_finder_over_find`.
```
...
- Add package/docs links relevant to `prefer_custom_finder_over_find` (e.g. bloc, riverpod, hive).
