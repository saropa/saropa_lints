# Task: `prefer_connectivity_debounce`

## Summary
- **Rule Name**: `prefer_connectivity_debounce`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Debounce rapid connectivity changes. Detect status handler without debounce.
...
// TODO: Replace with concrete example for `prefer_connectivity_debounce`.
```
...
- Add package/docs links relevant to `prefer_connectivity_debounce` (e.g. bloc, riverpod, hive).
