# Task: `prefer_i_prefix_interfaces`

## Summary
- **Rule Name**: `prefer_i_prefix_interfaces`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
Interface classes use `I` prefix (`IRepository`)
...
// TODO: Replace with concrete example for `prefer_i_prefix_interfaces`.
```
...
- Add package/docs links relevant to `prefer_i_prefix_interfaces` (e.g. bloc, riverpod, hive).
