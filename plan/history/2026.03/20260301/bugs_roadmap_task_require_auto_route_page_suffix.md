# Task: `require_auto_route_page_suffix`

## Summary
- **Rule Name**: `require_auto_route_page_suffix`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
...
Page classes should have Page suffix. Detect @RoutePage without suffix.
...
// TODO: Replace with concrete example for `require_auto_route_page_suffix`.
```
...
- Add package/docs links relevant to `require_auto_route_page_suffix` (e.g. bloc, riverpod, hive).
