# Task: `prefer_then_catcherror`

## Summary
- **Rule Name**: `prefer_then_catcherror`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
...
Prefer then().catchError() over try/catch for async error handling.
...
// TODO: Replace with concrete example for `prefer_then_catcherror`.
```
...
- Add package/docs links relevant to `prefer_then_catcherror` (e.g. bloc, riverpod, hive).
