# Task: `prefer_publish_to_none`

## Summary
- **Rule Name**: `prefer_publish_to_none`
- **Tier**: Recommended
- **Severity**: INFO
- **Status**: Planned
...
Private packages should have `publish_to: none`.
...
// TODO: Replace with concrete example for `prefer_publish_to_none`.
```
...
- Add package/docs links relevant to `prefer_publish_to_none` (e.g. bloc, riverpod, hive).
