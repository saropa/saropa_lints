# Task: `prefer_constructors_over_static_methods`

## Summary
- **Rule Name**: `prefer_constructors_over_static_methods`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
...
Prefer constructors over static factory methods.
...
// TODO: Replace with concrete example for `prefer_constructors_over_static_methods`.
```
...
- Add package/docs links relevant to `prefer_constructors_over_static_methods` (e.g. bloc, riverpod, hive).
