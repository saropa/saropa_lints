# Task: `prefer_caret_version_syntax`

## Summary
- **Rule Name**: `prefer_caret_version_syntax`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
...
Use `^1.0.0` caret syntax for version constraints.
...
// TODO: Replace with concrete example for `prefer_caret_version_syntax`.
```
...
- Add package/docs links relevant to `prefer_caret_version_syntax` (e.g. bloc, riverpod, hive).
