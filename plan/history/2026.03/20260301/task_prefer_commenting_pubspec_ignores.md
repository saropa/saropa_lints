# Task: `prefer_commenting_pubspec_ignores`

## Summary
- **Rule Name**: `prefer_commenting_pubspec_ignores`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Document why pubspec rules are ignored.
...
// TODO: Replace with concrete example for `prefer_commenting_pubspec_ignores`.
```
...
- Add package/docs links relevant to `prefer_commenting_pubspec_ignores` (e.g. bloc, riverpod, hive).
