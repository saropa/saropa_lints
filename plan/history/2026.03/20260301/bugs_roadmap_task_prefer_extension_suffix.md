# Task: `prefer_extension_suffix`

## Summary
- **Rule Name**: `prefer_extension_suffix`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
Extensions use `Extension` or `X` suffix
...
// TODO: Replace with concrete example for `prefer_extension_suffix`.
```
...
- Add package/docs links relevant to `prefer_extension_suffix` (e.g. bloc, riverpod, hive).
