# Task: `prefer_positional_bool_params`

## Summary
- **Rule Name**: `prefer_positional_bool_params`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
Boolean parameters as positional
...
// TODO: Replace with concrete example for `prefer_positional_bool_params`.
```
...
- Add package/docs links relevant to `prefer_positional_bool_params` (e.g. bloc, riverpod, hive).
