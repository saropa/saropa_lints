# Task: `prefer_auto_route_typed_args`

## Summary
- **Rule Name**: `prefer_auto_route_typed_args`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use strongly typed route arguments. Detect dynamic args passing.
...
// TODO: Replace with concrete example for `prefer_auto_route_typed_args`.
```
...
- Add package/docs links relevant to `prefer_auto_route_typed_args` (e.g. bloc, riverpod, hive).
