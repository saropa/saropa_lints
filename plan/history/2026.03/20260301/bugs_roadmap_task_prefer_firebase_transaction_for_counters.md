# Task: `prefer_firebase_transaction_for_counters`

## Summary
- **Rule Name**: `prefer_firebase_transaction_for_counters`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use transactions for counters. Detect read-then-write pattern.
...
// TODO: Replace with concrete example for `prefer_firebase_transaction_for_counters`.
```
...
- Add package/docs links relevant to `prefer_firebase_transaction_for_counters` (e.g. bloc, riverpod, hive).
