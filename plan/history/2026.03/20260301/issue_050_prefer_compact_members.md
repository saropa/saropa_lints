# Prefer Compact Members

**GitHub:** [https://github.com/saropa/saropa_lints/issues/50](https://github.com/saropa/saropa_lints/issues/50)

**Resolved in:** N/A — Deferred (stylistic). Issue closed.
...
### Problem  
Compact class member declarations can improve code density and reduce vertical space, especially in small classes.

### Why This Is Complex  
- **Pattern detection:** Requires analyzing class structure and member formatting.
- **Code diversity:** Different formatting styles and preferences.
- **False positives:** Some codebases may intentionally use expanded members.

### Desired Outcome  
- Detect unnecessarily expanded class members.
- Warn about potential wasted space.
- Suggest compacting members where appropriate.

### References  
- See ROADMAP.md section: "prefer_compact_members"

---

## Roadmap task spec (merged from bugs/roadmap/task_prefer_compact_members.md)

# Task: `prefer_compact_members`

## Summary
- **Rule Name**: `prefer_compact_members`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
...
Compact class member declarations.
...
// TODO: Replace with concrete example for `prefer_compact_members`.
```
...
- Add package/docs links relevant to `prefer_compact_members` (e.g. bloc, riverpod, hive).
