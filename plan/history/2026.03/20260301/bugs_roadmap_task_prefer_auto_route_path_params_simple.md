# Task: `prefer_auto_route_path_params_simple`

## Summary
- **Rule Name**: `prefer_auto_route_path_params_simple`
- **Tier**: Recommended
- **Severity**: INFO
- **Status**: Planned
...
Path params should be simple types. Detect complex objects in path.
...
// TODO: Replace with concrete example for `prefer_auto_route_path_params_simple`.
```
...
- Add package/docs links relevant to `prefer_auto_route_path_params_simple` (e.g. bloc, riverpod, hive).
