...
Prefer forEach over for-in for readability.
...
// TODO: Replace with concrete example for `prefer_foreach`.
```
...
- Add package/docs links relevant to `prefer_foreach` (e.g. bloc, riverpod, hive).
