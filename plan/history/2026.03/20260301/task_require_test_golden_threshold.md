# Task: `require_test_golden_threshold`

## Summary
- **Rule Name**: `require_test_golden_threshold`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Set golden test threshold for CI differences. Detect default threshold.
...
// TODO: Replace with concrete example for `require_test_golden_threshold`.
```
...
- Add package/docs links relevant to `require_test_golden_threshold` (e.g. bloc, riverpod, hive).
