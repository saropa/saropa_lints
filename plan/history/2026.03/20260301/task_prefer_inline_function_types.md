# Task: `prefer_inline_function_types`

## Summary
- **Rule Name**: `prefer_inline_function_types`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
Inline function types over `typedef`
...
// TODO: Replace with concrete example for `prefer_inline_function_types`.
```
...
- Add package/docs links relevant to `prefer_inline_function_types` (e.g. bloc, riverpod, hive).
