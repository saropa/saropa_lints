# Task: `require_test_coverage_threshold`

## Summary
- **Rule Name**: `require_test_coverage_threshold`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
- **Source**: ROADMAP.md — 5.31 Testing Best Practices Rules

## Problem Statement

Set minimum coverage threshold. Detect coverage below threshold.
...
// TODO: Replace with concrete example for `require_test_coverage_threshold`.
```
...
- Add package/docs links relevant to `require_test_coverage_threshold` (e.g. bloc, riverpod, hive).
