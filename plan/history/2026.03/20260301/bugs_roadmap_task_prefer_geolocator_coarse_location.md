# Task: `prefer_geolocator_coarse_location`

## Summary
- **Rule Name**: `prefer_geolocator_coarse_location`
- **Tier**: Recommended
- **Severity**: INFO
- **Status**: Planned
...
ACCESS_COARSE_LOCATION for city-level. Detect fine permission for coarse needs.
...
// TODO: Replace with concrete example for `prefer_geolocator_coarse_location`.
```
...
- Add package/docs links relevant to `prefer_geolocator_coarse_location` (e.g. bloc, riverpod, hive).
