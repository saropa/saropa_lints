# Task: `prefer_static_method_over_function`

## Summary
- **Rule Name**: `prefer_static_method_over_function`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
Static methods over top-level functions
...
// TODO: Replace with concrete example for `prefer_static_method_over_function`.
```
...
- Add package/docs links relevant to `prefer_static_method_over_function` (e.g. bloc, riverpod, hive).
