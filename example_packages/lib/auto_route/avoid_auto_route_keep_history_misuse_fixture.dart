...
// Test fixture for: avoid_auto_route_keep_history_misuse
...
// BAD: replaceAll outside auth flow
// expect_lint: avoid_auto_route_keep_history_misuse
void _badReplaceAll() {
  context.router.replaceAll([const HomeRoute(), const ProductsRoute()]);
}

// BAD: popUntilRoot outside auth flow
// expect_lint: avoid_auto_route_keep_history_misuse
void _badPopUntilRoot() {
  context.router.popUntilRoot();
}

// GOOD: replaceAll in auth-related function (login)
void _onLogin() {
  context.router.replaceAll([const HomeRoute()]);
}

// GOOD: replaceAll in logout function
void _onLogout() {
  context.router.replaceAll([const LoginRoute()]);
}

// GOOD: replaceAll in onboarding flow
void _completeOnboarding() {
  context.router.replaceAll([const HomeRoute()]);
}

// GOOD: Normal push navigation
void _goodNavigation() {
