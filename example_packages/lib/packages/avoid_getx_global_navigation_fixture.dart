...
// Test fixture for: avoid_getx_global_navigation
...
// BAD: Should trigger avoid_getx_global_navigation
// expect_lint: avoid_getx_global_navigation
void _bad641() {
  Get.to(NextPage());
  Get.off(HomePage());
  Get.toNamed('/details');
...
// GOOD: Should NOT trigger avoid_getx_global_navigation
void _good641() {
