...
// Test fixture for: prefer_hive_encryption
...
// BAD: Should trigger prefer_hive_encryption
// expect_lint: prefer_hive_encryption
void _bad658() async {
  final box = await Hive.openBox('secrets');
  box.put('password', password);
}

// GOOD: Should NOT trigger prefer_hive_encryption
void _good658() async {
