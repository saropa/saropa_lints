...
// Test fixture for: avoid_cached_isar_stream
// Source: lib\src\rules\packages\isar_rules.dart
...
// BAD: Should trigger avoid_cached_isar_stream
// expect_lint: avoid_cached_isar_stream
void _bad691() {
  final usersStream = isar.users.where().watch(); // BAD: cached
  StreamBuilder(stream: usersStream);
}

// GOOD: Should NOT trigger avoid_cached_isar_stream
void _good691() {
