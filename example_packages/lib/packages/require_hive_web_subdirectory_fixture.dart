...
// Test fixture for: require_hive_web_subdirectory
// Source: lib\src\rules\packages\hive_rules.dart

import 'package:saropa_lints_example/flutter_mocks.dart';

// BAD: Should trigger require_hive_web_subdirectory
// expect_lint: require_hive_web_subdirectory
void _bad671() async {
  await Hive.initFlutter(); // No subDir - shared storage on web!
}

// GOOD: Should NOT trigger require_hive_web_subdirectory
void _good671() async {
