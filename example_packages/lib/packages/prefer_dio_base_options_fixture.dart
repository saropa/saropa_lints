...
// Test fixture for: prefer_dio_base_options
...
// BAD: Should trigger prefer_dio_base_options
// expect_lint: prefer_dio_base_options
void _bad597() {
  dio.get('/a', options: Options(headers: {'Auth': token}));
  dio.get('/b', options: Options(headers: {'Auth': token}));
}

// GOOD: Should NOT trigger prefer_dio_base_options
void _good597() {
