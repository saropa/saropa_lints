...
// Test fixture for: avoid_app_links_sensitive_params
...
// BAD: Should trigger avoid_app_links_sensitive_params
// expect_lint: avoid_app_links_sensitive_params
void _bad696() {
  final link = 'myapp://auth?token=$accessToken';
  final link = 'myapp://reset?password=$newPassword';
}

// GOOD: Should NOT trigger avoid_app_links_sensitive_params
void _good696() {
