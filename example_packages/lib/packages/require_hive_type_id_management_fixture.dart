...
class _bad663_Settings extends HiveObject {}

@HiveType(typeId: 0)
class _bad663_User extends HiveObject {}

// GOOD: Should NOT trigger require_hive_type_id_management
...
@HiveType(typeId: 0)
class _good663_User extends HiveObject {}

@HiveType(typeId: 1)
class _good663_Settings extends HiveObject {}
