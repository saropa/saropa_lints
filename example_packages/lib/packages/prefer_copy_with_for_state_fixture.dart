...
// Test fixture for: prefer_copy_with_for_state
...
// BAD: Should trigger prefer_copy_with_for_state
// expect_lint: prefer_copy_with_for_state
void _bad555() {
  emit(state..count = 5); // Mutating existing state!
}

// GOOD: Should NOT trigger prefer_copy_with_for_state
void _good555() {
