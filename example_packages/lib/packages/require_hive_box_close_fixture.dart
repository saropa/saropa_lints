...
// Test fixture for: require_hive_box_close
...
// BAD: Should trigger require_hive_box_close
// expect_lint: require_hive_box_close
void _bad657() async {
  late Box box;
  void initState() {
...
// GOOD: Should NOT trigger require_hive_box_close
void _good657() {
  late Box box;
  void dispose() {
    box.close();
