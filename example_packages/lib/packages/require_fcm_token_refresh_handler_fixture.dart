...
// Test fixture for: require_fcm_token_refresh_handler
...
// BAD: Should trigger require_fcm_token_refresh_handler
// expect_lint: require_fcm_token_refresh_handler
void _bad619() async {
  final token = await messaging.getToken();
  // Send to server - but no refresh handling!
}

// GOOD: Should NOT trigger require_fcm_token_refresh_handler
void _good619() async {
  final token = await messaging.getToken();
  sendToServer(token);
