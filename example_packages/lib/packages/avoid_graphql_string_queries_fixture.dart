...
// Test fixture for: avoid_graphql_string_queries
// Source: lib\src\rules\packages\graphql_rules.dart
...
// BAD: Should trigger avoid_graphql_string_queries
// expect_lint: avoid_graphql_string_queries
void _bad654() async {
  final query = gql('''
  query GetUsers {
  users {
...
// GOOD: Should NOT trigger avoid_graphql_string_queries
void _good654() async {
