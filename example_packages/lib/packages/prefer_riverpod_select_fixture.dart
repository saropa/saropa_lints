...
// Test fixture for: prefer_riverpod_select
...
// BAD: Should trigger prefer_riverpod_select
// expect_lint: prefer_riverpod_select
void _bad739() {
  final name = ref.watch(userProvider).name;
  // Rebuilds on ANY user change
}

// GOOD: Should NOT trigger prefer_riverpod_select
void _good739() {
