...
// Test fixture for: prefer_riverpod_auto_dispose
...
// BAD: Should trigger prefer_riverpod_auto_dispose
// expect_lint: prefer_riverpod_auto_dispose
void _bad741() {
  final myProvider = StateProvider<int>((ref) => 0);
}

// GOOD: Should NOT trigger prefer_riverpod_auto_dispose
void _good741() {
