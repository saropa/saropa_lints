...
// Test fixture for: prefer_encrypted_prefs
...
// BAD: Should trigger prefer_encrypted_prefs
// expect_lint: prefer_encrypted_prefs
void _bad766() async {
...
// GOOD: Should NOT trigger prefer_encrypted_prefs
void _good766() async {
  final secureStorage = FlutterSecureStorage();
