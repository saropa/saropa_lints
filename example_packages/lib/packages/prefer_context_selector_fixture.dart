...
// Test fixture for: prefer_context_selector
...
// BAD: Should trigger prefer_context_selector
// expect_lint: prefer_context_selector
void _bad758() {
  final user = context.watch<UserNotifier>().user;
  // Rebuilds on ANY UserNotifier change
}

// GOOD: Should NOT trigger prefer_context_selector
void _good758() {
