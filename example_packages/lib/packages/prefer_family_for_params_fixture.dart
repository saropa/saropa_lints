...
// Test fixture for: prefer_family_for_params
...
// BAD: Should trigger prefer_family_for_params
// expect_lint: prefer_family_for_params
void _bad750() {
  // Missing family parameter
  final user = ref.watch(userProvider); // Error or wrong instance!
}

// GOOD: Should NOT trigger prefer_family_for_params
void _good750() {
