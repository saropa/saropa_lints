# Require Foldable Awareness

**GitHub:** [https://github.com/saropa/saropa_lints/issues/40](https://github.com/saropa/saropa_lints/issues/40)

**Opened:** 2026-01-23T14:01:48Z

**Resolved in:** N/A — Deferred (platform/API diversity; DisplayFeature detection). Issue closed.
...
### Problem  
Foldable devices have hinges and multiple displays. Content should not be placed on the fold, and the DisplayFeature API should be used to adapt layouts.

### Why This Is Complex  
- **Pattern detection:** Requires analyzing layout code for foldable device support.
- **API diversity:** Different devices and APIs for foldable support.
- **False positives:** Some apps may not target foldable devices.

### Desired Outcome  
- Detect layouts that do not account for foldable device features.
- Warn about potential content placement issues.
- Suggest using DisplayFeature API for foldable awareness.

### References  
- See ROADMAP.md section: "require_foldable_awareness"

---

## Roadmap task spec (merged from bugs/roadmap/task_require_foldable_awareness.md)

# Task: `require_foldable_awareness`

## Summary
- **Rule Name**: `require_foldable_awareness`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
- **Source**: ROADMAP.md — 1.8 Navigation, Deep Linking & Responsive Design

## Problem Statement

Foldable devices have hinges and multiple displays. Use DisplayFeature API to avoid placing content on fold.
...
// TODO: Replace with concrete example for `require_foldable_awareness`.
```
...
- Add package/docs links relevant to `require_foldable_awareness` (e.g. bloc, riverpod, hive).
