# Prefer Test Data Reset

**GitHub:** [https://github.com/saropa/saropa_lints/issues/43](https://github.com/saropa/saropa_lints/issues/43)

**Resolved in:** N/A — Deferred (setUp/reset pattern detection). Issue closed.
...
### Problem  
Each test should start with known state. Resetting database, clearing shared preferences, and logging out users in setUp prevents test pollution.

### Why This Is Complex  
- **Pattern detection:** Requires analyzing test setup and teardown logic.
- **Test diversity:** Different frameworks and patterns for state reset.
- **False positives:** Some tests may not require full reset.

### Desired Outcome  
- Detect tests without proper data reset in setUp.
- Warn about potential test pollution.
- Suggest best practices for resetting test data.

### References  
- See ROADMAP.md section: "prefer_test_data_reset"

---

## Roadmap task spec (merged from bugs/roadmap/task_prefer_test_data_reset.md)

# Task: `prefer_test_data_reset`

## Summary
- **Rule Name**: `prefer_test_data_reset`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Each test should start with known state. Reset database, clear shared preferences, and log out users in setUp to prevent test pollution.
...
// TODO: Replace with concrete example for `prefer_test_data_reset`.
```
...
- Add package/docs links relevant to `prefer_test_data_reset` (e.g. bloc, riverpod, hive).
