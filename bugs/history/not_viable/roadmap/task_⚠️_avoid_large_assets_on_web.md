> **========================================================**
> **NOT VIABLE -- LINT RULES CANNOT READ FILE SIZES**
> **========================================================**
>
> Phase 1 requires reading image file sizes from disk (>500KB).
> custom_lint rules run in the Dart analyzer isolate and only
> receive AST nodes -- no filesystem API for measuring assets.
>
> Problems:
> - Asset paths in code are strings; analyzer doesn't resolve
>   them to filesystem paths
> - Assets may be generated at build time (flutter_gen)
> - Asset resolution depends on device pixel ratio (2.0x/, 3.0x/)
>
> This is a build-time concern, not a lint concern.
> A CI script (`find assets/ -size +500k`) would be more reliable.
>
> **========================================================**
