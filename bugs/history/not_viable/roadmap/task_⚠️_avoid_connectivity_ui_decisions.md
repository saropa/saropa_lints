...
> **========================================================**
>
> Wants to flag "full-screen UI blocks based on connectivity"
> but allow "small offline indicators." Both patterns have
> identical AST structure: StreamBuilder -> if on
> ConnectivityResult -> return widget. The linter cannot
> distinguish a full-screen Scaffold from a small Banner --
> that's a layout concept, not an AST concept.
>
> **========================================================**
