> **========================================================**
> **NOT VIABLE -- DETECTION SURFACE TOO NARROW**
> **========================================================**
>
> The spec targets for-loops re-fetching all pages on refresh.
> But real pagination implementations don't use this pattern:
>
> - BLoC: `add(RefreshEvent())` -- logic inside BLoC, invisible
> - Riverpod: `ref.invalidate(provider)` -- internal to notifier
> - PagingController: `.refresh()` -- single call, nothing to flag
> - Custom ScrollController: state management callbacks
>
> The for-loop-over-pages pattern is a textbook example, not
> how real apps work. The rule would have near-zero real-world
> detections while requiring significant implementation effort.
>
> **========================================================**
