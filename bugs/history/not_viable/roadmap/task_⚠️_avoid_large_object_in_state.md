> **========================================================**
> **NOT VIABLE -- STATIC ANALYSIS CANNOT MEASURE RUNTIME SIZE**
> **========================================================**
>
> The type `Uint8List` tells you nothing about size at rest.
> A 16-byte UUID and a 5MB photo are both `Uint8List`.
>
> Problems:
> - Phase 1 (flag Uint8List fields) catches small buffers
>   while missing the actual memory hogs (decoded images,
>   parsed JSON models, cached API responses stored as Map
>   or custom types)
> - Static analysis fundamentally cannot measure runtime
>   memory consumption
> - False positive rate would be very high
>
> DevTools memory profiler is the right tool for this problem.
>
> **========================================================**
