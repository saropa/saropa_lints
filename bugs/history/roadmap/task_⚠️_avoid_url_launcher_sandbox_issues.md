> **========================================================**
> **DUPLICATE -- COVERED BY 3 EXISTING RULES**
> **========================================================**
>
> 1. `RequireUrlLauncherCanLaunchCheckRule` — detects
>    launchUrl() without canLaunchUrl() check
> 2. `PreferUrlLauncherFallbackRule` — detects launchUrl()
>    without fallback handling
> 3. `AvoidIgnoringReturnValuesRule` — flags discarded
>    Future<bool> return value from launchUrl()
>
> The spec's Phase 1 trigger ("launchUrl result discarded")
> is exactly what these three rules already cover.
>
> **========================================================**
