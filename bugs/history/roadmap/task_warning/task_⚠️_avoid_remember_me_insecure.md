...
> **========================================================**
>
> Fully covered by four existing security rules:
> - `RequireSecureStorageRule` (security_rules.dart:206)
> - `AvoidStoringPasswordsRule` (security_rules.dart:1353)
> - `AvoidAuthStateInPrefsRule` (shared_preferences_rules.dart:457)
> - `RequireSecureStorageForAuthRule` (security_rules.dart:3382)
>
> Together they catch all password/credential/token keys in
> SharedPreferences. No detection gap remains.
>
> **========================================================**
