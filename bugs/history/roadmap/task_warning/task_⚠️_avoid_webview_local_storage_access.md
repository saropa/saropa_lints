...
> **========================================================**
>
> `AvoidWebViewJavaScriptEnabledRule` already flags
> `JavaScriptMode.unrestricted` and `javaScriptEnabled: true`.
> `PreferWebViewJavaScriptDisabledRule` provides the flip-side.
> The "local storage access" concern is just a consequence of
> unrestricted JS — not a distinct detection pattern.
>
> **========================================================**
