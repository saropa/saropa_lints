# Task: `prefer_final_fields_always`

## Summary
- **Rule Name**: `prefer_final_fields_always`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
// TODO: Replace with concrete example for `prefer_final_fields_always`.
```
...
- Add package/docs links relevant to `prefer_final_fields_always` (e.g. bloc, riverpod, hive).
