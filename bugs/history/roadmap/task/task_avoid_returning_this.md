# Task: `avoid_returning_this`

## Summary
- **Rule Name**: `avoid_returning_this`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
...
Avoid returning this from methods; prefer fluent interfaces.
...
// TODO: Replace with concrete example for `avoid_returning_this`.
```
...
- Add package/docs links relevant to `avoid_returning_this` (e.g. bloc, riverpod, hive).
