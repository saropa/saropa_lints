# Task: `prefer_fold_over_reduce`

## Summary
- **Rule Name**: `prefer_fold_over_reduce`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
...
Prefer fold over reduce for collections when initial value is needed.
...
// TODO: Replace with concrete example for `prefer_fold_over_reduce`.
```
...
- Add package/docs links relevant to `prefer_fold_over_reduce` (e.g. bloc, riverpod, hive).
