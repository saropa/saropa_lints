# Task: `prefer_cancellation_token_pattern`

## Summary
- **Rule Name**: `prefer_cancellation_token_pattern`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
- **Source**: ROADMAP.md — 5.44 Auto-Dispose Pattern Rules

## Problem Statement

Use CancelToken pattern for cancelable operations. Detect manual cancellation.
...
// TODO: Replace with concrete example for `prefer_cancellation_token_pattern`.
```
...
- Add package/docs links relevant to `prefer_cancellation_token_pattern` (e.g. bloc, riverpod, hive).
