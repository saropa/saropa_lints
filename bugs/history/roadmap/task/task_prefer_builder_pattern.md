# Task: `prefer_builder_pattern`

## Summary
- **Rule Name**: `prefer_builder_pattern`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use Builder for context-dependent children. Detect context issues.
...
// TODO: Replace with concrete example for `prefer_builder_pattern`.
```
...
- Add package/docs links relevant to `prefer_builder_pattern` (e.g. bloc, riverpod, hive).
