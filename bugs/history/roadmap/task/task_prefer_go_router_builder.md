# Task: `prefer_go_router_builder`

## Summary
- **Rule Name**: `prefer_go_router_builder`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use go_router_builder for compile-time route safety. Detect hand-written route paths.
...
// TODO: Replace with concrete example for `prefer_go_router_builder`.
```
...
- Add package/docs links relevant to `prefer_go_router_builder` (e.g. bloc, riverpod, hive).
