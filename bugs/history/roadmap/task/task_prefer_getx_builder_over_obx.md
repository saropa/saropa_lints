# Task: `prefer_getx_builder_over_obx`

## Summary
- **Rule Name**: `prefer_getx_builder_over_obx`
- **Tier**: Recommended
- **Severity**: INFO
- **Status**: Planned
...
GetBuilder is more explicit than Obx for state. Detect mixed patterns.
...
// TODO: Replace with concrete example for `prefer_getx_builder_over_obx`.
```
...
- Add package/docs links relevant to `prefer_getx_builder_over_obx` (e.g. bloc, riverpod, hive).
