# Task: `prefer_class_destructuring`
...
Use record destructuring for class field access when beneficial.
...
// TODO: Replace with concrete example for `prefer_class_destructuring`.
```
...
- Add package/docs links relevant to `prefer_class_destructuring` (e.g. bloc, riverpod, hive).
