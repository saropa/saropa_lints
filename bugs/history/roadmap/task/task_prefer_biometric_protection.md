**IMPLEMENTED:** Rule added in `security_rules.dart` (v4.13.0). Flags FlutterSecureStorage without authenticationRequired in aOptions/iOptions; tier Professional.

---

# Task: `prefer_biometric_protection`

## Summary
- **Rule Name**: `prefer_biometric_protection`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Implemented
- **Source**: ROADMAP.md — 5.49 Secure Storage, Late Init & Hive Advanced

## Problem Statement

Use biometric protection for sensitive data. Detect authenticationRequired option.
...
- Add package/docs links relevant to `prefer_biometric_protection` (e.g. bloc, riverpod, hive).
