# Task: `prefer_freezed_union_types`

## Summary
- **Rule Name**: `prefer_freezed_union_types`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use Freezed unions for sealed state. Detect manual sealed class hierarchies.
...
// TODO: Replace with concrete example for `prefer_freezed_union_types`.
```
...
- Add package/docs links relevant to `prefer_freezed_union_types` (e.g. bloc, riverpod, hive).
