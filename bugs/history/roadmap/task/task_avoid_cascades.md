...
Discourage use of cascade (..) for clarity and maintainability.
...
// TODO: Replace with concrete example for `avoid_cascades`.
```
...
- Add package/docs links relevant to `avoid_cascades` (e.g. bloc, riverpod, hive).
