# Task: `prefer_compile_time_config`

## Summary
- **Rule Name**: `prefer_compile_time_config`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use const for compile-time config. Detect runtime config lookup for static values.
...
// TODO: Replace with concrete example for `prefer_compile_time_config`.
```
...
- Add package/docs links relevant to `prefer_compile_time_config` (e.g. bloc, riverpod, hive).
