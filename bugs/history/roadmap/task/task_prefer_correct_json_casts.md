# Task: `prefer_correct_json_casts`

## Summary
- **Rule Name**: `prefer_correct_json_casts`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use proper type casts when working with JSON data.
...
// TODO: Replace with concrete example for `prefer_correct_json_casts`.
```
...
- Add package/docs links relevant to `prefer_correct_json_casts` (e.g. bloc, riverpod, hive).
