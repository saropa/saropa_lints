# Task: `prefer_expression_body_getters`

## Summary
- **Rule Name**: `prefer_expression_body_getters`
- **Tier**: Recommended
- **Severity**: INFO
- **Status**: Planned
...
// TODO: Replace with concrete example for `prefer_expression_body_getters`.
```
...
- Add package/docs links relevant to `prefer_expression_body_getters` (e.g. bloc, riverpod, hive).
