# Task: `prefer_flavor_configuration`

## Summary
- **Rule Name**: `prefer_flavor_configuration`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use Flutter flavors for environments. Detect manual environment switching.
...
// TODO: Replace with concrete example for `prefer_flavor_configuration`.
```
...
- Add package/docs links relevant to `prefer_flavor_configuration` (e.g. bloc, riverpod, hive).
