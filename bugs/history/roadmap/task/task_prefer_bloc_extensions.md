...
Use Bloc extension methods for cleaner code.
...
// TODO: Replace with concrete example for `prefer_bloc_extensions`.
```
...
- Add package/docs links relevant to `prefer_bloc_extensions` (e.g. bloc, riverpod, hive).
