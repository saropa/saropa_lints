# Task: `prefer_conditional_logging`

## Summary
- **Rule Name**: `prefer_conditional_logging`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Expensive log message construction should be conditional. Detect expensive string in log.
...
// TODO: Replace with concrete example for `prefer_conditional_logging`.
```
...
- Add package/docs links relevant to `prefer_conditional_logging` (e.g. bloc, riverpod, hive).
