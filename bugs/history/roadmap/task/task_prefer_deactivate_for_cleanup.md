# Task: `prefer_deactivate_for_cleanup`

## Summary
- **Rule Name**: `prefer_deactivate_for_cleanup`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
- **Source**: ROADMAP.md — 5.21 Stream, Future, Lifecycle & Form Rules

## Problem Statement

Use deactivate for removable cleanup. Detect dispose-only cleanup that could be in deactivate.
...
// TODO: Replace with concrete example for `prefer_deactivate_for_cleanup`.
```
...
- Add package/docs links relevant to `prefer_deactivate_for_cleanup` (e.g. bloc, riverpod, hive).
