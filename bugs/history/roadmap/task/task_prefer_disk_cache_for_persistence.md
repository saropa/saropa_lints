# Task: `prefer_disk_cache_for_persistence`

## Summary
- **Rule Name**: `prefer_disk_cache_for_persistence`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use disk cache for persistence across sessions. Detect memory-only cache for persistent data.
...
// TODO: Replace with concrete example for `prefer_disk_cache_for_persistence`.
```
...
- Add package/docs links relevant to `prefer_disk_cache_for_persistence` (e.g. bloc, riverpod, hive).
