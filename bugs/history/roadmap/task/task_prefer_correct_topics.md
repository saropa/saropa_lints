# Task: `prefer_correct_topics`

## Summary
- **Rule Name**: `prefer_correct_topics`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Topics should be valid pub.dev topics.
...
// TODO: Replace with concrete example for `prefer_correct_topics`.
```
...
- Add package/docs links relevant to `prefer_correct_topics` (e.g. bloc, riverpod, hive).
