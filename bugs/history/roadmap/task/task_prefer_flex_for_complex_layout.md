# Task: `prefer_flex_for_complex_layout`

## Summary
- **Rule Name**: `prefer_flex_for_complex_layout`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use Flex over Row/Column for dynamic axis. Detect conditional Row/Column.
...
// TODO: Replace with concrete example for `prefer_flex_for_complex_layout`.
```
...
- Add package/docs links relevant to `prefer_flex_for_complex_layout` (e.g. bloc, riverpod, hive).
