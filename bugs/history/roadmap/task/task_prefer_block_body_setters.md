# Task: `prefer_block_body_setters`

## Summary
- **Rule Name**: `prefer_block_body_setters`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
// TODO: Replace with concrete example for `prefer_block_body_setters`.
```
...
- Add package/docs links relevant to `prefer_block_body_setters` (e.g. bloc, riverpod, hive).
