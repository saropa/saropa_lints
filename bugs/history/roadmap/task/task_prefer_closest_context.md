# Task: `prefer_closest_context`

## Summary
- **Rule Name**: `prefer_closest_context`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use closest BuildContext for better performance. Detect distant context usage.
...
// TODO: Replace with concrete example for `prefer_closest_context`.
```
...
- Add package/docs links relevant to `prefer_closest_context` (e.g. bloc, riverpod, hive).
