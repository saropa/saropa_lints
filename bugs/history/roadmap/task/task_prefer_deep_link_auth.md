# Task: `prefer_deep_link_auth`

## Summary
- **Rule Name**: `prefer_deep_link_auth`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Deep links with auth tokens (password reset, magic links) must validate tokens server-side and expire quickly.
...
// TODO: Replace with concrete example for `prefer_deep_link_auth`.
```
...
- Add package/docs links relevant to `prefer_deep_link_auth` (e.g. bloc, riverpod, hive).
