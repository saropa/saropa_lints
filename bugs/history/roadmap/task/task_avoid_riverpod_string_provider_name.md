# Task: `avoid_riverpod_string_provider_name`

## Summary
- **Rule Name**: `avoid_riverpod_string_provider_name`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
- **Source**: ROADMAP.md — 5.4 Riverpod Advanced Rules

## Problem Statement

Provider.name should be auto-generated. Detect manual name strings in providers.
...
// TODO: Replace with concrete example for `avoid_riverpod_string_provider_name`.
```
...
- Add package/docs links relevant to `avoid_riverpod_string_provider_name` (e.g. bloc, riverpod, hive).
