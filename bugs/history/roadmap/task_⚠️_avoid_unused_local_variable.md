> **========================================================**
> **DUPLICATE -- DART SDK BUILT-IN**
> **========================================================**
>
> Dart SDK already provides `unused_local_variable` as a
> built-in hint. To elevate to WARNING severity, configure
> `analysis_options.yaml`:
>   analyzer:
>     errors:
>       unused_local_variable: warning
>
> No custom lint rule needed.
>
> **========================================================**
