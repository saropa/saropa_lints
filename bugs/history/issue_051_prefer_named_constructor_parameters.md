# Prefer Named Constructor Parameters

**GitHub:** [https://github.com/saropa/saropa_lints/issues/51](https://github.com/saropa/saropa_lints/issues/51)

**Resolved in:** N/A — Deferred (stylistic; overlaps existing param rules). Issue closed.
...
### Problem  
Using named parameters in constructors improves clarity and reduces errors from argument order.
...
- **False positives:** Some constructors may intentionally use positional parameters.

### Desired Outcome  
- Detect constructors without named parameters where appropriate.
- Warn about potential confusion.
- Suggest using named parameters for clarity.

### References  
- See ROADMAP.md section: "prefer_named_constructor_parameters"

---

## Roadmap task spec (merged from bugs/roadmap/task_prefer_named_constructor_parameters.md)

# Task: `prefer_named_constructor_parameters`

## Summary
- **Rule Name**: `prefer_named_constructor_parameters`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
...
Prefer named parameters in constructors for clarity.
...
// TODO: Replace with concrete example for `prefer_named_constructor_parameters`.
```
...
- Add package/docs links relevant to `prefer_named_constructor_parameters` (e.g. bloc, riverpod, hive).
