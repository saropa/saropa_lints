...
- [ ] Write quick-fix replacement (not applicable — shape choice is contextual)
...
**Status:** Implemented as `avoid_chip_delete_inkwell_circle_border` (`lib/src/rules/widget/flutter_migration_widget_rules.dart`)
