...
5. **Init in extension (I3, I5):** ~~I1 (Triage UI) done. I2 (Apply triage → write YAML) done. I3 (Minimal custom config) done.~~ First-run flow (I5). Then I4 (deprecate CLI). **← next**
