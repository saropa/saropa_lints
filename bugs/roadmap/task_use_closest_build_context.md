# Task: `use_closest_build_context`

## Summary
- **Rule Name**: `use_closest_build_context`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use the closest available BuildContext for better performance.
...
// TODO: Replace with concrete example for `use_closest_build_context`.
```
...
- Add package/docs links relevant to `use_closest_build_context` (e.g. bloc, riverpod, hive).
