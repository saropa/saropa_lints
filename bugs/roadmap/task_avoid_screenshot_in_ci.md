# Task: `avoid_screenshot_in_ci`

## Summary
- **Rule Name**: `avoid_screenshot_in_ci`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
Screenshots in CI consume storage and slow tests. Take screenshots only on failure for debugging, not on every test.
...
// TODO: Replace with concrete example for `avoid_screenshot_in_ci`.
```
...
- Add package/docs links relevant to `avoid_screenshot_in_ci` (e.g. bloc, riverpod, hive).
