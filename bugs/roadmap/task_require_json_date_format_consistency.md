# Task: `require_json_date_format_consistency`

## Summary
- **Rule Name**: `require_json_date_format_consistency`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
- **Source**: ROADMAP.md — 1.34 JSON & Serialization Rules

## Problem Statement

Dates in JSON need consistent format. Detect DateTime serialization without explicit format.
...
// TODO: Replace with concrete example for `require_json_date_format_consistency`.
```
...
- Add package/docs links relevant to `require_json_date_format_consistency` (e.g. bloc, riverpod, hive).
