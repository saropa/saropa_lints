# Task: `require_context_in_build_descendants`

## Summary
- **Rule Name**: `require_context_in_build_descendants`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
- **Source**: ROADMAP.md — 5.37 Build Context Rules

## Problem Statement

Use Builder for updated context. Detect context issue after widget creation.
...
// TODO: Replace with concrete example for `require_context_in_build_descendants`.
```
...
- Add package/docs links relevant to `require_context_in_build_descendants` (e.g. bloc, riverpod, hive).
