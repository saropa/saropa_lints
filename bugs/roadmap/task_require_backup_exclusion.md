# Task: `require_backup_exclusion`

## Summary
- **Rule Name**: `require_backup_exclusion`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Sensitive data should be excluded from iCloud/Google backups. Backups are often less protected than the device.
...
// TODO: Replace with concrete example for `require_backup_exclusion`.
```
...
- Add package/docs links relevant to `require_backup_exclusion` (e.g. bloc, riverpod, hive).
