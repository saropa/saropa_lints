# Task: `require_dispose_verification_tests`

## Summary
- **Rule Name**: `require_dispose_verification_tests`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Test dispose is called properly. Detect disposable without dispose test.
...
// TODO: Replace with concrete example for `require_dispose_verification_tests`.
```
...
- Add package/docs links relevant to `require_dispose_verification_tests` (e.g. bloc, riverpod, hive).
