# Task: `prefer_no_i_prefix_interfaces`

## Summary
- **Rule Name**: `prefer_no_i_prefix_interfaces`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
Interface classes without `I` prefix
...
// TODO: Replace with concrete example for `prefer_no_i_prefix_interfaces`.
```
...
- Add package/docs links relevant to `prefer_no_i_prefix_interfaces` (e.g. bloc, riverpod, hive).
