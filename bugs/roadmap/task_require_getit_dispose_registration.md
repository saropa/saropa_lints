# Task: `require_getit_dispose_registration`

## Summary
- **Rule Name**: `require_getit_dispose_registration`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Disposable singletons need dispose callbacks. Detect registerSingleton of Disposable types without dispose parameter.
...
// TODO: Replace with concrete example for `require_getit_dispose_registration`.
```
...
- Add package/docs links relevant to `require_getit_dispose_registration` (e.g. bloc, riverpod, hive).
