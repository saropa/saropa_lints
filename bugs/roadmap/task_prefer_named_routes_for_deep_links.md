# Task: `prefer_named_routes_for_deep_links`

## Summary
- **Rule Name**: `prefer_named_routes_for_deep_links`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
- **Source**: ROADMAP.md — 5.26 Navigator Rules

## Problem Statement

Named routes enable deep linking. Detect anonymous route construction.
...
// TODO: Replace with concrete example for `prefer_named_routes_for_deep_links`.
```
...
- Add package/docs links relevant to `prefer_named_routes_for_deep_links` (e.g. bloc, riverpod, hive).
