# Task: `prefer_whitelist_validation`

## Summary
- **Rule Name**: `prefer_whitelist_validation`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
- **Source**: ROADMAP.md — 1.5 Security Rules

## Problem Statement

Validate input against known-good values (allowlist) rather than blocking known-bad values (blocklist). Blocklists miss novel attacks.
...
// TODO: Replace with concrete example for `prefer_whitelist_validation`.
```
...
- Add package/docs links relevant to `prefer_whitelist_validation` (e.g. bloc, riverpod, hive).
