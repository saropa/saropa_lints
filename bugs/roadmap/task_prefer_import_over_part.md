# Task: `prefer_import_over_part`

## Summary
- **Rule Name**: `prefer_import_over_part`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use imports instead of `part`/`part of`
...
// TODO: Replace with concrete example for `prefer_import_over_part`.
```
...
- Add package/docs links relevant to `prefer_import_over_part` (e.g. bloc, riverpod, hive).
