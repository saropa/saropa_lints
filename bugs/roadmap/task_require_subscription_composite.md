# Task: `require_subscription_composite`

## Summary
- **Rule Name**: `require_subscription_composite`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Group subscriptions for batch disposal. Detect multiple individual subscriptions.
...
// TODO: Replace with concrete example for `require_subscription_composite`.
```
...
- Add package/docs links relevant to `require_subscription_composite` (e.g. bloc, riverpod, hive).
