# Task: `require_error_message_clarity`

## Summary
- **Rule Name**: `require_error_message_clarity`
- **Tier**: Recommended
- **Severity**: INFO
- **Status**: Planned
...
Error messages should explain fix. Detect generic "Invalid" messages.
...
// TODO: Replace with concrete example for `require_error_message_clarity`.
```
...
- Add package/docs links relevant to `require_error_message_clarity` (e.g. bloc, riverpod, hive).
