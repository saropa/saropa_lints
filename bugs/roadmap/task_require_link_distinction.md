# Task: `require_link_distinction`

## Summary
- **Rule Name**: `require_link_distinction`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
Links must be distinguishable from regular text without relying on color alone. Use underline or other visual treatment.
...
// TODO: Replace with concrete example for `require_link_distinction`.
```
...
- Add package/docs links relevant to `require_link_distinction` (e.g. bloc, riverpod, hive).
