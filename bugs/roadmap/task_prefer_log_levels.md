# Task: `prefer_log_levels`

## Summary
- **Rule Name**: `prefer_log_levels`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use log levels appropriately. Detect single log level usage.
...
// TODO: Replace with concrete example for `prefer_log_levels`.
```
...
- Add package/docs links relevant to `prefer_log_levels` (e.g. bloc, riverpod, hive).
