# Task: `prefer_outlined_icons`

## Summary
- **Rule Name**: `prefer_outlined_icons`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
Outlined icons have better visibility than filled icons for users with low vision. Consider icon style for accessibility.
...
// TODO: Replace with concrete example for `prefer_outlined_icons`.
```
...
- Add package/docs links relevant to `prefer_outlined_icons` (e.g. bloc, riverpod, hive).
