# Task: `require_di_module_separation`

## Summary
- **Rule Name**: `require_di_module_separation`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
- **Source**: ROADMAP.md — 5.42 Dependency Injection Rules

## Problem Statement

Separate DI configuration into modules. Detect monolithic registration.
...
// TODO: Replace with concrete example for `require_di_module_separation`.
```
...
- Add package/docs links relevant to `require_di_module_separation` (e.g. bloc, riverpod, hive).
