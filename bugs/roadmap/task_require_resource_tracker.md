# Task: `require_resource_tracker`

## Summary
- **Rule Name**: `require_resource_tracker`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
Track resources for leak detection. Detect undisposed resources in debug mode.
...
// TODO: Replace with concrete example for `require_resource_tracker`.
```
...
- Add package/docs links relevant to `require_resource_tracker` (e.g. bloc, riverpod, hive).
