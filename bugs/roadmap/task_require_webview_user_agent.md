# Task: `require_webview_user_agent`

## Summary
- **Rule Name**: `require_webview_user_agent`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Set custom user agent for analytics. Detect default user agent.
...
// TODO: Replace with concrete example for `require_webview_user_agent`.
```
...
- Add package/docs links relevant to `require_webview_user_agent` (e.g. bloc, riverpod, hive).
