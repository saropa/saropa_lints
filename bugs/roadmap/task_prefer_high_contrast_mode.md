# Task: `prefer_high_contrast_mode`

## Summary
- **Rule Name**: `prefer_high_contrast_mode`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Support MediaQuery.highContrast for users who need stark color differences. Provide high-contrast theme variant.
...
// TODO: Replace with concrete example for `prefer_high_contrast_mode`.
```
...
- Add package/docs links relevant to `prefer_high_contrast_mode` (e.g. bloc, riverpod, hive).
