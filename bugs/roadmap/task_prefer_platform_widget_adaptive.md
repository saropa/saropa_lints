# Task: `prefer_platform_widget_adaptive`

## Summary
- **Rule Name**: `prefer_platform_widget_adaptive`
- **Tier**: Recommended
- **Severity**: INFO
- **Status**: Planned
...
Use platform-adaptive widgets. Detect Material widgets in iOS-only context.
...
// TODO: Replace with concrete example for `prefer_platform_widget_adaptive`.
```
...
- Add package/docs links relevant to `prefer_platform_widget_adaptive` (e.g. bloc, riverpod, hive).
