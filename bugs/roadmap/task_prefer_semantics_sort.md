# Task: `prefer_semantics_sort`

## Summary
- **Rule Name**: `prefer_semantics_sort`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Complex layouts may need `sortKey` to control screen reader navigation order. Default order may not match visual layout.
...
// TODO: Replace with concrete example for `prefer_semantics_sort`.
```
...
- Add package/docs links relevant to `prefer_semantics_sort` (e.g. bloc, riverpod, hive).
