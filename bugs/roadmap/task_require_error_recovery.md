# Task: `require_error_recovery`

## Summary
- **Rule Name**: `require_error_recovery`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Error handlers should enable recovery. Detect catch without user-recoverable action.
...
// TODO: Replace with concrete example for `require_error_recovery`.
```
...
- Add package/docs links relevant to `require_error_recovery` (e.g. bloc, riverpod, hive).
