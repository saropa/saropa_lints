# Task: `require_rtl_support`

## Summary
- **Rule Name**: `require_rtl_support`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Support RTL layouts. Detect hardcoded left/right in layouts.
...
// TODO: Replace with concrete example for `require_rtl_support`.
```
...
- Add package/docs links relevant to `require_rtl_support` (e.g. bloc, riverpod, hive).
