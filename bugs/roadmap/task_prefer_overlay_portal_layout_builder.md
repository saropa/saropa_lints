# Task: `prefer_overlay_portal_layout_builder`

## Summary
- **Rule Name**: `prefer_overlay_portal_layout_builder`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
- **Source**: ROADMAP.md — 4.1 Dart 3.x & Flutter Widget Features

## Problem Statement

Use OverlayPortal.overlayChildLayoutBuilder (Flutter 3.38) for unconstrained overlays.
...
// TODO: Replace with concrete example for `prefer_overlay_portal_layout_builder`.
```
...
- Add package/docs links relevant to `prefer_overlay_portal_layout_builder` (e.g. bloc, riverpod, hive).
