# Task: `avoid_freezed_invalid_annotation_target`

## Summary
- **Rule Name**: `avoid_freezed_invalid_annotation_target`
- **Tier**: Recommended
- **Severity**: INFO
- **Status**: Planned
...
Disable invalid_annotation_target warning in analysis_options.
...
// TODO: Replace with concrete example for `avoid_freezed_invalid_annotation_target`.
```
...
- Add package/docs links relevant to `avoid_freezed_invalid_annotation_target` (e.g. bloc, riverpod, hive).
