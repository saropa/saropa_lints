# Task: `require_heading_hierarchy`

## Summary
- **Rule Name**: `require_heading_hierarchy`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use proper heading structure. Detect inconsistent heading levels.
...
// TODO: Replace with concrete example for `require_heading_hierarchy`.
```
...
- Add package/docs links relevant to `require_heading_hierarchy` (e.g. bloc, riverpod, hive).
