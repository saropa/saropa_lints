# Task: `require_firebase_email_enumeration_protection`

## Summary
- **Rule Name**: `require_firebase_email_enumeration_protection`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
fetchSignInMethodsForEmail was removed. Detect usage in code.
...
// TODO: Replace with concrete example for `require_firebase_email_enumeration_protection`.
```
...
- Add package/docs links relevant to `require_firebase_email_enumeration_protection` (e.g. bloc, riverpod, hive).
