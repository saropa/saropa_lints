# Task: `require_switch_control`

## Summary
- **Rule Name**: `require_switch_control`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
Switch control users navigate sequentially. Ensure logical focus order and that all interactive elements are focusable.
...
// TODO: Replace with concrete example for `require_switch_control`.
```
...
- Add package/docs links relevant to `require_switch_control` (e.g. bloc, riverpod, hive).
