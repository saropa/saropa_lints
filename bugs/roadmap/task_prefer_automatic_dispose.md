# Task: `prefer_automatic_dispose`

## Summary
- **Rule Name**: `prefer_automatic_dispose`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use packages with auto-dispose. Detect manual disposal patterns.
...
// TODO: Replace with concrete example for `prefer_automatic_dispose`.
```
...
- Add package/docs links relevant to `prefer_automatic_dispose` (e.g. bloc, riverpod, hive).
