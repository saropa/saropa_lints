# Task: `prefer_composition_over_inheritance`

## Summary
- **Rule Name**: `prefer_composition_over_inheritance`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
- **Source**: ROADMAP.md — 5.38 Code Organization Rules

## Problem Statement

Use composition for flexibility. Detect deep inheritance hierarchies.
...
// TODO: Replace with concrete example for `prefer_composition_over_inheritance`.
```
...
- Add package/docs links relevant to `prefer_composition_over_inheritance` (e.g. bloc, riverpod, hive).
