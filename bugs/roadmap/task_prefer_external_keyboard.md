# Task: `prefer_external_keyboard`

## Summary
- **Rule Name**: `prefer_external_keyboard`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
Support full keyboard navigation for users who can't use touch. Ensure all actions are reachable via Tab and Enter.
...
// TODO: Replace with concrete example for `prefer_external_keyboard`.
```
...
- Add package/docs links relevant to `prefer_external_keyboard` (e.g. bloc, riverpod, hive).
