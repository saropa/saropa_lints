# Task: `prefer_optional_named_params`

## Summary
- **Rule Name**: `prefer_optional_named_params`
- **Tier**: Recommended
- **Severity**: INFO
- **Status**: Planned
...
// TODO: Replace with concrete example for `prefer_optional_named_params`.
```
...
- Add package/docs links relevant to `prefer_optional_named_params` (e.g. bloc, riverpod, hive).
