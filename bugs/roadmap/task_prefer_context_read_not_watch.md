# Task: `prefer_context_read_not_watch`

## Summary
- **Rule Name**: `prefer_context_read_not_watch`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use context.read in one-time operations. Detect context.watch in single-use callback.
...
// TODO: Replace with concrete example for `prefer_context_read_not_watch`.
```
...
- Add package/docs links relevant to `prefer_context_read_not_watch` (e.g. bloc, riverpod, hive).
