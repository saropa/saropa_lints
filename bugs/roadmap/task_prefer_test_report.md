# Task: `prefer_test_report`

## Summary
- **Rule Name**: `prefer_test_report`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
Generate JUnit XML or JSON reports for CI dashboards. Raw console output is hard to track over time.
...
// TODO: Replace with concrete example for `prefer_test_report`.
```
...
- Add package/docs links relevant to `prefer_test_report` (e.g. bloc, riverpod, hive).
