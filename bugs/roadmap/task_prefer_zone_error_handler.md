# Task: `prefer_zone_error_handler`

## Summary
- **Rule Name**: `prefer_zone_error_handler`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
Use Zone for unhandled async errors. Detect async without zone handling.
...
// TODO: Replace with concrete example for `prefer_zone_error_handler`.
```
...
- Add package/docs links relevant to `prefer_zone_error_handler` (e.g. bloc, riverpod, hive).
