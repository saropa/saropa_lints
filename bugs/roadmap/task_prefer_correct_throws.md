# Task: `prefer_correct_throws`

## Summary
- **Rule Name**: `prefer_correct_throws`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Document thrown exceptions with `@Throws` annotation.
...
// TODO: Replace with concrete example for `prefer_correct_throws`.
```
...
- Add package/docs links relevant to `prefer_correct_throws` (e.g. bloc, riverpod, hive).
