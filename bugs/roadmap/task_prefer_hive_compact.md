# Task: `prefer_hive_compact`

## Summary
- **Rule Name**: `prefer_hive_compact`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Large boxes should be compacted periodically. Detect long-running box without compact.
...
// TODO: Replace with concrete example for `prefer_hive_compact`.
```
...
- Add package/docs links relevant to `prefer_hive_compact` (e.g. bloc, riverpod, hive).
