...
Validate custom element tag names follow conventions.
...
// TODO: Replace with concrete example for `tag_name`.
```
...
- Add package/docs links relevant to `tag_name` (e.g. bloc, riverpod, hive).
