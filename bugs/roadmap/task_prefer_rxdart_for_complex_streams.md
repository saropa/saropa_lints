# Task: `prefer_rxdart_for_complex_streams`

## Summary
- **Rule Name**: `prefer_rxdart_for_complex_streams`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
RxDart provides better operators. Detect complex stream transformations.
...
// TODO: Replace with concrete example for `prefer_rxdart_for_complex_streams`.
```
...
- Add package/docs links relevant to `prefer_rxdart_for_complex_streams` (e.g. bloc, riverpod, hive).
