# Task: `require_will_pop_scope`

## Summary
- **Rule Name**: `require_will_pop_scope`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Handle back button appropriately. Detect navigation without back handling.
...
// TODO: Replace with concrete example for `require_will_pop_scope`.
```
...
- Add package/docs links relevant to `require_will_pop_scope` (e.g. bloc, riverpod, hive).
