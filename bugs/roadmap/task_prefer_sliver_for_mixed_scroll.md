# Task: `prefer_sliver_for_mixed_scroll`

## Summary
- **Rule Name**: `prefer_sliver_for_mixed_scroll`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use slivers for mixed scrollable content. Detect nested scrollables.
...
// TODO: Replace with concrete example for `prefer_sliver_for_mixed_scroll`.
```
...
- Add package/docs links relevant to `prefer_sliver_for_mixed_scroll` (e.g. bloc, riverpod, hive).
