# Task: `prefer_internet_connection_checker`

## Summary
- **Rule Name**: `prefer_internet_connection_checker`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
// TODO: Replace with concrete example for `prefer_internet_connection_checker`.
```
...
- Add package/docs links relevant to `prefer_internet_connection_checker` (e.g. bloc, riverpod, hive).
