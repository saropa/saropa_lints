# Task: `require_config_validation`

## Summary
- **Rule Name**: `require_config_validation`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Validate configuration on startup. Detect config usage without validation.
...
// TODO: Replace with concrete example for `require_config_validation`.
```
...
- Add package/docs links relevant to `require_config_validation` (e.g. bloc, riverpod, hive).
