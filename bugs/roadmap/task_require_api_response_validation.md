# Task: `require_api_response_validation`

## Summary
- **Rule Name**: `require_api_response_validation`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
- **Source**: ROADMAP.md — 5.35 Platform & API Response Handling

## Problem Statement

Validate API response structure. Detect direct field access without validation.
...
// TODO: Replace with concrete example for `require_api_response_validation`.
```
...
- Add package/docs links relevant to `require_api_response_validation` (e.g. bloc, riverpod, hive).
