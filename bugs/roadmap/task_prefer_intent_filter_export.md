# Task: `prefer_intent_filter_export`

## Summary
- **Rule Name**: `prefer_intent_filter_export`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Android intent filters should be exported only when necessary. Unexported components can't be invoked by malicious apps.
...
// TODO: Replace with concrete example for `prefer_intent_filter_export`.
```
...
- Add package/docs links relevant to `prefer_intent_filter_export` (e.g. bloc, riverpod, hive).
