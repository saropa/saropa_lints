# Task: `prefer_hive_compact_periodically`

## Summary
- **Rule Name**: `prefer_hive_compact_periodically`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Hive files grow without compaction. Call box.compact() after bulk deletes to reclaim space.
...
// TODO: Replace with concrete example for `prefer_hive_compact_periodically`.
```
...
- Add package/docs links relevant to `prefer_hive_compact_periodically` (e.g. bloc, riverpod, hive).
