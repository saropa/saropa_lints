# Task: `prefer_weak_references`

## Summary
- **Rule Name**: `prefer_weak_references`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
Use Expando for optional associations. Detect strong refs where weak would work.
...
// TODO: Replace with concrete example for `prefer_weak_references`.
```
...
- Add package/docs links relevant to `prefer_weak_references` (e.g. bloc, riverpod, hive).
