# Task: `prefer_webview_sandbox`

## Summary
- **Rule Name**: `prefer_webview_sandbox`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use sandbox attribute for iframes. Detect iframe without sandbox.
...
// TODO: Replace with concrete example for `prefer_webview_sandbox`.
```
...
- Add package/docs links relevant to `prefer_webview_sandbox` (e.g. bloc, riverpod, hive).
