# Task: `prefer_isar_for_complex_queries`

## Summary
- **Rule Name**: `prefer_isar_for_complex_queries`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
- **Source**: ROADMAP.md — 1.10 Database & Storage Rules

## Problem Statement

Hive's query capabilities are limited. Isar supports complex queries, full-text search, and links between objects.
...
// TODO: Replace with concrete example for `prefer_isar_for_complex_queries`.
```
...
- Add package/docs links relevant to `prefer_isar_for_complex_queries` (e.g. bloc, riverpod, hive).
