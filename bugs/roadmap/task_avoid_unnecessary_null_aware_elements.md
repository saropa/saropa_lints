# Task: `avoid_unnecessary_null_aware_elements`

## Summary
- **Rule Name**: `avoid_unnecessary_null_aware_elements`
- **Tier**: Recommended
- **Severity**: INFO
- **Status**: Planned
...
Null-aware elements in collections that can't be null.
...
// TODO: Replace with concrete example for `avoid_unnecessary_null_aware_elements`.
```
...
- Add package/docs links relevant to `avoid_unnecessary_null_aware_elements` (e.g. bloc, riverpod, hive).
