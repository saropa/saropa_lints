# Task: `prefer_dark_mode_colors`

## Summary
- **Rule Name**: `prefer_dark_mode_colors`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Dark mode isn't just inverted colors. Ensure proper contrast, reduce pure white text, and test readability.
...
// TODO: Replace with concrete example for `prefer_dark_mode_colors`.
```
...
- Add package/docs links relevant to `prefer_dark_mode_colors` (e.g. bloc, riverpod, hive).
