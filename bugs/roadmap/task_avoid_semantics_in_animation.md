# Task: `avoid_semantics_in_animation`

## Summary
- **Rule Name**: `avoid_semantics_in_animation`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
Semantics should not change during animations. Screen readers get confused by rapidly changing semantic trees.
...
// TODO: Replace with concrete example for `avoid_semantics_in_animation`.
```
...
- Add package/docs links relevant to `avoid_semantics_in_animation` (e.g. bloc, riverpod, hive).
