# Task: `require_api_version_handling`

## Summary
- **Rule Name**: `require_api_version_handling`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Handle API version changes. Detect hardcoded response expectations.
...
// TODO: Replace with concrete example for `require_api_version_handling`.
```
...
- Add package/docs links relevant to `require_api_version_handling` (e.g. bloc, riverpod, hive).
