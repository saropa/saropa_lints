# Task: `prefer_fire_and_forget`

## Summary
- **Rule Name**: `prefer_fire_and_forget`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
...
Prefer fire-and-forget async calls where result is not needed.
...
// TODO: Replace with concrete example for `prefer_fire_and_forget`.
```
...
- Add package/docs links relevant to `prefer_fire_and_forget` (e.g. bloc, riverpod, hive).
