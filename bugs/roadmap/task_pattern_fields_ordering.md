# Task: `pattern_fields_ordering`

## Summary
- **Rule Name**: `pattern_fields_ordering`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
- **Source**: ROADMAP.md — 1.60 Ordering & Pattern Rules

## Problem Statement

Enforce consistent ordering of fields in pattern matching.
...
// TODO: Replace with concrete example for `pattern_fields_ordering`.
```
...
- Add package/docs links relevant to `pattern_fields_ordering` (e.g. bloc, riverpod, hive).
