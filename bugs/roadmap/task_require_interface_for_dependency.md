# Task: `require_interface_for_dependency`

## Summary
- **Rule Name**: `require_interface_for_dependency`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use interfaces for testability. Detect concrete class dependencies.
...
// TODO: Replace with concrete example for `require_interface_for_dependency`.
```
...
- Add package/docs links relevant to `require_interface_for_dependency` (e.g. bloc, riverpod, hive).
