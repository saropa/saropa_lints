# Task: `prefer_riverpod_keep_alive`

## Summary
- **Rule Name**: `prefer_riverpod_keep_alive`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Long-lived state should use ref.keepAlive(). Detect state loss from auto-dispose.
...
// TODO: Replace with concrete example for `prefer_riverpod_keep_alive`.
```
...
- Add package/docs links relevant to `prefer_riverpod_keep_alive` (e.g. bloc, riverpod, hive).
