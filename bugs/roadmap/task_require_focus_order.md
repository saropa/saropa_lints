# Task: `require_focus_order`

## Summary
- **Rule Name**: `require_focus_order`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Ensure logical focus order. Detect FocusTraversalGroup misconfiguration.
...
// TODO: Replace with concrete example for `require_focus_order`.
```
...
- Add package/docs links relevant to `require_focus_order` (e.g. bloc, riverpod, hive).
