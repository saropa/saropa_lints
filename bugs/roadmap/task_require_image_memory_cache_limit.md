# Task: `require_image_memory_cache_limit`

## Summary
- **Rule Name**: `require_image_memory_cache_limit`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Set PaintingBinding.imageCache limits. Detect default unlimited cache.
...
// TODO: Replace with concrete example for `require_image_memory_cache_limit`.
```
...
- Add package/docs links relevant to `require_image_memory_cache_limit` (e.g. bloc, riverpod, hive).
