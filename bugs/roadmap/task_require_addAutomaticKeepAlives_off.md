# Task: `require_addAutomaticKeepAlives_off`

## Summary
- **Rule Name**: `require_addAutomaticKeepAlives_off`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Disable for memory savings in long lists. Detect long list with default true.
...
// TODO: Replace with concrete example for `require_addAutomaticKeepAlives_off`.
```
...
- Add package/docs links relevant to `require_addAutomaticKeepAlives_off` (e.g. bloc, riverpod, hive).
