# Task: `require_stream_cancel_on_error`

## Summary
- **Rule Name**: `require_stream_cancel_on_error`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Consider cancelOnError for critical streams. Detect error-sensitive streams.
...
// TODO: Replace with concrete example for `require_stream_cancel_on_error`.
```
...
- Add package/docs links relevant to `require_stream_cancel_on_error` (e.g. bloc, riverpod, hive).
