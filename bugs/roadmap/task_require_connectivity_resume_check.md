# Task: `require_connectivity_resume_check`

## Summary
- **Rule Name**: `require_connectivity_resume_check`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Re-check connectivity when app resumes. Android 8+ stops background updates.
...
// TODO: Replace with concrete example for `require_connectivity_resume_check`.
```
...
- Add package/docs links relevant to `require_connectivity_resume_check` (e.g. bloc, riverpod, hive).
