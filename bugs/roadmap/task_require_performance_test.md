# Task: `require_performance_test`

## Summary
- **Rule Name**: `require_performance_test`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Measure frame rendering time and startup latency in integration tests. Catch performance regressions before they reach production.
...
// TODO: Replace with concrete example for `require_performance_test`.
```
...
- Add package/docs links relevant to `require_performance_test` (e.g. bloc, riverpod, hive).
