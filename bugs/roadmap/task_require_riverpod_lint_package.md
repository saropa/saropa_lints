# Task: `require_riverpod_lint_package`

## Summary
- **Rule Name**: `require_riverpod_lint_package`
- **Tier**: Recommended
- **Severity**: INFO
- **Status**: Planned
...
Install riverpod_lint for official linting. Detect Riverpod usage without riverpod_lint dependency.
...
// TODO: Replace with concrete example for `require_riverpod_lint_package`.
```
...
- Add package/docs links relevant to `require_riverpod_lint_package` (e.g. bloc, riverpod, hive).
