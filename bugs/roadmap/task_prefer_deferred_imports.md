# Task: `prefer_deferred_imports`

## Summary
- **Rule Name**: `prefer_deferred_imports`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
Use deferred imports for large libraries
...
// TODO: Replace with concrete example for `prefer_deferred_imports`.
```
...
- Add package/docs links relevant to `prefer_deferred_imports` (e.g. bloc, riverpod, hive).
