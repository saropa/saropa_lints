# Task: `avoid_test_on_real_device`

## Summary
- **Rule Name**: `avoid_test_on_real_device`
- **Tier**: Recommended
- **Severity**: INFO
- **Status**: Planned
...
Real devices vary in performance and state. Use emulators/simulators in CI for consistent, reproducible results.
...
// TODO: Replace with concrete example for `avoid_test_on_real_device`.
```
...
- Add package/docs links relevant to `avoid_test_on_real_device` (e.g. bloc, riverpod, hive).
