# Task: `prefer_base_prefix`

## Summary
- **Rule Name**: `prefer_base_prefix`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
// TODO: Replace with concrete example for `prefer_base_prefix`.
```
...
- Add package/docs links relevant to `prefer_base_prefix` (e.g. bloc, riverpod, hive).
