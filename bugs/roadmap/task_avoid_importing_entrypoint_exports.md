# Task: `avoid_importing_entrypoint_exports`

## Summary
- **Rule Name**: `avoid_importing_entrypoint_exports`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Avoid importing from files that re-export entry points.
...
// TODO: Replace with concrete example for `avoid_importing_entrypoint_exports`.
```
...
- Add package/docs links relevant to `avoid_importing_entrypoint_exports` (e.g. bloc, riverpod, hive).
