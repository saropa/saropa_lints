# Task: `require_cancellable_operations`

## Summary
- **Rule Name**: `require_cancellable_operations`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Long operations should be cancellable. Detect Completer without cancel mechanism.
...
// TODO: Replace with concrete example for `require_cancellable_operations`.
```
...
- Add package/docs links relevant to `require_cancellable_operations` (e.g. bloc, riverpod, hive).
