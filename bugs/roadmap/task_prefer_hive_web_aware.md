# Task: `prefer_hive_web_aware`

## Summary
- **Rule Name**: `prefer_hive_web_aware`
- **Tier**: Recommended
- **Severity**: INFO
- **Status**: Planned
...
Hive web has different behavior. Detect Hive usage without web considerations.
...
// TODO: Replace with concrete example for `prefer_hive_web_aware`.
```
...
- Add package/docs links relevant to `prefer_hive_web_aware` (e.g. bloc, riverpod, hive).
