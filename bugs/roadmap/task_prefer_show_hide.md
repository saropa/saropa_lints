# Task: `prefer_show_hide`

## Summary
- **Rule Name**: `prefer_show_hide`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
// TODO: Replace with concrete example for `prefer_show_hide`.
```
...
- Add package/docs links relevant to `prefer_show_hide` (e.g. bloc, riverpod, hive).
