# Task: `prefer_notification_custom_sound`

## Summary
- **Rule Name**: `prefer_notification_custom_sound`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Important notifications may need custom sound. Document sound configuration.
...
// TODO: Replace with concrete example for `prefer_notification_custom_sound`.
```
...
- Add package/docs links relevant to `prefer_notification_custom_sound` (e.g. bloc, riverpod, hive).
