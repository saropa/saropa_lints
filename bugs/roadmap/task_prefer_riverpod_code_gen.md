# Task: `prefer_riverpod_code_gen`

## Summary
- **Rule Name**: `prefer_riverpod_code_gen`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use @riverpod annotation for type-safe providers. Detect hand-written provider declarations.
...
// TODO: Replace with concrete example for `prefer_riverpod_code_gen`.
```
...
- Add package/docs links relevant to `prefer_riverpod_code_gen` (e.g. bloc, riverpod, hive).
