# Task: `prefer_correct_screenshots`

## Summary
- **Rule Name**: `prefer_correct_screenshots`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Screenshots in pubspec should have valid paths and descriptions.
...
// TODO: Replace with concrete example for `prefer_correct_screenshots`.
```
...
- Add package/docs links relevant to `prefer_correct_screenshots` (e.g. bloc, riverpod, hive).
