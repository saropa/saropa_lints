# Task: `prefer_log_timestamp`

## Summary
- **Rule Name**: `prefer_log_timestamp`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Include timestamps in logs. Detect logs without time information.
...
// TODO: Replace with concrete example for `prefer_log_timestamp`.
```
...
- Add package/docs links relevant to `prefer_log_timestamp` (e.g. bloc, riverpod, hive).
