# Task: `prefer_streams_over_polling`

## Summary
- **Rule Name**: `prefer_streams_over_polling`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Streams are more memory-efficient than polling. Detect Timer-based polling.
...
// TODO: Replace with concrete example for `prefer_streams_over_polling`.
```
...
- Add package/docs links relevant to `prefer_streams_over_polling` (e.g. bloc, riverpod, hive).
