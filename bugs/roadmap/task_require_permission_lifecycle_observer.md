# Task: `require_permission_lifecycle_observer`

## Summary
- **Rule Name**: `require_permission_lifecycle_observer`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
- **Source**: ROADMAP.md — 5.9 Platform & Permissions (sqflite, permission_handler, geolocator, notifications)

## Problem Statement

Re-check permissions on app resume. Detect missing WidgetsBindingObserver.
...
// TODO: Replace with concrete example for `require_permission_lifecycle_observer`.
```
...
- Add package/docs links relevant to `require_permission_lifecycle_observer` (e.g. bloc, riverpod, hive).
