# Task: `prefer_lru_cache`

## Summary
- **Rule Name**: `prefer_lru_cache`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use LRU for memory-bounded cache. Detect Map used as cache without eviction.
...
// TODO: Replace with concrete example for `prefer_lru_cache`.
```
...
- Add package/docs links relevant to `prefer_lru_cache` (e.g. bloc, riverpod, hive).
