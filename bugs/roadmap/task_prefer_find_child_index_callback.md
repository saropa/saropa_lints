# Task: `prefer_find_child_index_callback`

## Summary
- **Rule Name**: `prefer_find_child_index_callback`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use for custom child positioning. Detect custom index needs.
...
// TODO: Replace with concrete example for `prefer_find_child_index_callback`.
```
...
- Add package/docs links relevant to `prefer_find_child_index_callback` (e.g. bloc, riverpod, hive).
