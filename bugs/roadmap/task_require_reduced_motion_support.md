# Task: `require_reduced_motion_support`

## Summary
- **Rule Name**: `require_reduced_motion_support`
- **Tier**: Recommended
- **Severity**: INFO
- **Status**: Planned
...
Check MediaQuery.disableAnimations. Detect animations without reduced motion check.
...
// TODO: Replace with concrete example for `require_reduced_motion_support`.
```
...
- Add package/docs links relevant to `require_reduced_motion_support` (e.g. bloc, riverpod, hive).
