# Task: `prefer_stream_transformer`

## Summary
- **Rule Name**: `prefer_stream_transformer`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use transformers for complex operations. Detect manual stream manipulation.
...
// TODO: Replace with concrete example for `prefer_stream_transformer`.
```
...
- Add package/docs links relevant to `prefer_stream_transformer` (e.g. bloc, riverpod, hive).
