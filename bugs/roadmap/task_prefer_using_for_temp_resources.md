# Task: `prefer_using_for_temp_resources`

## Summary
- **Rule Name**: `prefer_using_for_temp_resources`
- **Tier**: Recommended
- **Severity**: INFO
- **Status**: Planned
...
Use using() extension for scoped resources. Detect try-finally for temp resources.
...
// TODO: Replace with concrete example for `prefer_using_for_temp_resources`.
```
...
- Add package/docs links relevant to `prefer_using_for_temp_resources` (e.g. bloc, riverpod, hive).
