# Task: `prefer_announce_for_changes`

## Summary
- **Rule Name**: `prefer_announce_for_changes`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
- **Source**: ROADMAP.md — 1.6 Accessibility Rules

## Problem Statement

Important state changes should use `SemanticsService.announce()` to inform screen reader users of non-visual feedback.
...
// TODO: Replace with concrete example for `prefer_announce_for_changes`.
```
...
- Add package/docs links relevant to `prefer_announce_for_changes` (e.g. bloc, riverpod, hive).
