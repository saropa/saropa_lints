# Task: `prefer_part_over_import`

## Summary
- **Rule Name**: `prefer_part_over_import`
- **Tier**: Pedantic
- **Severity**: INFO
- **Status**: Planned
...
Use `part`/`part of` for tightly coupled files
...
// TODO: Replace with concrete example for `prefer_part_over_import`.
```
...
- Add package/docs links relevant to `prefer_part_over_import` (e.g. bloc, riverpod, hive).
