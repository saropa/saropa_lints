# Task: `use_specific_deprecation`

## Summary
- **Rule Name**: `use_specific_deprecation`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use Dart 3.10 specific deprecation annotations for finer-grained control.
...
// TODO: Replace with concrete example for `use_specific_deprecation`.
```
...
- Add package/docs links relevant to `use_specific_deprecation` (e.g. bloc, riverpod, hive).
