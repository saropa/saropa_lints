# Task: `prefer_json_codegen`

## Summary
- **Rule Name**: `prefer_json_codegen`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Manual fromJson/toJson is error-prone. Detect hand-written fromJson methods; suggest json_serializable/freezed.
...
// TODO: Replace with concrete example for `prefer_json_codegen`.
```
...
- Add package/docs links relevant to `prefer_json_codegen` (e.g. bloc, riverpod, hive).
