# Task: `require_sqflite_index_for_queries`

## Summary
- **Rule Name**: `require_sqflite_index_for_queries`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Frequently queried columns need indexes. Detect slow queries without index.
...
// TODO: Replace with concrete example for `require_sqflite_index_for_queries`.
```
...
- Add package/docs links relevant to `require_sqflite_index_for_queries` (e.g. bloc, riverpod, hive).
