# Task: `require_multi_factor`

## Summary
- **Rule Name**: `require_multi_factor`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
Sensitive operations (payments, account changes) should offer or require multi-factor authentication for additional security.
...
// TODO: Replace with concrete example for `require_multi_factor`.
```
...
- Add package/docs links relevant to `require_multi_factor` (e.g. bloc, riverpod, hive).
