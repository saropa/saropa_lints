# Task: `record_fields_ordering`

## Summary
- **Rule Name**: `record_fields_ordering`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
...
Enforce consistent ordering of fields in record declarations.
...
// TODO: Replace with concrete example for `record_fields_ordering`.
```
...
- Add package/docs links relevant to `record_fields_ordering` (e.g. bloc, riverpod, hive).
