# Task: `prefer_injectable_package`

## Summary
- **Rule Name**: `prefer_injectable_package`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use code generation for DI. Detect manual registration boilerplate.
...
// TODO: Replace with concrete example for `prefer_injectable_package`.
```
...
- Add package/docs links relevant to `prefer_injectable_package` (e.g. bloc, riverpod, hive).
