# Task: `require_error_context_in_logs`

## Summary
- **Rule Name**: `require_error_context_in_logs`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Errors need context for debugging. Detect error log without context.
...
// TODO: Replace with concrete example for `require_error_context_in_logs`.
```
...
- Add package/docs links relevant to `require_error_context_in_logs` (e.g. bloc, riverpod, hive).
