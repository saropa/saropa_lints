# Task: `prefer_l10n_yaml_config`

## Summary
- **Rule Name**: `prefer_l10n_yaml_config`
- **Tier**: Recommended
- **Severity**: INFO
- **Status**: Planned
- **Source**: ROADMAP.md — 5.28 Internationalization (intl) Rules

## Problem Statement

Use l10n.yaml for configuration. Detect missing configuration file.
...
// TODO: Replace with concrete example for `prefer_l10n_yaml_config`.
```
...
- Add package/docs links relevant to `prefer_l10n_yaml_config` (e.g. bloc, riverpod, hive).
