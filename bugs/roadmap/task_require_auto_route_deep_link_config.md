# Task: `require_auto_route_deep_link_config`

## Summary
- **Rule Name**: `require_auto_route_deep_link_config`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Configure deep links properly. Detect routes without path configuration.
...
// TODO: Replace with concrete example for `require_auto_route_deep_link_config`.
```
...
- Add package/docs links relevant to `require_auto_route_deep_link_config` (e.g. bloc, riverpod, hive).
