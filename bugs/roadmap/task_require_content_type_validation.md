# Task: `require_content_type_validation`

## Summary
- **Rule Name**: `require_content_type_validation`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Verify response Content-Type. Detect JSON parsing without content-type check.
...
// TODO: Replace with concrete example for `require_content_type_validation`.
```
...
- Add package/docs links relevant to `require_content_type_validation` (e.g. bloc, riverpod, hive).
