# Task: `prefer_permission_minimal_request`

## Summary
- **Rule Name**: `prefer_permission_minimal_request`
- **Tier**: Recommended
- **Severity**: INFO
- **Status**: Planned
...
Request only needed permissions. Detect requesting unused permissions.
...
// TODO: Replace with concrete example for `prefer_permission_minimal_request`.
```
...
- Add package/docs links relevant to `prefer_permission_minimal_request` (e.g. bloc, riverpod, hive).
