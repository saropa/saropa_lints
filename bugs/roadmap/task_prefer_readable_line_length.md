# Task: `prefer_readable_line_length`

## Summary
- **Rule Name**: `prefer_readable_line_length`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Lines shouldn't exceed ~80 characters. Detect wide text without constraints.
...
// TODO: Replace with concrete example for `prefer_readable_line_length`.
```
...
- Add package/docs links relevant to `prefer_readable_line_length` (e.g. bloc, riverpod, hive).
