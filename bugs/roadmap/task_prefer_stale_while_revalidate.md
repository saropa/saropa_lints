# Task: `prefer_stale_while_revalidate`

## Summary
- **Rule Name**: `prefer_stale_while_revalidate`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Show stale data while refreshing. Detect blocking refresh pattern.
...
// TODO: Replace with concrete example for `prefer_stale_while_revalidate`.
```
...
- Add package/docs links relevant to `prefer_stale_while_revalidate` (e.g. bloc, riverpod, hive).
