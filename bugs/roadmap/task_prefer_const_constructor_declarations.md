# Task: `prefer_const_constructor_declarations`

## Summary
- **Rule Name**: `prefer_const_constructor_declarations`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
...
Prefer declaring constructors as const when possible.
...
// TODO: Replace with concrete example for `prefer_const_constructor_declarations`.
```
...
- Add package/docs links relevant to `prefer_const_constructor_declarations` (e.g. bloc, riverpod, hive).
