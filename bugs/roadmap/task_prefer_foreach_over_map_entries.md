# Task: `prefer_foreach_over_map_entries`

## Summary
- **Rule Name**: `prefer_foreach_over_map_entries`
- **Tier**: Stylistic
- **Severity**: INFO
- **Status**: Planned
...
Prefer forEach for map iteration over map.entries.
...
// TODO: Replace with concrete example for `prefer_foreach_over_map_entries`.
```
...
- Add package/docs links relevant to `prefer_foreach_over_map_entries` (e.g. bloc, riverpod, hive).
