# Task: `prefer_pinned_version_syntax`

## Summary
- **Rule Name**: `prefer_pinned_version_syntax`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
// TODO: Replace with concrete example for `prefer_pinned_version_syntax`.
```
...
- Add package/docs links relevant to `prefer_pinned_version_syntax` (e.g. bloc, riverpod, hive).
