# Task: `require_provider_update_should_notify`

## Summary
- **Rule Name**: `require_provider_update_should_notify`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
- **Source**: ROADMAP.md — 5.2 Navigation & State Management (go_router, Provider, GetX)

## Problem Statement

ChangeNotifiers should implement efficient notifyListeners. Detect notifying on every setter.
...
// TODO: Replace with concrete example for `require_provider_update_should_notify`.
```
...
- Add package/docs links relevant to `require_provider_update_should_notify` (e.g. bloc, riverpod, hive).
