# Task: `prefer_js_interop_over_dart_js`

## Summary
- **Rule Name**: `prefer_js_interop_over_dart_js`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use stable `dart:js_interop` (Dart 3.5) instead of deprecated `dart:js`.
...
// TODO: Replace with concrete example for `prefer_js_interop_over_dart_js`.
```
...
- Add package/docs links relevant to `prefer_js_interop_over_dart_js` (e.g. bloc, riverpod, hive).
