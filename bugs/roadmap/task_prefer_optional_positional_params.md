# Task: `prefer_optional_positional_params`

## Summary
- **Rule Name**: `prefer_optional_positional_params`
- **Tier**: Comprehensive
- **Severity**: INFO
- **Status**: Planned
...
// TODO: Replace with concrete example for `prefer_optional_positional_params`.
```
...
- Add package/docs links relevant to `prefer_optional_positional_params` (e.g. bloc, riverpod, hive).
