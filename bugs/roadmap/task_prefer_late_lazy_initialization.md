# Task: `prefer_late_lazy_initialization`

## Summary
- **Rule Name**: `prefer_late_lazy_initialization`
- **Tier**: Professional
- **Severity**: INFO
- **Status**: Planned
...
Use late for expensive lazy initialization. Detect eager init of rarely-used fields.
...
// TODO: Replace with concrete example for `prefer_late_lazy_initialization`.
```
...
- Add package/docs links relevant to `prefer_late_lazy_initialization` (e.g. bloc, riverpod, hive).
