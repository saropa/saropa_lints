...
**Conflicts with:** [`prefer_pinned_version_syntax`](../tier_1_quick_wins/proposal_prefer_pinned_version_syntax.md) — mutually exclusive; a project enables at most one.
