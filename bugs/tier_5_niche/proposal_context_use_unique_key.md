...
Created: 2026-09-02
Type: New rule
Related rules: `context_ref_reassignment` (`context_plus_lint` companion proposal, same source package — see `bugs/tier_5_niche/proposal_context_ref_reassignment.md`)
