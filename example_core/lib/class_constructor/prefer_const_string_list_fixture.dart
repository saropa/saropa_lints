...
// Test fixture for: prefer_const_string_list
// Source: lib\src\rules\class_constructor_rules.dart

import '../flutter_mocks.dart';

// BAD: Should trigger prefer_const_string_list
// expect_lint: prefer_const_string_list
void _bad140() {
  final List<String> countries = <String>['US', 'CA', 'MX'];
}

// GOOD: Should NOT trigger prefer_const_string_list
void _good140() {
