...
// Test fixture for: avoid_multi_assignment
...
// BAD: Should trigger avoid_multi_assignment
// expect_lint: avoid_multi_assignment
void _bad265() {
  a = b = c = 0;
}

// GOOD: Should NOT trigger avoid_multi_assignment
void _good265() {
  a = 0;
  b = 0;
  c = 0;
