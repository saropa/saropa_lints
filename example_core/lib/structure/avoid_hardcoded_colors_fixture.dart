...
// Test fixture for: avoid_hardcoded_colors
...
// BAD: Should trigger avoid_hardcoded_colors
// expect_lint: avoid_hardcoded_colors
void _bad1062() {
  Container(color: Color(0xFF000000));
  Text('Hi', style: TextStyle(color: Colors.red));
}

// GOOD: Should NOT trigger avoid_hardcoded_colors
void _good1062() {
