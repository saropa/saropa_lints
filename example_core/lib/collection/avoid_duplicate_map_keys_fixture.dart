...
// Test fixture for: avoid_duplicate_map_keys
...
// BAD: Should trigger avoid_duplicate_map_keys
// expect_lint: avoid_duplicate_map_keys
void _bad240() {
  final map = {'a': 1, 'b': 2, 'a': 3};
}

// GOOD: Should NOT trigger avoid_duplicate_map_keys
void _good240() {
