...
// Test fixture for: avoid_single_field_destructuring
...
// BAD: Should trigger avoid_single_field_destructuring
// expect_lint: avoid_single_field_destructuring
void _bad958() {
  final (:name) = person;
  print(name);
}

// GOOD: Should NOT trigger avoid_single_field_destructuring
void _good958() {
