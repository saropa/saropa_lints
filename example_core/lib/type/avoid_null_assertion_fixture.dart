...
// Test fixture for: avoid_null_assertion
...
// BAD: Should trigger avoid_null_assertion
// expect_lint: avoid_null_assertion
void _bad1228() {
  final String name = user.name!; // Crashes if name is null
}

// GOOD: Should NOT trigger avoid_null_assertion
void _good1228() {
