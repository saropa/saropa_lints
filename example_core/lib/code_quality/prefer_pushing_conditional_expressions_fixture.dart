...
// Test fixture for: prefer_pushing_conditional_expressions
...
// BAD: Should trigger prefer_pushing_conditional_expressions
// expect_lint: prefer_pushing_conditional_expressions
void _bad208() {
  condition ? foo(1, 2) : foo(1, 3);
}

// GOOD: Should NOT trigger prefer_pushing_conditional_expressions
void _good208() {
  foo(1, condition ? 2 : 3);
}
