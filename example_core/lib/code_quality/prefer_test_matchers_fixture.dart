...
// Test fixture for: prefer_test_matchers
...
// BAD: Should trigger prefer_test_matchers
// expect_lint: prefer_test_matchers
void _bad217() {
  expect(list.length, equals(0));
  expect(string.contains('x'), isTrue);
}

// GOOD: Should NOT trigger prefer_test_matchers
void _good217() {
  expect(list, isEmpty);
