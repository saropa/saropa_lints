...
// Test fixture for: prefer_enums_by_name
...
// BAD: Should trigger prefer_enums_by_name
// expect_lint: prefer_enums_by_name
void _bad167() {
  MyEnum.values.firstWhere((e) => e.name == 'value');
}

// GOOD: Should NOT trigger prefer_enums_by_name
void _good167() {
