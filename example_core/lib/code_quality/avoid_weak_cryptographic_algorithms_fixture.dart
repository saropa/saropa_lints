...
// Test fixture for: avoid_weak_cryptographic_algorithms
...
// BAD: Should trigger avoid_weak_cryptographic_algorithms
// expect_lint: avoid_weak_cryptographic_algorithms
void _bad162() {
  final hash = md5.convert(utf8.encode('password'));
  final hash2 = sha1.convert(utf8.encode('password'));
}

// GOOD: Should NOT trigger avoid_weak_cryptographic_algorithms
void _good162() {
