...
// Test fixture for: avoid_missing_interpolation
...
// BAD: Should trigger avoid_missing_interpolation
// expect_lint: avoid_missing_interpolation
void _bad238() {
  final greeting = 'Hello, ' + name + '!';
  final path = baseUrl + '/api/' + endpoint;
}

// GOOD: Should NOT trigger avoid_missing_interpolation
void _good238() {
  final greeting = 'Hello, $name!';
  final path = '$baseUrl/api/$endpoint';
}
