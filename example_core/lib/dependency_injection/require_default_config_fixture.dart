...
// Test fixture for: require_default_config
...
// BAD: Should trigger require_default_config
// expect_lint: require_default_config
void _bad320() {
  final apiUrl = dotenv.get('API_URL'); // Crashes if missing
  final timeout = int.parse(env['TIMEOUT']!); // Null pointer if missing
}

// GOOD: Should NOT trigger require_default_config
void _good320() {
