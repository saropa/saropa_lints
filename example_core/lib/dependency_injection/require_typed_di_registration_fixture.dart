...
// Test fixture for: require_typed_di_registration
...
// BAD: Should trigger require_typed_di_registration
// expect_lint: require_typed_di_registration
void _bad318() {
  getIt.registerSingleton(UserService()); // Type not explicit
}

// GOOD: Should NOT trigger require_typed_di_registration
void _good318() {
