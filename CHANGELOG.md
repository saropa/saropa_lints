...
- **Discussion 062 (false positive reduction review):** Lives in `bugs/discussion/discussion_062_false_positive_reduction_review.md`; status in progress (move to `bugs/history/` only when fully complete). Ongoing guidance: CONTRIBUTING.md § Avoiding False Positives and `project skill doc` § Reducing False Positives.
