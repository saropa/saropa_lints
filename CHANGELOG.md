...
Patch release correcting follow-on defects in the rule and dashboard changes that shipped in 16.2.1, and in how three rules read their project configuration. Two lint rules stopped short of the cases they were meant to cover, three rules could read configuration belonging to an unrelated section of your config file, and the Config Dashboard could sit on a stale view after you flipped a toggle. [log](https://github.com/saropa/saropa_lints/blob/v16.2.2/CHANGELOG.md)
