...
- Fixed 25 lint violations for `curly_braces_in_flow_control_structures` rule
- Added `curly_braces_in_flow_control_structures` to analysis_options.yaml for stricter code style
