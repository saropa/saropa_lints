...
// Test fixture for: avoid_ios_hardcoded_bundle_id
// Source: lib\src\rules\platforms\ios_rules.dart

import '../flutter_mocks.dart';

// BAD: Should trigger avoid_ios_hardcoded_bundle_id
// expect_lint: avoid_ios_hardcoded_bundle_id
void _bad858() {
  const bundleId = 'com.example.myapp';
}

// GOOD: Should NOT trigger avoid_ios_hardcoded_bundle_id
void _good858() async {
