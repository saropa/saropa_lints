...
// Test fixture for: require_ios_app_tracking_transparency
...
// BAD: Should trigger require_ios_app_tracking_transparency
// expect_lint: require_ios_app_tracking_transparency
void _bad852() async {
  // Using AdMob without ATT check
  await AdMob.initialize();
}

// GOOD: Should NOT trigger require_ios_app_tracking_transparency
void _good852() async {
