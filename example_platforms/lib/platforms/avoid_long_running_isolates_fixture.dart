...
// Test fixture for: avoid_long_running_isolates
...
// BAD: Should trigger avoid_long_running_isolates
// expect_lint: avoid_long_running_isolates
void _bad900() {
  // Long operation without background task handling
  Future.delayed(Duration(minutes: 5), () => syncAllData());
}

// GOOD: Should NOT trigger avoid_long_running_isolates
void _good900() async {
