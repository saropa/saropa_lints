...
// Test fixture for: require_ios_minimum_version_check
...
// BAD: Should trigger require_ios_minimum_version_check
// expect_lint: require_ios_minimum_version_check
void _bad850() async {
  // LiveActivity requires iOS 16.1+
  await channel.invokeMethod('startLiveActivity', data);
}

// GOOD: Should NOT trigger require_ios_minimum_version_check
void _good850() async {
