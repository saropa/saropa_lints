...
// Test fixture for: require_ios_low_power_mode_handling
// Source: lib\src\rules\platforms\ios_rules.dart

import '../flutter_mocks.dart';

// BAD: Should trigger require_ios_low_power_mode_handling
// expect_lint: require_ios_low_power_mode_handling
void _bad909() {
  // Always uses heavy animations
  AnimationController(duration: Duration(seconds: 2));
}

// GOOD: Should NOT trigger require_ios_low_power_mode_handling
void _good909() async {
