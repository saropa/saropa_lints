...
// Test fixture for: require_macos_file_access_intent
...
// BAD: Should trigger require_macos_file_access_intent
// expect_lint: require_macos_file_access_intent
void _bad927() {
  // Direct path access fails in sandbox
  final file = File('/Users/name/Documents/file.txt');
}

// GOOD: Should NOT trigger require_macos_file_access_intent
void _good927() async {
