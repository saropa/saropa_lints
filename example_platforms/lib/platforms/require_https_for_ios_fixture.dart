...
// Test fixture for: require_https_for_ios
...
// BAD: Should trigger require_https_for_ios
// expect_lint: require_https_for_ios
void _bad843() async {
  final response = await http.get(Uri.parse('http://api.example.com/data'));
}

// GOOD: Should NOT trigger require_https_for_ios
void _good843() async {
  // Use HTTPS
