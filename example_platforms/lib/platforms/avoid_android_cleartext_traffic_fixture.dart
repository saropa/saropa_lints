...
// Test fixture for: avoid_android_cleartext_traffic
...
// BAD: Should trigger avoid_android_cleartext_traffic
// expect_lint: avoid_android_cleartext_traffic
void _bad833() async {
  // HTTP URL without platform consideration
  final response = await http.get(Uri.parse('http://api.example.com/data'));
}

// GOOD: Should NOT trigger avoid_android_cleartext_traffic
void _good833() async {
  // Use HTTPS
